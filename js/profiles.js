...
(function () {
  ...
  function injectCSS() {
    ...
    style.textContent = `
      ...
      .dt-active-since { font-family:'Cormorant Garamond',serif;font-style:italic;font-size:12px;color:rgba(201,168,76,0.5);margin-top:2px; }
      ...
      .dt-section-title { font-family:'Cinzel',serif;font-size:9px;letter-spacing:0.2em;color:rgba(201,168,76,0.5);text-transform:uppercase;margin-bottom:16px; }
      ...
      .dt-stat-label { font-family:'Cinzel',serif;font-size:8px;letter-spacing:0.12em;color:rgba(201,168,76,0.5);text-transform:uppercase;text-align:center; }
      ...
      .dt-mem-sub  { font-family:'Cormorant Garamond',serif;font-style:italic;font-size:11px;color:rgba(201,168,76,0.5);margin-top:1px; }
      ...
      .dt-p-stats { font-family:'Cormorant Garamond',serif;font-style:italic;font-size:11px;color:rgba(201,168,76,0.5);margin-top:2px; }
      ...
      .dt-standalone-close {
        width:32px;height:32px;border-radius:50%;border:1.5px solid rgba(201,168,76,0.25);
    ...
    overlay.innerHTML =
      '<div class="dt-standalone-sheet" id="dtStandaloneSheet" onclick="event.stopPropagation()">' +
        ...
        '<div class="dt-standalone-topbar">' +
          '<button class="dt-standalone-close" id="dtStandaloneClose" aria-label="Fermer">' +
  ...
  function buildModalHTML() {
    ...
    // Juz done (simplifié : juz 30 = sourates 78-114)
    var juzDone    = [];
    var juzPartial = [];
    // Pour l'instant basé sur le nombre de sourates (à affiner plus tard)
    if (stats.surahs >= 37) juzDone.push(30);
    else if (stats.surahs > 0) juzPartial.push(30);
  ...
  function openProfileModal() {
    ...
    setTimeout(function(){ animateRing('dt-ring-j','dt-pct-j','dt-det-j', Math.floor(stats.surahs/4), 30); }, 600);
  }
