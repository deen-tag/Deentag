...
(function () {
  ...
  function injectCSS() {
    ...
    style.textContent = `
      ...
      .dt-ring-wrap { position:relative;width:52px;height:52px;display:flex;align-items:center;justify-content:center; }
  ...
  function buildModalHTML() {
    ...
    if (memSurahs.length === 0) {
      html += '<div style="font-family:Cormorant Garamond,serif;font-style:italic;font-size:13px;color:rgba(var(--gold-rgb),0.65);text-align:center;padding:16px;">Aucune sourate mémorisée</div>';
    } else {
