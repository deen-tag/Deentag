...
function openSurah(surahId, startVerse) {
  ...
  setTimeout(() => {
    ...
    sheet.style.transform    = 'translateY(100%)';
    sheet.style.height       = 'calc(100dvh - env(safe-area-inset-top, 16px))';
    sheet.style.maxHeight    = 'calc(100dvh - env(safe-area-inset-top, 16px))';
    sheet.style.borderRadius = '20px 20px 0 0';
    sheet.style.overflowY    = 'hidden';
    sheet.style.top          = 'env(safe-area-inset-top, 16px)';
