...
var DUAS = {
  ...
  repas: {
    ...
    acc2: {
      ...
      audio: 'repas2.mp3',
      sheet: { sub_fr: 'Oubli de dire Bismillah', sub_en: 'Forgot to say Bismillah', sub_es: 'Olvidaste decir Bismillah', sub_de: 'Bismillah vergessen', sub_it: 'Dimenticato il Bismillah', sub_nl: 'Bismillah vergeten', sub_pt: 'Esqueceu o Bismillah', sub_tr: 'Besmeleyi unutma' }
    },
    acc3: {
      titre: {
  ...
  reveil: {
    ...
    acc4: {
      ...
      sheet: { sub_fr: 'Les sunnahs du coucher', sub_en: 'Sunnahs of bedtime', sub_es: 'Sunnahs para dormir', sub_de: 'Sunnahs vor dem Schlafen', sub_it: 'Sunnah della notte', sub_nl: 'Soenna\'s voor het slapen', sub_pt: 'Sunnahs para dormir', sub_tr: 'Yatma sünnetleri' }
    },
    acc5: {
  ...
  maison: {
    ...
    acc4: {
      ...
      audio: null,
      sheet: { sub_fr: 'Protection en quittant la maison', sub_en: 'Protection when leaving home', sub_es: 'Protección al salir de casa', sub_de: 'Schutz beim Verlassen des Hauses', sub_it: 'Protezione uscendo di casa', sub_nl: 'Bescherming bij het verlaten van huis', sub_pt: 'Proteção ao sair de casa', sub_tr: 'Evden çıkarken korunma' }
    },
    acc5: {
      titre: { fr: 'SUNNAHS DU PROPHÈTE ﷺ', en: 'PROPHET\'S ﷺ SUNNAH', es: 'SUNNAH DEL PROFETA ﷺ' },
      sunnah: true,
  ...
  enfants: {
    ...
    acc3: {
      ...
      sheet: { sub_fr: 'Les sunnahs de protection', sub_en: 'Sunnahs of protection', sub_es: 'Sunnahs de protección', sub_de: 'Schutz-Sunnahs', sub_it: 'Sunnah di protezione', sub_nl: 'Beschermende soenna\'s', sub_pt: 'Sunnahs de proteção', sub_tr: 'Koruma sünnetleri' }
    }
  },
  ...
  rizq: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'Pour la subsistance', sub_en: 'For sustenance', sub_es: 'Por el sustento', sub_de: 'Für die Versorgung', sub_it: 'Per il sostentamento', sub_nl: 'Voor levensonderhoud', sub_pt: 'Pelo sustento', sub_tr: 'Rızık için' }
    }
  },
  ...
  mariage: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'Félicitations aux époux', sub_en: 'Congratulating the newlyweds', sub_es: 'Felicitaciones a los esposos', sub_de: 'Glückwünsche an die Eheleute', sub_it: 'Congratulazioni agli sposi', sub_nl: 'Felicitaties aan het bruidspaar', sub_pt: 'Felicitações aos noivos', sub_tr: 'Evlilere tebrik' }
    }
  },
...
azan: {
  ...
  acc2: {
    ...
    audio: '',
    sheet: { sub_fr: 'Après l\'appel à la prière (Adhan)', sub_en: 'After the call to prayer (Adhan)', sub_es: 'Después de la llamada a la oración (Adhan)', sub_de: 'Nach dem Gebetsruf (Adhan)', sub_it: 'Dopo la chiamata alla preghiera (Adhan)', sub_nl: 'Na de gebedsoproep (Adhan)', sub_pt: 'Após o chamado à oração (Adhan)', sub_tr: 'Ezandan sonra (Ezan)' }
  }
},
