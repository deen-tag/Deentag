  ...
  toilettes: {
    ...
    acc3: {
      ...
      items: {
        ...
        de: [
          { titre: 'MIT DEM LINKEN FUSS EINTRETEN', texte: 'Es ist Sunnah, die Toilette mit dem linken Fuss zuerst zu betreten.' },
          { titre: 'KOPFBEDECKUNG TRAGEN', texte: 'Es wurde berichtet, dass der Prophet ﷺ beim Betreten der Toilette stets seine Kopfbedeckung trug.' },
          { titre: 'NICHT IN STEHENDEM WASSER URINIEREN', texte: 'Der Prophet ﷺ verbot das Urinieren in stehendes Wasser. [Sahih Muslim 281]' },
          { titre: 'NICHT MIT DEM GESICHT ZUR QIBLA', texte: 'Der Prophet ﷺ: "Wenn ihr die Notdurft verrichtet, wendet weder Gesicht noch Rücken der Qibla zu." [Sahih al-Bukhârî 394]' },
          { titre: 'NICHT MIT DER RECHTEN HAND REINIGEN', texte: 'Der Prophet ﷺ: "Wenn einer von euch uriniert, soll er sein Glied nicht mit seiner rechten Hand halten." [Sahih al-Bukhârî 154]' }
        ],
        it: [
          { titre: 'ENTRARE CON IL PIEDE SINISTRO', texte: 'È sunnah entrare in bagno con il piede sinistro per primo.' },
          { titre: 'INDOSSARE UN COPRICAPO', texte: 'Fu riportato che il Profeta ﷺ indossava sempre il copricapo entrando in bagno.' },
          { titre: 'NON URINARE IN ACQUA STAGNANTE', texte: 'Il Profeta ﷺ proibiva di urinare in acqua stagnante. [Sahih Muslim 281]' },
          { titre: 'NON VOLTARSI VERSO LA QIBLA', texte: 'Il Profeta ﷺ: «Quando fate i vostri bisogni, non rivolgetevi verso la Qibla né di fronte né di schiena.» [Sahih al-Bukhārī 394]' },
          { titre: 'NON PULIRSI CON LA MANO DESTRA', texte: 'Il Profeta ﷺ: «Quando uno di voi urina, non tenga il suo membro con la mano destra.» [Sahih al-Bukhārī 154]' }
        ],
        nl: [
          { titre: 'BINNENGAAN MET DE LINKERVOET', texte: 'Het is sunnah om het toilet te betreden met de linkervoet als eerste.' },
          { titre: 'EEN HOOFDBEDEKKING DRAGEN', texte: 'Er werd gemeld dat de Profeet ﷺ bij het betreden van het toilet altijd zijn hoofdbedekking ophield.' },
          { titre: 'NIET URINEREN IN STILSTAAND WATER', texte: 'De Profeet ﷺ verbood te urineren in stilstaand water. [Sahih Muslim 281]' },
          { titre: 'NIET RICHTING DE QIBLA', texte: 'De Profeet ﷺ: "Wanneer jullie je behoefte doen, keer je gezicht noch je rug naar de Qibla." [Sahih al-Bukhârî 394]' },
          { titre: 'NIET REINIGEN MET DE RECHTERHAND', texte: 'De Profeet ﷺ: "Wanneer een van jullie urineert, laat hem zijn geslachtsorgaan niet met zijn rechterhand vasthouden." [Sahih al-Bukhârî 154]' }
        ],
        pt: [
          { titre: 'ENTRAR COM O PÉ ESQUERDO', texte: 'É sunnah entrar na casa de banho primeiro com o pé esquerdo.' },
          { titre: 'USAR UMA COBERTURA DE CABEÇA', texte: 'Foi relatado que o Profeta ﷺ sempre usava cobertura de cabeça ao entrar na casa de banho.' },
          { titre: 'NÃO URINAR EM ÁGUA PARADA', texte: 'O Profeta ﷺ proibia urinar em água parada. [Sahih Muslim 281]' },
          { titre: 'NÃO VIRAR-SE PARA A QIBLA', texte: 'O Profeta ﷺ: «Quando fazeis as vossas necessidades, não volteis o rosto nem as costas para a Qibla.» [Sahih al-Bukhārī 394]' },
          { titre: 'NÃO LIMPAR COM A MÃO DIREITA', texte: 'O Profeta ﷺ: «Quando um de vós urinar, que não segure o seu órgão com a mão direita.» [Sahih al-Bukhārī 154]' }
        ],
        tr: [
          { titre: 'SOL AYAKLA GİRMEK', texte: 'Tuvalete sol ayakla girmek sünnettir.' },
          { titre: 'BAŞINI ÖRTMEK', texte: 'Peygamber ﷺ\'in tuvalete girerken başını örttüğü rivayet edilmiştir.' },
          { titre: 'DURGUN SUYA İDRAR YAPMAMAK', texte: 'Peygamber ﷺ durgun suya idrar yapmayı yasaklamıştır. [Sahih Muslim 281]' },
          { titre: 'KIBLÉYE DÖNMEMEK', texte: 'Peygamber ﷺ: "Hacetinizi giderirken kıbleye ne yüzünüzü ne de arkanızı dönün." [Sahihu\'l-Buhârî 394]' },
          { titre: 'SAĞ ELLE TEMİZLENMEMEK', texte: 'Peygamber ﷺ: "Biriniz idrar yaparken tenasül uzvunu sağ eliyle tutmasın." [Sahihu\'l-Buhârî 154]' }
        ]
      },
      sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar' }
    }
  ...
  transport: {
    ...
    acc3: {
      ...
      items: {
        ...
        de: [
          { titre: 'WUDU VOR DER REISE', texte: 'Der Prophet ﷺ empfahl, in einem Zustand ritueller Reinheit zu reisen.' },
          { titre: 'DONNERSTAGS ABREISEN', texte: 'Ka\'b ibn Mâlik berichtete, dass der Prophet ﷺ es liebte, donnerstags aufzubrechen. [Sahih al-Bukhârî 2950]' },
          { titre: 'JEMANDEM BESCHEID GEBEN', texte: 'Der Prophet ﷺ pflegte, jemanden zu informieren, wenn er reiste.' },
          { titre: 'TAKBIR AUF DEM WEG', texte: 'Jâbir berichtete: "Wenn wir einen Aufstieg nahmen, riefen wir Allâhu Akbar; wenn wir hinabstiegen, sagten wir Subhânallah." [Sahih al-Bukhârî 2993]' },
        ...
        it: [
          { titre: 'FARE IL WUDU PRIMA DEL VIAGGIO', texte: 'Il Profeta ﷺ raccomandava di viaggiare in stato di purezza rituale.' },
          { titre: 'PARTIRE DI GIOVEDÌ', texte: 'Ka\'b ibn Mâlik riferì che il Profeta ﷺ amava partire di giovedì. [Sahih al-Bukhārī 2950]' },
          { titre: 'INFORMARE QUALCUNO', texte: 'Il Profeta ﷺ era solito informare qualcuno prima di un viaggio.' },
          { titre: 'TAKBIR LUNGO IL CAMMINO', texte: 'Jâbir riferì: «Quando salivamo dicevamo Allâhu Akbar; quando scendevamo dicevamo Subhânallah.» [Sahih al-Bukhārī 2993]' },
        ...
        nl: [
          { titre: 'WUDU DOEN VOOR DE REIS', texte: 'De Profeet ﷺ adviseerde om in staat van rituele reinheid te reizen.' },
          { titre: 'VERTREKKEN OP DONDERDAG', texte: 'Ka\'b ibn Mâlik vertelde dat de Profeet ﷺ graag op donderdag vertrok. [Sahih al-Bukhârî 2950]' },
          { titre: 'IEMAND INLICHTEN', texte: 'De Profeet ﷺ placht iemand te informeren wanneer hij op reis ging.' },
          { titre: 'TAKBIR ONDERWEG', texte: 'Jâbir: "Wanneer wij omhooggingen riepen wij Allâhu Akbar; wanneer wij neerdaalden zeiden wij Subhânallah." [Sahih al-Bukhârî 2993]' },
        ...
        pt: [
          { titre: 'FAZER WUDU ANTES DA VIAGEM', texte: 'O Profeta ﷺ recomendava viajar em estado de pureza ritual.' },
          { titre: 'PARTIR À QUINTA-FEIRA', texte: 'Ka\'b ibn Mâlik relatou que o Profeta ﷺ gostava de partir às quintas-feiras. [Sahih al-Bukhārī 2950]' },
          { titre: 'INFORMAR ALGUÉM', texte: 'O Profeta ﷺ costumava informar alguém antes de viajar.' },
          { titre: 'TAKBIR PELO CAMINHO', texte: 'Jâbir: «Quando subíamos dizíamos Allâhu Akbar; quando descíamos dizíamos Subhânallah.» [Sahih al-Bukhārī 2993]' },
        ...
        tr: [
          { titre: 'YOLCULUKTAN ÖNCE ABDEST ALMAK', texte: 'Peygamber ﷺ mümkün olduğunda abdestli olarak yolculuğa çıkmayı tavsiye ederdi.' },
          { titre: 'PERŞEMBE YOLA ÇIKMAK', texte: 'Ka\'b b. Mâlik\'ten; Peygamber ﷺ perşembe günü yola çıkmayı severdi. [Sahihu\'l-Buhârî 2950]' },
          { titre: 'BİRİNİ BİLGİLENDİRMEK', texte: 'Peygamber ﷺ yolculuğa çıkmadan önce birine haber verirdi.' },
          { titre: 'YOL BOYUNCA TEKBİR GETİRMEK', texte: 'Câbir\'den: "Yokuş çıkarken Allahu Ekber, inerken Sübhanallah derdik." [Sahihu\'l-Buhârî 2993]' },
