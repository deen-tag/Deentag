...
var DUAS = {
  ...
  repas: {
    ...
    acc1: {
      ...
      phonetique: { fr: 'Bismillâh', en: 'Bismillaah', es: 'Bismilláh' , de: 'Bismillâh', it: 'Bismillāh', nl: 'Bismillaah', pt: 'Bismillāh', tr: 'Bismillâh'  },
      traduction: {
fr: 'Au nom d\'Allah',
en: 'In the name of Allah',
es: 'En el nombre de Allah', de: 'Im Namen Allahs', it: 'Nel nome di Allah', nl: 'In de naam van Allah', pt: 'Em nome de Allah', tr: 'Allah\'ın adıyla' },
      hadith: {
...
es: 'Bismilláhi awwalahu wa ájirah', de: 'Bismillâhi awwalahu wa âkhirahu', it: 'Bismillāhi awwalahu wa ākhirahu', nl: 'Bismillaahi awwalahu wa aakhirahu', pt: 'Bismillāhi awwalahu wa ākhirahu', tr: 'Bismillâhi evvelehû ve âhirahu' },
      traduction: {
fr: 'Au nom d\'Allah au début et à la fin',
en: 'In the name of Allah, at the beginning and at the end',
es: 'En el nombre de Allah, al principio y al final', de: 'Im Namen Allahs, am Anfang und am Ende', it: 'Nel nome di Allah, all\'inizio e alla fine', nl: 'In de naam van Allah, aan het begin en aan het einde', pt: 'Em nome de Allah, no início e no fim', tr: 'Allah\'ın adıyla' },
      hadith: {
...
es: 'Narrado por \'Â\'ishah (que Allah esté complacida con ella), el Profeta ﷺ dijo: «Cuando alguno de vosotros coma, que mencione el nombre de Allah al principio. Si olvida, que diga: Bismilláhi awwalahu wa ájirah.»\nFuente: Sunan Abu Daoud (3767) · Tirmidhi (1858)', de: 'Überliefert von \'Â\'isha (möge Allah mit ihr zufrieden sein), der Prophet ﷺ sagte: „Wenn einer von euch isst, soll er am Anfang den Namen Allahs nennen. Vergisst er es, soll er sagen: Bismillâhi awwalahu wa âkhirahu.“\nQuelle: Sunan Abî Dâwûd (3767) · Tirmidhi (1858)', it: 'Riportato da \'Â\'isha (che Allah sia soddisfatta di lei), il Profeta ﷺ disse: «Quando uno di voi mangia, menzioni il nome di Allah all\'inizio. Se lo dimentica, dica: Bismillāhi awwalahu wa ākhirahu.»\nFonte: Sunan Abî Dâwûd (3767) · Tirmidhi (1858)', nl: 'Overgeleverd door \'Â\'isha (moge Allah tevreden met haar zijn), de Profeet ﷺ zei: "Wanneer een van jullie eet, laat hem de naam van Allah noemen aan het begin. Als hij het vergeet, laat hem zeggen: Bismillaahi awwalahu wa aakhirahu."\nBron: Sunan Abî Dâwûd (3767) · Tirmidhi (1858)', pt: 'Narrado por \'Â\'isha (que Allah esteja satisfeito com ela), o Profeta ﷺ disse: «Quando um de vós comer, que mencione o nome de Allah no início. Se esquecer, que diga: Bismillāhi awwalahu wa ākhirahu.»\nFonte: Sunan Abî Dâwûd (3767) · Tirmidhi (1858)', tr: '\'Âişe\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ şöyle buyurdu: "Biriniz yemek yediğinde başında Allah\'ın adını zikretsin. Unutursa: Bismillâhi evvelehû ve âhirahu desin."\nKaynak: Sünen-i Ebî Dâvûd (3767) · Tirmizî (1858)' , de: 'Überliefert von \'Â\'isha (möge Allah mit ihr zufrieden sein), der Prophet ﷺ sagte: „Wenn einer von euch isst, soll er am Anfang den Namen Allahs nennen. Vergisst er es, soll er sagen: Bismillâhi awwalahu wa âkhirahu.“\nQuelle: Sunan Abî Dâwûd (3767) · Tirmidhi (1858)', it: 'Riportato da \'Â\'isha (che Allah sia soddisfatta di lei), il Profeta ﷺ disse: «Quando uno di voi mangia, menzioni il nome di Allah all\'inizio. Se lo dimentica, dica: Bismillāhi awwalahu wa ākhirahu.»\nFonte: Sunan Abî Dâwûd (3767) · Tirmidhi (1858)', nl: 'Overgeleverd door \'Â\'isha (moge Allah tevreden met haar zijn), de Profeet ﷺ zei: "Wanneer een van jullie eet, laat hem de naam van Allah noemen aan het begin. Als hij het vergeet, laat hem zeggen: Bismillaahi awwalahu wa aakhirahu."\nBron: Sunan Abî Dâwûd (3767) · Tirmidhi (1858)', pt: 'Narrado por \'Â\'isha (que Allah esteja satisfeito com ela), o Profeta ﷺ disse: «Quando um de vós comer, que mencione o nome de Allah no início. Se esquecer, que diga: Bismillāhi awwalahu wa ākhirahu.»\nFonte: Sunan Abî Dâwûd (3767) · Tirmidhi (1858)', tr: '\'Âişe\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ şöyle buyurdu: "Biriniz yemek yediğinde başında Allah\'ın adını zikretsin. Unutursa: Bismillâhi evvelehû ve âhirahu desin."\nKaynak: Sünen-i Ebî Dâvûd (3767) · Tirmizî (1858)' },
      audio: 'repas2.mp3',
...
es: 'Narrado por Mu\'âdh ibn Anas (que Allah esté complacido con él), el Profeta ﷺ dijo: «Quien coma una comida y diga esta invocación, sus pecados anteriores le serán perdonados.»\nFuente: Sunan Abu Daoud (4023) · Tirmidhi (3458)', de: 'Überliefert von Mu\'âdh ibn Anas (möge Allah mit ihm zufrieden sein), der Prophet ﷺ sagte: „Wer eine Mahlzeit isst und dieses Bittgebet spricht, dem werden seine früheren Sünden vergeben.“\nQuelle: Sunan Abî Dâwûd (4023) · Tirmidhi (3458)', it: 'Riportato da Mu\'âdh ibn Anas (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «Chi mangia un pasto e dice questa invocazione, i suoi peccati precedenti gli saranno perdonati.»\nFonte: Sunan Abî Dâwûd (4023) · Tirmidhi (3458)', nl: 'Overgeleverd door Mu\'âdh ibn Anas (moge Allah tevreden met hem zijn), de Profeet ﷺ zei: "Wie een maaltijd eet en dit smeekgebed zegt, zijn vroegere zonden zullen hem vergeven worden."\nBron: Sunan Abî Dâwûd (4023) · Tirmidhi (3458)', pt: 'Narrado por Mu\'âdh ibn Anas (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «Quem comer uma refeição e disser esta invocação, os seus pecados anteriores ser-lhe-ão perdoados.»\nFonte: Sunan Abî Dâwûd (4023) · Tirmidhi (3458)', tr: 'Muâz b. Enes\'ten (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ şöyle buyurdu: "Bir yemek yiyen kimse bu duayı okursa geçmiş günahları bağışlanır."\nKaynak: Sünen-i Ebî Dâvûd (4023) · Tirmizî (3458)' },
  ...
  ablution: {
    ...
    acc1: {
      ...
      traduction: { fr: 'Au nom d\'Allah', en: 'In the name of Allah', es: 'En el nombre de Allah' , de: 'Bismillâh', it: 'Bismillāh', nl: 'Bismillaah', pt: 'Bismillāh', tr: 'Bismillâh' },
      hadith: { },
      audio: 'ablution1.mp3',
...
es: 'Ash-hadu an laa iláaha illalláahu wahdahu laa sharíika lah, wa ash-hadu anna Muhammadan \'abduhu wa rasúluh.', de: 'Ash-hadu an lâ ilâha illallaahu wahdahu lâ shareeka lah, wa ash-hadu anna Muhammadan \'abduhu wa rasûluh.', it: 'Ash-hadu an lā ilāha illallāhu wahdahu lā sharīka lah, wa ash-hadu anna Muhammadan \'abduhu wa rasūluh.', nl: 'Ash-hadu an laa ilaaha illallaahu wahdahu laa shareeka lah, wa ash-hadu anna Muhammadan \'abduhu wa rasooluh.', pt: 'Ash-hadu an lā ilāha illallāhu wahdahu lā sharīka lah, wa ash-hadu anna Muhammadan \'abduhu wa rasūluh.', tr: 'Eşhedü en lâ ilâhe illallâhu vahdehû lâ şerîke leh' },
      traduction: {
...
es: 'Narrado por \'Umar ibn al-Khattâb (que Allah esté complacido con él), el Profeta ﷺ enseñaba a decir esta invocación después de las abluciones, a continuación de la Shahada.\nFuente: Jami\' at-Tirmidhi (55)', de: 'Überliefert von \'Umar ibn al-Khattâb (möge Allah mit ihm zufrieden sein), der Prophet ﷺ lehrte, dieses Bittgebet nach den Ablutionen, im Anschluss an die Schahada, zu sprechen.\nQuelle: Jâmi\' at-Tirmidhi (55)', it: 'Riportato da \'Umar ibn al-Khattâb (che Allah sia soddisfatto di lui), il Profeta ﷺ insegnava a dire questa invocazione dopo le ablucioni, a seguito della Shahada.\nFonte: Jâmi\' at-Tirmidhi (55)', nl: 'Overgeleverd door \'Umar ibn al-Khattâb (moge Allah tevreden met hem zijn), de Profeet ﷺ leerde dit smeekgebed na de reiniging te zeggen, volgend op de Shahada.\nBron: Jâmi\' at-Tirmidhi (55)', pt: 'Narrado por \'Umar ibn al-Khattâb (que Allah esteja satisfeito com ele), o Profeta ﷺ ensinava a dizer esta invocação após a ablução, a seguir à Shahada.\nFonte: Jâmi\' at-Tirmidhi (55)', tr: '\'Ömer b. Hattâb\'dan (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ abdest sonrasında şehadet getirdikten hemen sonra bu duanın okunmasını öğretirdi.\nKaynak: Câmi\'u\'t-Tirmizî (55)' },
      audio: 'ablution3.mp3',
    ...
    acc4: {
      titre: { fr: 'SUNNAHS DU PROPHÈTE ﷺ', en: 'PROPHET\'S ﷺ SUNNAH', es: 'SUNNAH DEL PROFETA ﷺ', de: 'SUNNA DES PROPHETEN ﷺ', it: 'SUNNAH DEL PROFETA ﷺ', nl: 'SOENNA VAN DE PROFEET ﷺ', pt: 'SUNNAH DO PROFETA ﷺ', tr: 'PEYGAMBERİN ﷺ SÜNNETİ' },
      sunnah: true,
      items: {
        fr: [
          { titre: 'LES ABLUTIONS EFFACENT LES PETITS PÉCHÉS', texte: 'Le Prophète ﷺ a dit : « Quand le musulman accomplit ses ablutions, ses péchés sortent de ses mains, de son visage, de sa tête et de ses pieds avec l\'eau. » [Sahih Muslim 245]' },
          { titre: 'EAU DES ABLUTIONS = LUMIÈRE AU PARADIS', texte: 'D\'après Uthman ibn Affan (qu\'Allah l\'agrée), le Prophète ﷺ a dit : « Celui qui accomplit ses ablutions, son eau atteindra jusqu\'à ses pieds et sera une lumière pour lui au Jour Dernier. » [Jami\' at-Tirmidhi 22]' },
          { titre: 'LES ABLUTIONS = CLÉ DE LA PRIÈRE', texte: 'D\'après Abu Hurayra (qu\'Allah l\'agrée), le Prophète ﷺ a dit : « La prière ne peut être accomplie sans ablutions. » [Sahih Muslim 225]' },
          { titre: '10 RÉCOMPENSES PAR MEMBRE LAVÉ', texte: 'D\'après Abu Hurayra (qu\'Allah l\'agrée), le Prophète ﷺ a dit : « À celui qui accomplit parfaitement ses ablutions, il est écrit dix bonnes actions pour chaque membre qu\'il a lavé. » [Sahih Muslim 226]' },
          { titre: 'ABLUTIONS PARFAITES = ANGES TÉMOINS', texte: 'D\'après Umar ibn al-Khattab (qu\'Allah l\'agrée), le Prophète ﷺ a dit : « Quand l\'un de vous accomplit ses ablutions parfaitement, les anges témoignent pour lui : Qu\'Allah te purifie ! » [Jami\' at-Tirmidhi 13]' }
        ],
        en: [
          { titre: 'ABLUTION ERASES MINOR SINS', texte: 'The Prophet ﷺ said: "When a Muslim performs his ablution, his sins leave his hands, face, head and feet with the water." [Sahih Muslim 245]' },
          { titre: 'ABLUTION WATER = LIGHT ON JUDGEMENT DAY', texte: 'According to Uthman ibn Affan (may Allah be pleased with him), the Prophet ﷺ said: "Whoever performs his ablution, the water reaching his feet will be a light for him on the Last Day." [Jami\' at-Tirmidhi 22]' },
          { titre: 'ABLUTION = KEY TO PRAYER', texte: 'According to Abu Hurairah (may Allah be pleased with him), the Prophet ﷺ said: "Prayer cannot be performed without ablution." [Sahih Muslim 225]' },
          { titre: '10 REWARDS PER LIMB WASHED', texte: 'According to Abu Hurairah (may Allah be pleased with him), the Prophet ﷺ said: "For whoever performs his ablution perfectly, ten good deeds are recorded for each limb he has washed." [Sahih Muslim 226]' },
          { titre: 'PERFECT ABLUTION = ANGELS WITNESS', texte: 'According to Umar ibn al-Khattab (may Allah be pleased with him), the Prophet ﷺ said: "When one of you performs his ablution perfectly, the angels bear witness for him: May Allah purify you!" [Jami\' at-Tirmidhi 13]' }
        ],
        es: [
          { titre: 'LA ABLUCIÓN BORRA LOS PECADOS MENORES', texte: 'El Profeta ﷺ dijo: "Cuando el musulmán realiza sus abluciones, sus pecados salen de sus manos, cara, cabeza y pies con el agua." [Sahih Muslim 245]' },
          { titre: 'AGUA DE LA ABLUCIÓN = LUZ EN EL JUICIO', texte: 'Según Uthman ibn Affan (que Allah esté complacido con él), el Profeta ﷺ dijo: "Quien realice sus abluciones, el agua que llegue hasta sus pies será una luz para él en el Día Final." [Jami\' at-Tirmidhi 22]' },
          { titre: 'LA ABLUCIÓN = LLAVE DE LA ORACIÓN', texte: 'Según Abu Hurairah (que Allah esté complacido con él), el Profeta ﷺ dijo: "La oración no puede realizarse sin abluciones." [Sahih Muslim 225]' },
          { titre: '10 RECOMPENSAS POR MIEMBRO LAVADO', texte: 'Según Abu Hurairah (que Allah esté complacido con él), el Profeta ﷺ dijo: "A quien realice perfectamente sus abluciones, se le anotan diez buenas acciones por cada miembro que haya lavado." [Sahih Muslim 226]' },
          { titre: 'ABLUCIÓN PERFECTA = ÁNGELES TESTIGOS', texte: 'Según Umar ibn al-Khattab (que Allah esté complacido con él), el Profeta ﷺ dijo: "Cuando alguno de vosotros realiza sus abluciones perfectamente, los ángeles atestiguan por él: ¡Que Allah te purifique!" [Jami\' at-Tirmidhi 13]' }
        ],
        de: [
          { titre: 'DIE WASCHUNG TILGT KLEINERE SÜNDEN', texte: 'Der Prophet ﷺ sagte: „Wenn der Muslim seine Waschung vollzieht, verlassen seine Sünden seine Hände, sein Gesicht, seinen Kopf und seine Füße mit dem Wasser." [Sahih Muslim 245]' },
          { titre: 'WASCHWASSER = LICHT AM JÜNGSTEN TAG', texte: 'Gemäß Uthman ibn Affan (möge Allah mit ihm zufrieden sein) sagte der Prophet ﷺ: „Wer seine Waschung vollzieht, das Wasser, das bis zu seinen Füßen reicht, wird für ihn ein Licht am Jüngsten Tag sein." [Jâmi\' at-Tirmidhi 22]' },
          { titre: 'DIE WASCHUNG = SCHLÜSSEL ZUM GEBET', texte: 'Gemäß Abu Hurayra (möge Allah mit ihm zufrieden sein) sagte der Prophet ﷺ: „Das Gebet kann ohne Waschung nicht vollzogen werden." [Sahih Muslim 225]' },
          { titre: '10 BELOHNUNGEN PRO GEWASCHENEM GLIED', texte: 'Gemäß Abu Hurayra (möge Allah mit ihm zufrieden sein) sagte der Prophet ﷺ: „Wer seine Waschung vollständig vollzieht, dem werden für jedes gewaschene Glied zehn gute Taten aufgeschrieben." [Sahih Muslim 226]' },
          { titre: 'VOLLSTÄNDIGE WASCHUNG = ENGEL BEZEUGEN', texte: 'Gemäß Umar ibn al-Khattab (möge Allah mit ihm zufrieden sein) sagte der Prophet ﷺ: „Wenn einer von euch seine Waschung vollständig vollzieht, bezeugen die Engel für ihn: Möge Allah dich reinigen!" [Jâmi\' at-Tirmidhi 13]' }
        ],
        it: [
          { titre: 'L\'ABLUZIONE CANCELLA I PECCATI MINORI', texte: 'Il Profeta ﷺ disse: «Quando il musulmano compie la sua abluzione, i suoi peccati escono dalle sue mani, dal suo viso, dalla sua testa e dai suoi piedi con l\'acqua.» [Sahih Muslim 245]' },
          { titre: 'ACQUA DELL\'ABLUZIONE = LUCE NEL GIUDIZIO', texte: 'Secondo Uthman ibn Affan (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «Chi compie la sua abluzione, l\'acqua che raggiungerà i suoi piedi sarà una luce per lui nell\'Ultimo Giorno.» [Jâmi\' at-Tirmidhi 22]' },
          { titre: 'L\'ABLUZIONE = CHIAVE DELLA PREGHIERA', texte: 'Secondo Abu Hurayra (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «La preghiera non può essere compiuta senza abluzione.» [Sahih Muslim 225]' },
          { titre: '10 RICOMPENSE PER OGNI MEMBRO LAVATO', texte: 'Secondo Abu Hurayra (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «A chi compie perfettamente la sua abluzione, vengono scritte dieci buone azioni per ogni membro che ha lavato.» [Sahih Muslim 226]' },
          { titre: 'ABLUZIONE PERFETTA = ANGELI TESTIMONI', texte: 'Secondo Umar ibn al-Khattab (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «Quando uno di voi compie la sua abluzione perfettamente, gli angeli testimoniano per lui: Che Allah ti purifichi!» [Jâmi\' at-Tirmidhi 13]' }
        ],
        nl: [
          { titre: 'DE WASSING WIST KLEINERE ZONDEN UIT', texte: 'De Profeet ﷺ zei: "Wanneer de moslim zijn wassing verricht, verlaten zijn zonden zijn handen, gezicht, hoofd en voeten met het water." [Sahih Muslim 245]' },
          { titre: 'WASSINGSWATER = LICHT OP DE DAG DES OORDEELS', texte: 'Volgens Uthman ibn Affan (moge Allah tevreden met hem zijn) zei de Profeet ﷺ: "Wie zijn wassing verricht, het water dat zijn voeten bereikt zal een licht voor hem zijn op de Laatste Dag." [Jâmi\' at-Tirmidhi 22]' },
          { titre: 'DE WASSING = SLEUTEL TOT HET GEBED', texte: 'Volgens Abu Hurairah (moge Allah tevreden met hem zijn) zei de Profeet ﷺ: "Het gebed kan niet verricht worden zonder wassing." [Sahih Muslim 225]' },
          { titre: '10 BELONINGEN PER GEWASSEN LICHAAMSDEEL', texte: 'Volgens Abu Hurairah (moge Allah tevreden met hem zijn) zei de Profeet ﷺ: "Voor wie zijn wassing volledig verricht, worden tien goede daden genoteerd voor elk lichaamsdeel dat hij heeft gewassen." [Sahih Muslim 226]' },
          { titre: 'VOLLEDIGE WASSING = ENGELEN GETUIGEN', texte: 'Volgens Umar ibn al-Khattab (moge Allah tevreden met hem zijn) zei de Profeet ﷺ: "Wanneer een van jullie zijn wassing volledig verricht, getuigen de engelen voor hem: Moge Allah je reinigen!" [Jâmi\' at-Tirmidhi 13]' }
        ],
        pt: [
          { titre: 'A ABLUÇÃO APAGA OS PECADOS MENORES', texte: 'O Profeta ﷺ disse: «Quando o muçulmano realiza a sua ablução, os seus pecados saem das suas mãos, rosto, cabeça e pés com a água.» [Sahih Muslim 245]' },
          { titre: 'ÁGUA DA ABLUÇÃO = LUZ NO DIA DO JUÍZO', texte: 'Segundo Uthman ibn Affan (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «Quem realizar a sua ablução, a água que chegar aos seus pés será uma luz para ele no Último Dia.» [Jâmi\' at-Tirmidhi 22]' },
          { titre: 'A ABLUÇÃO = CHAVE DA ORAÇÃO', texte: 'Segundo Abu Hurayra (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «A oração não pode ser realizada sem ablução.» [Sahih Muslim 225]' },
          { titre: '10 RECOMPENSAS POR MEMBRO LAVADO', texte: 'Segundo Abu Hurayra (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «A quem realizar a sua ablução perfeitamente, são escritas dez boas ações por cada membro que lavou.» [Sahih Muslim 226]' },
          { titre: 'ABLUÇÃO PERFEITA = ANJOS TESTEMUNHAM', texte: 'Segundo Umar ibn al-Khattab (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «Quando um de vós realizar a sua ablução perfeitamente, os anjos testemunham por ele: Que Allah te purifique!» [Jâmi\' at-Tirmidhi 13]' }
        ],
        tr: [
          { titre: 'ABDEST KÜÇÜK GÜNAHları SİLER', texte: 'Peygamber ﷺ şöyle buyurdu: "Müslüman abdest aldığında günahları elleriyle, yüzüyle, başıyla ve ayaklarıyla birlikte su ile çıkar." [Sahih Muslim 245]' },
          { titre: 'ABDEST SUYU = KIYAMETte NUR', texte: 'Osman b. Affân\'dan (Allah ondan razı olsun); Peygamber ﷺ şöyle buyurdu: "Kim abdest alırsa ayaklarına değen su kıyamet günü ona nur olacaktır." [Câmi\'u\'t-Tirmizî 22]' },
          { titre: 'ABDEST = NAMAZIN ANAHTARI', texte: 'Ebû Hüreyre\'den (Allah ondan razı olsun); Peygamber ﷺ şöyle buyurdu: "Abdest olmadan namaz kabul olmaz." [Sahih Muslim 225]' },
          { titre: 'YIKANILAN HER UZUV İÇİN 10 SEVAP', texte: 'Ebû Hüreyre\'den (Allah ondan razı olsun); Peygamber ﷺ şöyle buyurdu: "Kim abdestini tam alırsa yıkadığı her uzuv için ona on hasene yazılır." [Sahih Muslim 226]' },
          { titre: 'TAM ABDEST = MELEKLER ŞAHIT OLUR', texte: 'Ömer b. Hattâb\'dan (Allah ondan razı olsun); Peygamber ﷺ şöyle buyurdu: "Biriniz abdestini tam aldığında melekler onun için şahitlik eder: Allah seni temizlesin!" [Câmi\'u\'t-Tirmizî 13]' }
        ]
      },
      sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar' }
    }
...
es: 'En el nombre de Allah. Oh Allah, me refugio en Ti de los demonios masculinos y femeninos', de: 'Im Namen Allahs. O Allah, ich suche Zuflucht bei Dir vor männlichen und weiblichen Teufeln.', it: 'Nel nome di Allah. O Allah, cerco rifugio in Te dai demoni maschili e femminili.', nl: 'In de naam van Allah. O Allah, ik zoek mijn toevlucht bij U voor mannelijke en vrouwelijke duivels.', pt: 'Em nome de Allah. Ó Allah, procuro refúgio em Ti dos demónios masculinos e femininos.', tr: 'Allah\'ın adıyla. Allah\'ım! Erkek ve dişi şeytanlardan Sana sığınırım.' },
      hadith: {
...
es: 'Narrado por Anas ibn Mâlik (que Allah esté complacido con él): «Cuando el Profeta ﷺ entraba al baño, decía: Allâhumma innî a\'ûdhu bika min al-khubuthi wal-khabâ\'ith.»\nFuente: Sahih al-Bukhârî (142) · Sahih Muslim (375)', de: 'Überliefert von Anas ibn Mâlik (möge Allah mit ihm zufrieden sein): „Wenn der Prophet ﷺ die Toilette betrat, sagte er: Allâhumma innî a\'ûdhu bika minal-khubuthi wal-khabâ\'ith.“\nQuelle: Sahih al-Bukhârî (142) · Sahih Muslim (375)', it: 'Riportato da Anas ibn Mâlik (che Allah sia soddisfatto di lui): «Quando il Profeta ﷺ entrava in bagno, diceva: Allāhummā innī a\'ūdhu bika minal-khubuthi wal-khabā\'ith.»\nFonte: Sahih al-Bukhârî (142) · Sahih Muslim (375)', nl: 'Overgeleverd door Anas ibn Mâlik (moge Allah tevreden met hem zijn): "Wanneer de Profeet ﷺ het toilet betrad, zei hij: Allaahummaa innee a\'oodhu bika minal khubuthi wal khabaa\'ith."\nBron: Sahih al-Bukhârî (142) · Sahih Muslim (375)', pt: 'Narrado por Anas ibn Mâlik (que Allah esteja satisfeito com ele): «Quando o Profeta ﷺ entrava na casa de banho, dizia: Allāhummā innī a\'ūdhu bika minal-khubuthi wal-khabā\'ith.»\nFonte: Sahih al-Bukhârî (142) · Sahih Muslim (375)', tr: 'Enes b. Mâlik\'ten (Allah ondan razı olsun) rivayet edilmiştir: "Peygamber ﷺ tuvalete girerken: Allâhümme innî eûzü bike minel-hubsi vel-habâis, derdi."\nKaynak: Sahihu\'l-Buhârî (142) · Sahih Muslim (375)' },
    ...
    acc2: {
      ...
      arabe: 'غُفْرَانَكَ',
      phonetique: { fr: 'Ghufrânak', en: 'Ghufraanak', es: 'Ghufraanak', de: 'Ghufrânak', it: 'Ghufrānak', nl: 'Ghufraanak', pt: 'Ghufrānak', tr: 'Gufrâneke'  , de: 'Ghufrânak', it: 'Ghufrānak', nl: 'Ghufraanak', pt: 'Ghufrānak', tr: 'Gufrâneke' },
    ...
    acc3: {
      ...
      items: {
        fr: [
          { titre: 'ENTRER PIED GAUCHE, SORTIR PIED DROIT', texte: 'D\'après Abou Hourayra (qu\'Allah l\'agrée) : « Le Messager d\'Allah ﷺ entrait aux toilettes en commençant par le pied gauche et sortait par le pied droit. » [Jami\' at-Tirmidhi 16]' },
          { titre: 'SE NETTOYER AVEC LA MAIN GAUCHE', texte: 'D\'après Salman al-Farisi (qu\'Allah l\'agrée) : « La main droite est pour manger et boire, la main gauche pour se nettoyer des impuretés. » [Sahih al-Bukhârî 153 · Sahih Muslim 267]' },
          { titre: 'NE PAS SE TOURNER VERS LA QIBLA', texte: 'D\'après Abu Ayyoub al-Ansari (qu\'Allah l\'agrée), le Prophète ﷺ a dit : « Lorsque vous allez à la selle, ne vous tournez ni face à la Qibla ni le dos à elle. » [Sahih al-Bukhârî 394]' },
          { titre: 'NE PAS PARLER AUX TOILETTES', texte: 'D\'après Aïcha (qu\'Allah l\'agrée) : « Le Messager d\'Allah ﷺ n\'a jamais parlé une seule fois aux toilettes. » [Sahih Muslim 262]' }
        ],
        en: [
          { titre: 'ENTER WITH LEFT FOOT, EXIT WITH RIGHT', texte: 'According to Abu Hurairah (may Allah be pleased with him): "The Messenger of Allah ﷺ entered the restroom with his left foot and exited with his right." [Jami\' at-Tirmidhi 16]' },
          { titre: 'CLEAN WITH THE LEFT HAND', texte: 'According to Salman al-Farisi (may Allah be pleased with him): "The right hand is for eating and drinking, the left for cleaning impurities." [Sahih al-Bukhari 153 · Sahih Muslim 267]' },
          { titre: 'DO NOT FACE THE QIBLA', texte: 'According to Abu Ayyub al-Ansari (may Allah be pleased with him), the Prophet ﷺ said: "When you go to relieve yourselves, do not face the Qibla or turn your backs to it." [Sahih al-Bukhari 394]' },
          { titre: 'DO NOT SPEAK IN THE RESTROOM', texte: 'According to Aisha (may Allah be pleased with her): "The Messenger of Allah ﷺ never spoke a single time in the restroom." [Sahih Muslim 262]' }
        ],
        es: [
          { titre: 'ENTRAR CON PIE IZQUIERDO, SALIR CON DERECHO', texte: 'Según Abu Hurairah (que Allah esté complacido con él): "El Mensajero de Allah ﷺ entraba al baño con el pie izquierdo y salía con el derecho." [Jami\' at-Tirmidhi 16]' },
          { titre: 'LIMPIARSE CON LA MANO IZQUIERDA', texte: 'Según Salman al-Farisi (que Allah esté complacido con él): "La mano derecha es para comer y beber, la izquierda para limpiar las impurezas." [Sahih al-Bujari 153 · Sahih Muslim 267]' },
          { titre: 'NO ORIENTARSE HACIA LA QIBLA', texte: 'Según Abu Ayyub al-Ansari (que Allah esté complacido con él), el Profeta ﷺ dijo: "Cuando vayáis a hacer vuestras necesidades, no os orientéis hacia la Qibla ni le deis la espalda." [Sahih al-Bujari 394]' },
          { titre: 'NO HABLAR EN EL BAÑO', texte: 'Según Aisha (que Allah esté complacida con ella): "El Mensajero de Allah ﷺ nunca habló ni una sola vez en el baño." [Sahih Muslim 262]' }
        ],
        de: [
          { titre: 'MIT DEM LINKEN FUSS EINTRETEN, MIT DEM RECHTEN AUSTRETEN', texte: 'Gemäß Abu Hurayra (möge Allah mit ihm zufrieden sein): „Der Gesandte Allahs ﷺ betrat die Toilette mit dem linken Fuß und verließ sie mit dem rechten." [Jâmi\' at-Tirmidhi 16]' },
          { titre: 'MIT DER LINKEN HAND REINIGEN', texte: 'Gemäß Salman al-Fârisi (möge Allah mit ihm zufrieden sein): „Die rechte Hand ist zum Essen und Trinken, die linke zum Reinigen von Unreinheiten." [Sahih al-Bukhârî 153 · Sahih Muslim 267]' },
          { titre: 'NICHT ZUR QIBLA WENDEN', texte: 'Gemäß Abu Ayyub al-Ansari (möge Allah mit ihm zufrieden sein) sagte der Prophet ﷺ: „Wenn ihr die Notdurft verrichtet, wendet weder Gesicht noch Rücken der Qibla zu." [Sahih al-Bukhârî 394]' },
          { titre: 'NICHT AUF DER TOILETTE SPRECHEN', texte: 'Gemäß Aisha (möge Allah mit ihr zufrieden sein): „Der Gesandte Allahs ﷺ hat auf der Toilette kein einziges Mal gesprochen." [Sahih Muslim 262]' }
        ],
        it: [
          { titre: 'ENTRARE CON IL PIEDE SINISTRO, USCIRE CON IL DESTRO', texte: 'Secondo Abu Hurayra (che Allah sia soddisfatto di lui): «Il Messaggero di Allah ﷺ entrava in bagno con il piede sinistro e usciva con il destro.» [Jâmi\' at-Tirmidhi 16]' },
          { titre: 'PULIRSI CON LA MANO SINISTRA', texte: 'Secondo Salman al-Farisi (che Allah sia soddisfatto di lui): «La mano destra è per mangiare e bere, la sinistra per pulire le impurità.» [Sahih al-Bukhārī 153 · Sahih Muslim 267]' },
          { titre: 'NON VOLTARSI VERSO LA QIBLA', texte: 'Secondo Abu Ayyub al-Ansari (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «Quando fate i vostri bisogni, non rivolgetevi verso la Qibla né di fronte né di schiena.» [Sahih al-Bukhārī 394]' },
          { titre: 'NON PARLARE IN BAGNO', texte: 'Secondo Aisha (che Allah sia soddisfatta di lei): «Il Messaggero di Allah ﷺ non ha mai parlato una sola volta in bagno.» [Sahih Muslim 262]' }
        ],
        nl: [
          { titre: 'BINNENGAAN MET DE LINKERVOET, VERLATEN MET DE RECHTER', texte: 'Volgens Abu Hurairah (moge Allah tevreden met hem zijn): "De Boodschapper van Allah ﷺ betrad het toilet met de linkervoet en verliet het met de rechter." [Jâmi\' at-Tirmidhi 16]' },
          { titre: 'REINIGEN MET DE LINKERHAND', texte: 'Volgens Salman al-Farisi (moge Allah tevreden met hem zijn): "De rechterhand is voor eten en drinken, de linker voor het reinigen van onzuiverheden." [Sahih al-Bukhârî 153 · Sahih Muslim 267]' },
          { titre: 'NIET RICHTING DE QIBLA KEREN', texte: 'Volgens Abu Ayyub al-Ansari (moge Allah tevreden met hem zijn), de Profeet ﷺ zei: "Wanneer jullie je behoefte doen, keer je gezicht noch je rug naar de Qibla." [Sahih al-Bukhârî 394]' },
          { titre: 'NIET PRATEN OP HET TOILET', texte: 'Volgens Aisha (moge Allah tevreden met haar zijn): "De Boodschapper van Allah ﷺ heeft nooit één keer op het toilet gesproken." [Sahih Muslim 262]' }
        ],
        pt: [
          { titre: 'ENTRAR COM O PÉ ESQUERDO, SAIR COM O DIREITO', texte: 'Segundo Abu Hurayra (que Allah esteja satisfeito com ele): «O Mensageiro de Allah ﷺ entrava na casa de banho com o pé esquerdo e saía com o direito.» [Jâmi\' at-Tirmidhi 16]' },
          { titre: 'LIMPAR COM A MÃO ESQUERDA', texte: 'Segundo Salman al-Farisi (que Allah esteja satisfeito com ele): «A mão direita é para comer e beber, a esquerda para limpar as impurezas.» [Sahih al-Bukhārī 153 · Sahih Muslim 267]' },
          { titre: 'NÃO SE VIRAR PARA A QIBLA', texte: 'Segundo Abu Ayyub al-Ansari (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «Quando fordes fazer as vossas necessidades, não volteis o rosto nem as costas para a Qibla.» [Sahih al-Bukhārī 394]' },
          { titre: 'NÃO FALAR NA CASA DE BANHO', texte: 'Segundo Aisha (que Allah esteja satisfeito com ela): «O Mensageiro de Allah ﷺ nunca falou uma única vez na casa de banho.» [Sahih Muslim 262]' }
        ],
        tr: [
          { titre: 'SOL AYAKLA GİRMEK, SAĞ AYAKLA ÇIKMAK', texte: 'Ebû Hüreyre\'den (Allah ondan razı olsun): "Allah\'ın Rasûlü ﷺ tuvalete sol ayağıyla girer, sağ ayağıyla çıkardı." [Câmi\'u\'t-Tirmizî 16]' },
          { titre: 'SOL ELLE TEMİZLENMEK', texte: 'Selmân el-Fârisî\'den (Allah ondan razı olsun): "Sağ el yemek ve içmek içindir, sol el ise necaset temizlemek için." [Sahihu\'l-Buhârî 153 · Sahih Muslim 267]' },
          { titre: 'KIBLÉYE DÖNMEMEK', texte: 'Ebû Eyyûb el-Ensârî\'den (Allah ondan razı olsun); Peygamber ﷺ şöyle buyurdu: "Hacetinizi giderirken kıbleye ne yüzünüzü ne de arkanızı dönün." [Sahihu\'l-Buhârî 394]' },
          { titre: 'TUVALETTE KONUŞMAMAK', texte: '\'Âişe\'den (Allah ondan razı olsun): "Allah\'ın Rasûlü ﷺ tuvalette hiç konuşmamıştır." [Sahih Muslim 262]' }
        ]
      },
      sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar' }
    }
...
es: 'En el nombre de Allah entramos, en el nombre de Allah salimos, y en Allah nuestro Señor confiamos.', de: 'Im Namen Allahs betreten wir es, im Namen Allahs verlassen wir es, und auf Allah, unseren Herrn, vertrauen wir.', it: 'Nel nome di Allah entriamo, nel nome di Allah usciamo, e in Allah nostro Signore confidiamo.', nl: 'In de naam van Allah gaan wij naar binnen, in de naam van Allah verlaten wij het, en op Allah onze Heer vertrouwen wij.', pt: 'Em nome de Allah entramos, em nome de Allah saímos, e em Allah nosso Senhor confiamos.', tr: 'Allah\'ın adıyla girdik, Allah\'ın adıyla çıktık, Rabbimiz Allah\'a tevekkül ettik.' },
      hadith: {
...
es: 'Bismilláah, tawakkaltu \'alalláah, wa laa hawla wa laa qúwwata illaa billáah', de: 'Bismillâh, tawakkaltu \'alâ Allâh, wa lâ hawla wa lâ quwwata illâ billâh', it: 'Bismillāh, tawakkaltu \'alā Allāh, wa lā ḥawla wa lā quwwata illā billāh', nl: 'Bismillaah, tawakkaltu \'alallaah, wa laa hawla wa laa quwwata illaa billaah', pt: 'Bismillāh, tawakkaltu \'alā Allāh, wa lā ḥawla wa lā quwwata illā billāh', tr: 'Bismillâh',
      traduction: {
...
es: 'En el nombre de Allah, confío en Allah, y no hay fuerza ni poder excepto con Allah.', de: 'Im Namen Allahs, ich vertraue auf Allah, und es gibt keine Kraft noch Macht außer bei Allah.', it: 'Nel nome di Allah, ripongo la mia fiducia in Allah, e non c\'è forza né potere se non in Allah.', nl: 'In de naam van Allah, ik stel mijn vertrouwen in Allah, en er is geen macht noch kracht behalve bij Allah.', pt: 'Em nome de Allah, deposito a minha confiança em Allah, e não há força nem poder senão em Allah.', tr: 'Allah\'ın adıyla' },
      hadith: {
...
es: 'Narrado por Abu Mâlik al-Ash\'arî (que Allah esté complacido con él), el Profeta ﷺ enseñaba esta invocación para cuando se sale de casa.\nFuente: Sunan Abu Daoud (5095)', de: 'Überliefert von Abu Mâlik al-Ash\'arî (möge Allah mit ihm zufrieden sein), der Prophet ﷺ lehrte dieses Bittgebet für den Moment, wenn man das Haus verlässt.\nQuelle: Sunan Abî Dâwûd (5095)', it: 'Riportato da Abu Mâlik al-Ash\'arî (che Allah sia soddisfatto di lui), il Profeta ﷺ insegnava questa invocazione per quando si esce di casa.\nFonte: Sunan Abî Dâwûd (5095)', nl: 'Overgeleverd door Abu Mâlik al-Ash\'arî (moge Allah tevreden met hem zijn), de Profeet ﷺ leerde dit smeekgebed voor het moment waarop men het huis verlaat.\nBron: Sunan Abî Dâwûd (5095)', pt: 'Narrado por Abu Mâlik al-Ash\'arî (que Allah esteja satisfeito com ele), o Profeta ﷺ ensinava esta invocação para quando se sai de casa.\nFonte: Sunan Abî Dâwûd (5095)', tr: 'Ebû Mâlik el-Eş\'arî\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ bu duayı evden çıkarken okunmak üzere öğretirdi.\nKaynak: Sünen-i Ebî Dâvûd (5095)' },
    ...
    acc4: {
      ...
      items: {
        fr: [
          { titre: 'DORMIR SUR LE CÔTÉ DROIT', texte: 'D\'après Aïcha (qu\'Allah l\'agrée), le Prophète ﷺ dormait sur le côté droit, la main droite sous la joue droite. [Sahih al-Bukhari 6311]' },
          { titre: 'FAIRE LES ABLUTIONS AVANT DE DORMIR', texte: 'Le Prophète ﷺ a dit : « Quand tu te couches, fais les ablutions comme pour la prière. » [Sahih al-Bukhari 6311]' },
          { titre: 'SOUFFLER DANS LES MAINS ET RÉCITER LES 3 SOURATES', texte: 'D\'après Aïcha, le Prophète ﷺ soufflait dans ses mains, récitait Al-Ikhlas, Al-Falaq et An-Nas trois fois chacune, puis les passait sur son corps. [Sahih al-Bukhari 5748]' },
          { titre: 'SECOUER SON LIT AVANT DE SE COUCHER', texte: 'Le Prophète ﷺ a dit : « Quand l\'un de vous va se coucher, qu\'il secoue son lit. » [Sahih al-Bukhari 6320]' },
          { titre: 'COMMENCER LA JOURNÉE AVEC LE DHIKR', texte: 'Le Prophète ﷺ a dit : « Quand l\'un de vous se lève le matin, qu\'il dise : Al-hamdu lillâhi lladhî ahyânâ... » [Sahih al-Bukhari 6312]' }
        ],
        en: [
          { titre: 'SLEEP ON THE RIGHT SIDE', texte: 'According to Aisha (may Allah be pleased with her), the Prophet ﷺ used to sleep on his right side, with his right hand under his right cheek. [Sahih al-Bukhari 6311]' },
          { titre: 'PERFORM ABLUTION BEFORE SLEEPING', texte: 'The Prophet ﷺ said: "When you go to bed, perform ablution as for prayer." [Sahih al-Bukhari 6311]' },
          { titre: 'BLOW INTO HANDS AND RECITE THE 3 SURAHS', texte: 'According to Aisha, the Prophet ﷺ used to blow into his hands, recite Al-Ikhlas, Al-Falaq and An-Nas three times each, then pass them over his body. [Sahih al-Bukhari 5748]' },
          { titre: 'SHAKE YOUR BED BEFORE LYING DOWN', texte: 'The Prophet ﷺ said: "When one of you goes to bed, let him shake out his bed." [Sahih al-Bukhari 6320]' },
          { titre: 'START THE DAY WITH DHIKR', texte: 'The Prophet ﷺ said: "When one of you wakes up in the morning, let him say: Al-hamdu lillahi lladhî ahyânâ..." [Sahih al-Bukhari 6312]' }
        ],
        es: [
          { titre: 'DORMIR SOBRE EL LADO DERECHO', texte: 'Según Aisha (que Allah esté complacida con ella), el Profeta ﷺ dormía sobre su lado derecho, con la mano derecha bajo la mejilla derecha. [Sahih al-Bujari 6311]' },
          { titre: 'HACER LA ABLUCIÓN ANTES DE DORMIR', texte: 'El Profeta ﷺ dijo: "Cuando vayas a acostarte, realiza las abluciones como para la oración." [Sahih al-Bujari 6311]' },
          { titre: 'SOPLAR EN LAS MANOS Y RECITAR LAS 3 SURAS', texte: 'Según Aisha, el Profeta ﷺ soplaba en sus manos, recitaba Al-Ikhlas, Al-Falaq y An-Nas tres veces cada una, luego las pasaba por su cuerpo. [Sahih al-Bujari 5748]' },
          { titre: 'SACUDIR LA CAMA ANTES DE ACOSTARSE', texte: 'El Profeta ﷺ dijo: "Cuando alguno de vosotros vaya a acostarse, que sacuda su cama." [Sahih al-Bujari 6320]' },
          { titre: 'COMENZAR EL DÍA CON DHIKR', texte: 'El Profeta ﷺ dijo: "Cuando alguno de vosotros se despierte por la mañana, que diga: Al-hamdu lillahi lladhî ahyânâ..." [Sahih al-Bujari 6312]' }
        ],
        de: [
          { titre: 'AUF DER RECHTEN SEITE SCHLAFEN', texte: 'Gemäß Aisha schlief der Prophet ﷺ auf seiner rechten Seite, die rechte Hand unter der rechten Wange. [Sahih al-Bukhârî 6311]' },
          { titre: 'VOR DEM SCHLAFEN DIE WASCHUNG VOLLZIEHEN', texte: 'Der Prophet ﷺ: „Wenn du dich schlafen legst, vollziehe die Waschung wie zum Gebet." [Sahih al-Bukhârî 6311]' },
          { titre: 'IN DIE HÄNDE BLASEN UND DIE 3 SUREN REZITIEREN', texte: 'Aisha berichtete: Der Prophet ﷺ blies in seine Hände, rezitierte Al-Ikhlas, Al-Falaq und An-Nas dreimal und wischte damit über seinen Körper. [Sahih al-Bukhârî 5748]' },
          { titre: 'DAS BETT VOR DEM HINLEGEN AUSSCHÜTTELN', texte: 'Der Prophet ﷺ: „Wenn einer von euch schlafen geht, soll er sein Bett ausschütteln." [Sahih al-Bukhârî 6320]' },
        ...
        it: [
          { titre: 'DORMIRE SUL LATO DESTRO', texte: 'Secondo Aisha (che Allah sia soddisfatta di lei), il Profeta ﷺ dormiva sul lato destro, con la mano destra sotto la guancia destra. [Sahih al-Bukhārī 6311]' },
          { titre: 'FARE L\'ABLUZIONE PRIMA DI DORMIRE', texte: 'Il Profeta ﷺ: «Quando vai a letto, fai l\'abluzione come per la preghiera.» [Sahih al-Bukhārī 6311]' },
          { titre: 'SOFFIARE NELLE MANI E RECITARE LE 3 SURE', texte: 'Secondo Aisha, il Profeta ﷺ soffiava nelle mani, recitava Al-Ikhlas, Al-Falaq e An-Nas tre volte ciascuna, poi le passava sul corpo. [Sahih al-Bukhārī 5748]' },
          { titre: 'SCUOTERE IL LETTO PRIMA DI CORICARSI', texte: 'Il Profeta ﷺ: «Quando uno di voi va a letto, che scuota il suo letto.» [Sahih al-Bukhārī 6320]' },
          { titre: 'INIZIARE LA GIORNATA CON IL DHIKR', texte: 'Il Profeta ﷺ: «Quando uno di voi si sveglia al mattino, dica: Al-hamdu lillâhi lladhî ahyânâ...» [Sahih al-Bukhārī 6312]' }
        ],
        nl: [
          { titre: 'SLAPEN OP DE RECHTERZIJDE', texte: 'Volgens Aisha (moge Allah tevreden met haar zijn) sliep de Profeet ﷺ op zijn rechterzijde, met zijn rechterhand onder zijn rechterwang. [Sahih al-Bukhârî 6311]' },
          { titre: 'DE WASSING VERRICHTEN VOOR HET SLAPEN', texte: 'De Profeet ﷺ: "Wanneer je naar bed gaat, verricht de wassing zoals voor het gebed." [Sahih al-Bukhârî 6311]' },
          { titre: 'IN DE HANDEN BLAZEN EN DE 3 SURA\'S RECITEREN', texte: 'Volgens Aisha blies de Profeet ﷺ in zijn handen, reciteerde Al-Ikhlas, Al-Falaq en An-Nas driemaal elk, en wreef daarmee over zijn lichaam. [Sahih al-Bukhârî 5748]' },
          { titre: 'HET BED AFSCHUDDEN VOOR HET LIGGEN', texte: 'De Profeet ﷺ: "Wanneer een van jullie gaat slapen, laat hem zijn bed afschudden." [Sahih al-Bukhârî 6320]' },
          { titre: 'DE DAG BEGINNEN MET DHIKR', texte: 'De Profeet ﷺ: "Wanneer een van jullie \'s ochtends wakker wordt, laat hem zeggen: Al-hamdu lillâhi lladhî ahyânâ..." [Sahih al-Bukhârî 6312]' }
        ],
        pt: [
          { titre: 'DORMIR SOBRE O LADO DIREITO', texte: 'Segundo Aisha (que Allah esteja satisfeito com ela), o Profeta ﷺ dormia sobre o lado direito, com a mão direita sob a face direita. [Sahih al-Bukhārī 6311]' },
          { titre: 'FAZER A ABLUÇÃO ANTES DE DORMIR', texte: 'O Profeta ﷺ: «Quando fores dormir, faz a ablução como para a oração.» [Sahih al-Bukhārī 6311]' },
          { titre: 'SOPRAR NAS MÃOS E RECITAR AS 3 SURAS', texte: 'Segundo Aisha, o Profeta ﷺ soprava nas mãos, recitava Al-Ikhlas, Al-Falaq e An-Nas três vezes cada uma e passava-as pelo corpo. [Sahih al-Bukhārī 5748]' },
          { titre: 'SACUDIR A CAMA ANTES DE SE DEITAR', texte: 'O Profeta ﷺ: «Quando um de vós for dormir, que sacuda a sua cama.» [Sahih al-Bukhārī 6320]' },
          { titre: 'COMEÇAR O DIA COM DHIKR', texte: 'O Profeta ﷺ: «Quando um de vós acordar de manhã, que diga: Al-hamdu lillâhi lladhî ahyânâ...» [Sahih al-Bukhārī 6312]' }
        ],
        tr: [
          { titre: 'SAĞ TARAFA YATMAK', texte: '\'Âişe\'den (Allah ondan razı olsun); Peygamber ﷺ sağ yanı üzerine, sağ elini sağ yanağının altına koyarak yatardı. [Sahihu\'l-Buhârî 6311]' },
          { titre: 'UYUMADAN ÖNCE ABDEST ALMAK', texte: 'Peygamber ﷺ: "Yatmak istediğinde namaz abdesti gibi abdest al." [Sahihu\'l-Buhârî 6311]' },
          { titre: 'ELLERİNE ÜFLEYEREK 3 SURE OKUMAK', texte: '\'Âişe\'den; Peygamber ﷺ ellerine üfler, Al-İhlâs, Al-Felak ve An-Nâs surelerini üçer kez okur ve ellerini vücuduna sürerdi. [Sahihu\'l-Buhârî 5748]' },
          { titre: 'YATMADAN ÖNCE YATAĞI SILKMAK', texte: 'Peygamber ﷺ: "Biriniz yatağa gideceğinde yatağını silksin." [Sahihu\'l-Buhârî 6320]' },
  ...
  maison: {
    ...
    acc5: {
      ...
      items: {
        ...
        de: [
          { titre: 'SALAM BEIM EINTRETEN', texte: 'Allah: "Wenn ihr in Häuser eintretet, grüßt euch mit einem Gruß von Allah, gesegnet und gut." [Koran 24:61] Der Prophet ﷺ pflegte beim Eintreten ins Haus zu grüßen.' },
          { titre: 'MIT DEM RECHTEN FUSS EINTRETEN', texte: 'Der Prophet ﷺ betrat das Haus immer zuerst mit dem rechten Fuß.' },
          { titre: 'DAS HAUS SAUBER HALTEN', texte: 'Der Prophet ﷺ: "Allah ist rein und liebt die Reinheit." [Tirmidhi 2799]' },
          { titre: 'BEVOR MAN SCHLÄFT AUFRÄUMEN', texte: 'Der Prophet ﷺ: "Löscht die Lampen bei Nacht aus, schließt die Türen und deckt die Gefäße ab." [Sahih al-Bukhârî 3280]' },
          { titre: 'SURAH AL-BAQARAH REZITIEREN', texte: 'Der Prophet ﷺ: "Rezitiert Surah al-Baqarah in euren Häusern, denn Satan flieht vor dem Haus, in dem sie rezitiert wird." [Sahih Muslim 780]' }
        ],
        it: [
          { titre: 'SALUTO ALL\'ENTRATA', texte: 'Allah: "Quando entrate nelle case, salutatevi con un saluto da Allah, benedetto e buono." [Corano 24:61] Il Profeta ﷺ era solito salutare quando entrava in casa.' },
          { titre: 'ENTRARE CON IL PIEDE DESTRO', texte: 'Il Profeta ﷺ entrava sempre in casa con il piede destro per primo.' },
          { titre: 'MANTENERE LA CASA PULITA', texte: 'Il Profeta ﷺ: «Allah è puro e ama la purezza.» [Tirmidhi 2799]' },
          { titre: 'RIORDINARE PRIMA DI DORMIRE', texte: 'Il Profeta ﷺ: «Spegnete le lampade di notte, chiudete le porte e coprite i recipienti.» [Sahih al-Bukhārī 3280]' },
          { titre: 'RECITARE SURAH AL-BAQARAH', texte: 'Il Profeta ﷺ: «Recitate Surah al-Baqarah nelle vostre case, poiché Satana fugge dalla casa in cui viene recitata.» [Sahih Muslim 780]' }
        ],
        nl: [
          { titre: 'SALAM BIJ BINNENKOMST', texte: 'Allah: "Wanneer jullie huizen betreden, groet elkaar met een groet van Allah, gezegend en goed." [Koran 24:61] De Profeet ﷺ placht te groeten bij het binnengaan.' },
          { titre: 'BINNENGAAN MET DE RECHTERVOET', texte: 'De Profeet ﷺ betrad het huis altijd als eerste met de rechtervoet.' },
          { titre: 'HET HUIS SCHOON HOUDEN', texte: 'De Profeet ﷺ: "Allah is rein en houdt van reinheid." [Tirmidhi 2799]' },
          { titre: 'OPRUIMEN VOOR HET SLAPEN', texte: 'De Profeet ﷺ: "Doof de lampen \'s nachts, sluit de deuren en dek de vaten af." [Sahih al-Bukhârî 3280]' },
          { titre: 'SURAH AL-BAQARAH RECITEREN', texte: 'De Profeet ﷺ: "Reciteer Surah al-Baqarah in jullie huizen, want Satan vlucht uit het huis waar zij gereciteerd wordt." [Sahih Muslim 780]' }
        ],
        pt: [
          { titre: 'SALAM AO ENTRAR', texte: 'Allah: "Quando entrardes nas casas, saudai-vos com uma saudação de Allah, abençoada e boa." [Alcorão 24:61] O Profeta ﷺ costumava cumprimentar ao entrar em casa.' },
          { titre: 'ENTRAR COM O PÉ DIREITO', texte: 'O Profeta ﷺ entrava sempre em casa primeiro com o pé direito.' },
          { titre: 'MANTER A CASA LIMPA', texte: 'O Profeta ﷺ: «Allah é puro e ama a pureza.» [Tirmidhi 2799]' },
          { titre: 'ARRUMAR ANTES DE DORMIR', texte: 'O Profeta ﷺ: «Apagai as lâmpadas à noite, fechai as portas e tapai os recipientes.» [Sahih al-Bukhārī 3280]' },
          { titre: 'RECITAR A SURAH AL-BAQARAH', texte: 'O Profeta ﷺ: «Recitai a Surah al-Baqarah nas vossas casas, pois Satanás foge da casa onde é recitada.» [Sahih Muslim 780]' }
        ],
        tr: [
          { titre: 'GİRERKEN SELAM VERMEK', texte: 'Allah: "Evlere girdiğinizde Allah\'tan bereketli bir selam olan birbirinize selam verin." [Kur\'an 24:61] Peygamber ﷺ eve girerken selam verirdi.' },
          { titre: 'SAĞ AYAKLA GİRMEK', texte: 'Peygamber ﷺ her zaman önce sağ ayağıyla eve girerdi.' },
          { titre: 'EVİ TEMİZ TUTMAK', texte: 'Peygamber ﷺ: "Allah temizdir, temizliği sever." [Tirmizî 2799]' },
          { titre: 'UYUMADAN ÖNCE TOPLAMAK', texte: 'Peygamber ﷺ: "Yatarken kandilleri söndürün, kapıları kapatın, kapları örtün." [Sahihu\'l-Buhârî 3280]' },
          { titre: 'BAKARA SURESİ OKUMAK', texte: 'Peygamber ﷺ: "Evlerinizde Bakara suresini okuyun; zira şeytan içinde okunduğu evden kaçar." [Sahih Muslim 780]' }
        ]
      },
      sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar' }
    }
...
es: 'Alláhummaa innee a\'údhu bika minal-hammi wal-hazani, wal-\'ayzi wal-kasali, wal-yubni wal-bujli, wa dhala\'id-dayni wa ghalabatir-riyaal.', de: 'Allâhumma innî a\'ûdhu bika minal-hammi wal-hazani, wal-\'ajzi wal-kasali, wal-jubni wal-bukhli, wa dala\'i d-dayni wa ghalabati r-rijâli.', it: 'Allāhummā innī a\'ūdhu bika minal-hammi wal-ḥazani, wal-\'ajzi wal-kasali, wal-jubni wal-bukhli, wa ḍala\'i d-dayni wa ghalabati r-rijāl.', nl: 'Allaahummaa innee a\'oodhu bika minal-hammi wal-hazani, wal-\'ajzi wal-kasali, wal-jubni wal-bukhli, wa dhala\'id-dayni wa ghalabatir-rijaal.', pt: 'Allāhummā innī a\'ūdhu bika minal-hammi wal-ḥazani, wal-\'ajzi wal-kasali, wal-jubni wal-bukhli, wa ḍala\'i d-dayni wa ghalabati r-rijāl.', tr: 'Allâhümme innî eûzü bike minel-hemmi vel-hazen',
      traduction: {
...
es: 'Alláhummaa innee \'abduka ibnu \'abdika ibnu amatika, naasiyatee biyadika... an taj\'alal-Qur\'aana rabee\'a qalbee, wa núura sadree, wa yalaa\'a huznee, wa dhahaaba hammee.', de: 'Allâhumma innî \'abduka ibnu \'abdika ibnu amatika, nâsiyatî biyadika... an taj\'ala l-Qur\'âna rabî\'a qalbî, wa nûra sadrî, wa jalâ\'a huznî, wa dhahâba hammî.', it: 'Allāhummā innī \'abduka ibnu \'abdika ibnu amatika, nāsiyatī biyadika... an taj\'alal-Qur\'āna rabī\'a qalbī, wa nūra ṣadrī, wa jalā\'a ḥuznī, wa dhahāba hammī.', nl: 'Allaahummaa innee \'abduka ibnu \'abdika ibnu amatika, naasiyatee biyadika... an taj\'alal-Qur\'aana rabee\'a qalbee, wa noora sadree, wa jalaa\'a huznee, wa dhahaaba hammee.', pt: 'Allāhummā innī \'abduka ibnu \'abdika ibnu amatika, nāsiyatī biyadika... an taj\'alal-Qur\'āna rabī\'a qalbī, wa nūra ṣadrī, wa jalā\'a ḥuznī, wa dhahāba hammī.', tr: 'Allâhümme innî abdüke',
      traduction: {
...
es: 'Narrado por \'Abdallah ibn Mas\'ûd (que Allah esté complacido con él), el Profeta ﷺ dijo: «No hay nadie afligido por la ansiedad o la tristeza que diga esta invocación, sin que Allah elimine su ansiedad y tristeza y las reemplace por alegría.»\nFuente: Musnad Ahmad (1/391), Sahih por al-Albânî', de: 'Überliefert von \'Abdallah ibn Mas\'ûd (möge Allah mit ihm zufrieden sein), der Prophet ﷺ sagte: „Es gibt niemanden, der von Angst oder Traurigkeit befallen wird und dieses Bittgebet spricht, ohne dass Allah seine Angst und Traurigkeit entfernt und durch Freude ersetzt.“\nQuelle: Musnad Ahmad (1/391), Sahih laut al-Albânî', it: 'Riportato da \'Abdallah ibn Mas\'ûd (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «Non c\'è nessuno afflitto dall\'ansia o dalla tristezza che dica questa invocazione, senza che Allah rimuova la sua ansia e tristezza e le sostituisca con gioia.»\nFonte: Musnad Ahmad (1/391), Sahih secondo al-Albânî', nl: 'Overgeleverd door \'Abdallah ibn Mas\'ûd (moge Allah tevreden met hem zijn), de Profeet ﷺ zei: "Er is niemand die door angst of verdriet getroffen wordt en dit smeekgebed zegt, zonder dat Allah zijn angst en verdriet wegneemt en vervangt door vreugde."\nBron: Musnad Ahmad (1/391), Sahih volgens al-Albânî', pt: 'Narrado por \'Abdallah ibn Mas\'ûd (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «Não há ninguém afligido pela ansiedade ou tristeza que diga esta invocação, sem que Allah remova a sua ansiedade e tristeza e as substitua por alegria.»\nFonte: Musnad Ahmad (1/391), Sahih segundo al-Albânî', tr: 'Abdullah b. Mes\'ûd\'dan (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ şöyle buyurdu: "Herhangi bir kimseye sıkıntı ve üzüntü isabet edip de bu duayı okursa mutlaka Allah onun sıkıntısını ve üzüntüsünü giderir, yerine sevinç verir."\nKaynak: Müsned-i Ahmed (1/391), Sahih — el-Albânî' },
    ...
    acc3: {
      ...
      items: {
        ...
        de: [
          { titre: 'DEN KORAN ALS TÄGLICHES HEILMITTEL NUTZEN', texte: 'Der Prophet ﷺ: "Es gibt keine Krankheit, gegen die Allah keine Heilung geschaffen hat." Lies täglich den Koran. [Sunan Ibn Mâjah 3438]' },
          { titre: 'VIEL ISTIGHFAR SPRECHEN', texte: 'Der Prophet ﷺ: "Wer viel um Vergebung bittet, dem wird Allah für jede Sorge einen Ausweg schaffen." [Sunan Abî Dâwûd 1518]' },
          { titre: 'DIE SCHUTZGEBETE REZITIEREN', texte: 'Der Prophet ﷺ pflegte morgens und abends die drei Quls dreimal zu rezitieren. [Sunan Abî Dâwûd 5082]' },
          { titre: 'GEBET UND GEDULD', texte: 'Allah: "O ihr, die ihr glaubt, sucht Hilfe in Geduld und Gebet. Wahrlich, Allah ist mit den Geduldigen." [Koran 2:153]' },
          { titre: 'VIEL SALAWAT SPRECHEN', texte: 'Der Prophet ﷺ: "Wer einmal für mich Salawat spricht, dem sendet Allah zehnmal Segnungen." [Sahih Muslim 408]' }
        ],
        it: [
          { titre: 'FAR DEL CORANO IL TUO RIMEDIO QUOTIDIANO', texte: 'Il Profeta ﷺ: «Non c\'è malattia per cui Allah non abbia creato una cura.» Leggi il Corano ogni giorno. [Sunan Ibn Mâjah 3438]' },
          { titre: 'FARE MOLTO ISTIGHFAR', texte: 'Il Profeta ﷺ: «Chi fa molto istighfar, Allah gli aprirà una via d\'uscita da ogni preoccupazione.» [Sunan Abî Dâwûd 1518]' },
          { titre: 'RECITARE LE SURE DI PROTEZIONE', texte: 'Il Profeta ﷺ era solito recitare al mattino e alla sera tre volte le tre Qul. [Sunan Abî Dâwûd 5082]' },
          { titre: 'PREGHIERA E PAZIENZA', texte: 'Allah: «O voi che credete, cercate aiuto nella pazienza e nella preghiera. In verità Allah è con i pazienti.» [Corano 2:153]' },
          { titre: 'FARE MOLTO SALAWAT', texte: 'Il Profeta ﷺ: «Chi pronuncia una salawat per me, Allah gli invierà dieci benedizioni.» [Sahih Muslim 408]' }
        ],
        nl: [
          { titre: 'MAAK DE KORAN JE DAGELIJKS GENEESMIDDEL', texte: 'De Profeet ﷺ: "Er is geen ziekte waarvoor Allah geen genezing heeft geschapen." Lees dagelijks de Koran. [Sunan Ibn Mâjah 3438]' },
          { titre: 'VEEL ISTIGHFAR ZEGGEN', texte: 'De Profeet ﷺ: "Wie veel istighfar zegt, zal Allah voor elke zorg een uitweg geven." [Sunan Abî Dâwûd 1518]' },
          { titre: 'DE BESCHERMENDE SURA\'S RECITEREN', texte: 'De Profeet ﷺ placht \'s ochtends en \'s avonds driemaal de drie Qul\'s te reciteren. [Sunan Abî Dâwûd 5082]' },
          { titre: 'GEBED EN GEDULD', texte: 'Allah: «O jullie die geloven, zoek hulp in geduld en gebed. Voorwaar, Allah is met de geduldigen.» [Koran 2:153]' },
          { titre: 'VEEL SALAWAT ZEGGEN', texte: 'De Profeet ﷺ: "Wie eenmaal salawat voor mij zegt, zal Allah tienmaal zegeningen sturen." [Sahih Muslim 408]' }
        ],
        pt: [
          { titre: 'FAZ DO ALCORÃO O TEU REMÉDIO DIÁRIO', texte: 'O Profeta ﷺ: «Não há doença para a qual Allah não tenha criado uma cura.» Lê o Alcorão diariamente. [Sunan Ibn Mâjah 3438]' },
          { titre: 'FAZ MUITO ISTIGHFAR', texte: 'O Profeta ﷺ: «Quem fizer muito istighfar, Allah abrirá uma saída para cada preocupação.» [Sunan Abî Dâwûd 1518]' },
          { titre: 'RECITA AS SURAS DE PROTEÇÃO', texte: 'O Profeta ﷺ costumava recitar de manhã e à tarde três vezes as três Qul. [Sunan Abî Dâwûd 5082]' },
          { titre: 'ORAÇÃO E PACIÊNCIA', texte: 'Allah: «Ó vós que credes, buscai ajuda na paciência e na oração. Em verdade, Allah está com os pacientes.» [Alcorão 2:153]' },
          { titre: 'FAZ MUITO SALAWAT', texte: 'O Profeta ﷺ: «Quem pronunciar um salawat por mim, Allah lhe enviará dez bênçãos.» [Sahih Muslim 408]' }
        ],
        tr: [
          { titre: 'KUR\'ANI GÜNLÜK İLACIN YAP', texte: 'Peygamber ﷺ: "Allah\'ın şifa yaratmadığı hiçbir hastalık yoktur." Kalp için her gün Kur\'an oku. [İbn Mâce 3438]' },
          { titre: 'ÇOK İSTİĞFAR ET', texte: 'Peygamber ﷺ: "Kim çok istiğfar ederse Allah ona her sıkıntıdan bir çıkış yolu açar." [Sünen-i Ebî Dâvûd 1518]' },
          { titre: 'KORUMA SURELERİNİ OKU', texte: 'Peygamber ﷺ sabah akşam üç Kul suresini üçer kez okurdu. [Sünen-i Ebî Dâvûd 5082]' },
          { titre: 'NAMAZ VE SABIR', texte: 'Allah: «Ey iman edenler! Sabır ve namazla yardım isteyin. Şüphesiz Allah sabredenlerle beraberdir.» [Kur\'an 2:153]' },
          { titre: 'ÇOK SALAVAT GETİR', texte: 'Peygamber ﷺ: "Kim bana bir kez salavat getirirse Allah ona on kez salat eder." [Sahih Muslim 408]' }
        ]
      },
      sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar' }
    }
...
es: 'Ibn Abbas narró que el Mensajero de Allah ﷺ buscaba refugio para Al-Hasan y Al-Husayn con esta súplica. Sahih al-Bukhari (3371).<br><br><strong style="color:var(--gold);">* 1 niño:</strong> Fonético: <em>U\'eedhuka</em> — Árabe: <span style="font-family:\'Amiri\',serif;">أُعِيذُكَ</span>'
    ...
    , sub_de: 'Hauptbittgebet', sub_it: 'Invocazione principale', sub_nl: 'Hoofdsmeekgebed', sub_pt: 'Invocação principal', sub_tr: 'Ana dua'},
    acc2: {
...
es: 'Narrado por Ibn \'Abbâs (que Allah esté complacido con ellos), el Profeta ﷺ pedía protección para al-Hasan y al-Husayn con esta invocación, como Ibrâhîm ﷺ lo hacía para Ismâ\'îl e Ishâq.\nFuente: Sahih al-Bukhârî (3371)', de: 'Überliefert von Ibn \'Abbâs (möge Allah mit ihnen beiden zufrieden sein), der Prophet ﷺ bat um Schutz für al-Hasan und al-Husayn mit diesem Bittgebet, wie Ibrâhîm ﷺ es für Ismâ\'îl und Ishâq tat.\nQuelle: Sahih al-Bukhârî (3371)', it: 'Riportato da Ibn \'Abbâs (che Allah sia soddisfatto di entrambi), il Profeta ﷺ chiedeva protezione per al-Hasan e al-Husayn con questa invocazione, come Ibrâhîm ﷺ faceva per Ismâ\'îl e Ishâq.\nFonte: Sahih al-Bukhârî (3371)', nl: 'Overgeleverd door Ibn \'Abbâs (moge Allah tevreden met hen beiden zijn), de Profeet ﷺ vroeg bescherming voor al-Hasan en al-Husayn met dit smeekgebed, zoals Ibrâhîm ﷺ dat deed voor Ismâ\'îl en Ishâq.\nBron: Sahih al-Bukhârî (3371)', pt: 'Narrado por Ibn \'Abbâs (que Allah esteja satisfeito com ambos), o Profeta ﷺ pedia proteção para al-Hasan e al-Husayn com esta invocação, como Ibrâhîm ﷺ fazia para Ismâ\'îl e Ishâq.\nFonte: Sahih al-Bukhârî (3371)', tr: 'İbn Abbâs\'tan (Allah onlardan razı olsun) rivayet edilmiştir; Peygamber ﷺ, İbrâhim ﷺ\'in İsmâil ve İshak için yaptığı gibi, Hasan ve Hüseyin için bu duayla koruma dilerdi.\nKaynak: Sahihu\'l-Buhârî (3371)' },
    ...
    acc3: {
      ...
      items: {
        ...
        de: [
          { titre: 'DIE SCHUTZGEBETE ÜBER KINDER REZITIEREN', texte: 'Gemäß \'Â\'isha rezitierte der Prophet ﷺ morgens und abends die drei Quls. Dasselbe empfiehlt sich zum Schutz der Kinder. [Sahih al-Bukhârî 5748]' },
          { titre: 'KINDER IN DEN SCHLAF BEGLEITEN', texte: 'Der Prophet ﷺ empfahl, jeden Abend Schutzgebete über Kinder zu sprechen.' },
          { titre: 'DEN ADHÂN INS OHR EINES NEUGEBORENEN SPRECHEN', texte: 'Es ist Sunnah, dem Neugeborenen den Adhân ins rechte Ohr und die Iqama ins linke Ohr zu sprechen. [Sunan Abî Dâwûd 5105]' },
          { titre: 'IM NAMEN ALLAHS FÜR DIE KINDER BETEN', texte: 'Der Prophet ﷺ betete: "O Allah, schütze meine Familie."' },
          { titre: 'KINDER DEN KORAN LEHREN', texte: 'Der Prophet ﷺ: "Der Beste unter euch ist, wer den Koran lernt und ihn lehrt." [Sahih al-Bukhârî 5027]' }
        ],
        it: [
          { titre: 'RECITARE LE SURE DI PROTEZIONE SUI BAMBINI', texte: 'Secondo \'Â\'isha, il Profeta ﷺ recitava le tre Qul mattina e sera. Lo stesso si raccomanda per la protezione dei bambini. [Sahih al-Bukhārī 5748]' },
          { titre: 'ACCOMPAGNARE I BAMBINI AL SONNO', texte: 'Il Profeta ﷺ raccomandava di recitare invocazioni protettive sui bambini ogni sera.' },
          { titre: 'RECITARE L\'ADHÂN ALL\'ORECCHIO DEL NEONATO', texte: 'È sunnah recitare l\'adhân all\'orecchio destro del neonato e l\'iqama a quello sinistro. [Sunan Abî Dâwûd 5105]' },
          { titre: 'PREGARE PER I BAMBINI', texte: 'Il Profeta ﷺ pregava: «O Allah, proteggi la mia famiglia.»' },
          { titre: 'INSEGNARE IL CORANO AI BAMBINI', texte: 'Il Profeta ﷺ: «Il migliore tra voi è colui che impara il Corano e lo insegna.» [Sahih al-Bukhārī 5027]' }
        ],
        nl: [
          { titre: 'DE BESCHERMENDE SURA\'S OVER KINDEREN RECITEREN', texte: 'Volgens \'Â\'isha reciteerde de Profeet ﷺ \'s ochtends en \'s avonds de drie Qul\'s. Hetzelfde wordt aanbevolen voor kinderen. [Sahih al-Bukhârî 5748]' },
          { titre: 'KINDEREN BEGELEIDEN NAAR DE SLAAP', texte: 'De Profeet ﷺ adviseerde elke avond beschermende smeekgebeden over kinderen te reciteren.' },
          { titre: 'DE ADHÂN FLUISTEREN IN HET OOR VAN EEN PASGEBORENE', texte: 'Het is sunnah om de adhân in het rechteroor van de pasgeborene te reciteren en de iqama in het linkeroor. [Sunan Abî Dâwûd 5105]' },
          { titre: 'BIDDEN VOOR KINDEREN', texte: 'De Profeet ﷺ bad: "O Allah, bescherm mijn familie."' },
          { titre: 'KINDEREN DE KORAN LEREN', texte: 'De Profeet ﷺ: "De beste onder jullie is degene die de Koran leert en het onderwijst." [Sahih al-Bukhârî 5027]' }
        ],
        pt: [
          { titre: 'RECITAR AS SURAS DE PROTEÇÃO SOBRE AS CRIANÇAS', texte: 'Segundo \'Â\'isha, o Profeta ﷺ recitava as três Qul de manhã e à tarde. O mesmo é recomendado para proteger as crianças. [Sahih al-Bukhārī 5748]' },
          { titre: 'ACOMPANHAR AS CRIANÇAS NO SONO', texte: 'O Profeta ﷺ recomendava recitar invocações protetoras sobre as crianças cada noite.' },
          { titre: 'RECITAR O ADHÂN AO OUVIDO DO RECÉM-NASCIDO', texte: 'É sunnah recitar o adhân ao ouvido direito do recém-nascido e a iqama ao ouvido esquerdo. [Sunan Abî Dâwûd 5105]' },
          { titre: 'REZAR PELAS CRIANÇAS', texte: 'O Profeta ﷺ rezava: «Ó Allah, protege a minha família.»' },
          { titre: 'ENSINAR O ALCORÃO ÀS CRIANÇAS', texte: 'O Profeta ﷺ: «O melhor entre vós é quem aprende o Alcorão e o ensina.» [Sahih al-Bukhārī 5027]' }
        ],
        tr: [
          { titre: 'ÇOCUKLAR ÜZERINE KORUMA SURELERİ OKUMAK', texte: '\'Âişe\'den; Peygamber ﷺ sabah akşam üç Kul suresini okurdu. Çocukların korunması için de tavsiye edilir. [Sahihu\'l-Buhârî 5748]' },
          { titre: 'ÇOCUKLARI UYURKEN KORUMAK', texte: 'Peygamber ﷺ her akşam çocuklar uyumadan önce koruma duaları okunmasını tavsiye ederdi.' },
          { titre: 'YENİDOĞANIN KULAĞINA EZAN OKUMAK', texte: 'Yeni doğan bebeğin sağ kulağına ezan, sol kulağına kamet okumak sünnettir. [Sünen-i Ebî Dâvûd 5105]' },
          { titre: 'ÇOCUKLARA DUA ETMEK', texte: 'Peygamber ﷺ şöyle dua ederdi: "Allah\'ım! Ailemi koru."' },
          { titre: 'ÇOCUKLARA KUR\'AN ÖĞRETMEk', texte: 'Peygamber ﷺ: "Sizin en hayırlınız Kur\'an\'ı öğrenen ve öğretendir." [Sahihu\'l-Buhârî 5027]' }
        ]
      },
      sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar' }
    }
...
es: 'Narrado por Ibn \'Umar (que Allah esté complacido con ellos): «Cuando el Profeta ﷺ montaba en su cabalgadura para viajar, decía Allâhu Akbar tres veces, luego decía esta invocación.»\nFuente: Sunan Abu Daoud (2602) · Tirmidhi (3446)', de: 'Überliefert von Ibn \'Umar (möge Allah mit ihnen beiden zufrieden sein): „Wenn der Prophet ﷺ auf sein Reittier stieg, um zu reisen, sagte er dreimal Allâhu Akbar, dann sprach er dieses Bittgebet.“\nQuelle: Sunan Abî Dâwûd (2602) · Tirmidhi (3446)', it: 'Riportato da Ibn \'Umar (che Allah sia soddisfatto di entrambi): «Quando il Profeta ﷺ saliva sulla sua cavalcatura per viaggiare, diceva tre volte Allâhu Akbar, poi diceva questa invocazione.»\nFonte: Sunan Abî Dâwûd (2602) · Tirmidhi (3446)', nl: 'Overgeleverd door Ibn \'Umar (moge Allah tevreden met hen beiden zijn): "Wanneer de Profeet ﷺ op zijn rijdier steeg om te reizen, zei hij driemaal Allâhu Akbar, dan zei hij dit smeekgebed."\nBron: Sunan Abî Dâwûd (2602) · Tirmidhi (3446)', pt: 'Narrado por Ibn \'Umar (que Allah esteja satisfeito com ambos): «Quando o Profeta ﷺ montava na sua montaria para viajar, dizia Allâhu Akbar três vezes, depois dizia esta invocação.»\nFonte: Sunan Abî Dâwûd (2602) · Tirmidhi (3446)', tr: 'İbn Ömer\'den (Allah onlardan razı olsun) rivayet edilmiştir: "Peygamber ﷺ yolculuk için bineğine bindiğinde üç kez Allahu Ekber der, ardından bu duayı okurdu."\nKaynak: Sünen-i Ebî Dâvûd (2602) · Tirmizî (3446)' },
      audio: 'transport1.mp3',
      sheet: { sub_fr: 'Subhâna alladhî', sub_en: 'Subhâna alladhî', sub_es: 'Subhâna alladhî' }
    , sub_de: 'Subhâna alladhî', sub_it: 'Subhāna lladhī', sub_nl: 'Subhâna alladhî', sub_pt: 'Subhāna lladhī', sub_tr: 'Sübhânellezî'},
    acc2: {
...
es: 'Narrado por Ibn \'Umar (que Allah esté complacido con ellos): «El Profeta ﷺ decía esta invocación durante sus viajes, mañana y tarde.»\nFuente: Sahih Muslim (1342)', de: 'Überliefert von Ibn \'Umar (möge Allah mit ihnen beiden zufrieden sein): „Der Prophet ﷺ pflegte dieses Bittgebet während seiner Reisen morgens und abends zu sprechen.“\nQuelle: Sahih Muslim (1342)', it: 'Riportato da Ibn \'Umar (che Allah sia soddisfatto di entrambi): «Il Profeta ﷺ era solito dire questa invocazione durante i suoi viaggi, mattina e sera.»\nFonte: Sahih Muslim (1342)', nl: 'Overgeleverd door Ibn \'Umar (moge Allah tevreden met hen beiden zijn): "De Profeet ﷺ placht dit smeekgebed tijdens zijn reizen te zeggen, \'s ochtends en \'s avonds."\nBron: Sahih Muslim (1342)', pt: 'Narrado por Ibn \'Umar (que Allah esteja satisfeito com ambos): «O Profeta ﷺ costumava dizer esta invocação durante as suas viagens, de manhã e à tarde.»\nFonte: Sahih Muslim (1342)', tr: 'İbn Ömer\'den (Allah onlardan razı olsun) rivayet edilmiştir: "Peygamber ﷺ yolculuklarında sabah ve akşam bu duayı okurdu."\nKaynak: Sahih Muslim (1342)' },
      audio: 'transport2.mp3',
      sheet: { sub_fr: 'Variante complète', sub_en: 'Complete variant', sub_es: 'Variante completa' }
    , sub_de: 'Vollständige Variante', sub_it: 'Variante completa', sub_nl: 'Volledige variant', sub_pt: 'Variante completa', sub_tr: 'Tam versiyon'},
    acc3: {
      titre: { fr: 'SUNNAHS DU PROPHÈTE ﷺ', en: 'PROPHET\'S ﷺ SUNNAH', es: 'SUNNAH DEL PROFETA ﷺ', de: 'SUNNA DES PROPHETEN ﷺ', it: 'SUNNAH DEL PROFETA ﷺ', nl: 'SOENNA VAN DE PROFEET ﷺ', pt: 'SUNNAH DO PROFETA ﷺ', tr: 'PEYGAMBERİN ﷺ SÜNNETİ' },
      sunnah: true,
      items: {
        fr: [
          { titre: 'DIRE BISMILLAH AVANT TOUT DÉPART', texte: 'Le Prophète ﷺ a dit : « Quand l\'homme sort de sa maison et dit Bismillâh, tawakkaltu \'alallâh, on lui dit : Tu es guidé, préservé et protégé. » [Sahih Muslim 2727]' },
          { titre: 'PARTIR LE JEUDI SI POSSIBLE', texte: 'D\'après Ka\'b ibn Malik (qu\'Allah l\'agrée) : « Le Prophète ﷺ partait rarement en voyage un jour autre que le jeudi. » [Sahih al-Bukhârî 2950]' },
          { titre: 'PRÉVENIR QUELQU\'UN AVANT DE PARTIR', texte: 'Le Prophète ﷺ avait l\'habitude de prévenir sa famille et ses proches avant tout départ en voyage.' },
          { titre: 'DIRE TAKBIR EN MONTÉE, TASBIH EN DESCENTE', texte: 'D\'après Jabir (qu\'Allah l\'agrée) : « Quand nous montions, nous disions Allahu Akbar, et quand nous descendions, nous disions Subhanallah. » [Sahih al-Bukhârî 2993]' },
          { titre: 'PRIER DEUX RAK\'AT À LA MOSQUÉE AU RETOUR', texte: 'D\'après Ka\'b ibn Malik (qu\'Allah l\'agrée) : « Le Prophète ﷺ, à son retour de voyage, commençait par la mosquée et y priait deux rak\'at. » [Sahih al-Bukhârî 3088]' }
        ],
        en: [
          { titre: 'SAY BISMILLAH BEFORE EVERY DEPARTURE', texte: 'The Prophet ﷺ said: "When a man leaves his house and says Bismillah, tawakkaltu \'alallah, it is said to him: You are guided, protected and preserved." [Sahih Muslim 2727]' },
          { titre: 'DEPART ON THURSDAY IF POSSIBLE', texte: 'According to Ka\'b ibn Malik (may Allah be pleased with him): "The Prophet ﷺ rarely set out on a journey on a day other than Thursday." [Sahih al-Bukhari 2950]' },
          { titre: 'INFORM SOMEONE BEFORE DEPARTING', texte: 'The Prophet ﷺ used to inform his family and loved ones before every journey.' },
          { titre: 'SAY TAKBIR GOING UP, TASBIH GOING DOWN', texte: 'According to Jabir (may Allah be pleased with him): "Whenever we went up, we would say Allahu Akbar, and whenever we came down, we would say Subhanallah." [Sahih al-Bukhari 2993]' },
          { titre: 'PRAY TWO RAK\'AH AT THE MOSQUE ON RETURN', texte: 'According to Ka\'b ibn Malik (may Allah be pleased with him): "The Prophet ﷺ, upon returning from a journey, would begin at the mosque and pray two rak\'ah." [Sahih al-Bukhari 3088]' }
        ],
        es: [
          { titre: 'DECIR BISMILLAH ANTES DE CADA PARTIDA', texte: 'El Profeta ﷺ dijo: "Cuando el hombre sale de su casa y dice Bismillah, tawakkaltu \'alallah, se le dice: Estás guiado, protegido y preservado." [Sahih Muslim 2727]' },
          { titre: 'PARTIR EL JUEVES SI ES POSIBLE', texte: 'Según Ka\'b ibn Malik (que Allah esté complacido con él): "El Profeta ﷺ raramente emprendía un viaje en un día que no fuera el jueves." [Sahih al-Bujari 2950]' },
          { titre: 'AVISAR A ALGUIEN ANTES DE PARTIR', texte: 'El Profeta ﷺ tenía la costumbre de avisar a su familia y seres queridos antes de cualquier viaje.' },
          { titre: 'DECIR TAKBIR AL SUBIR, TASBIH AL BAJAR', texte: 'Según Jabir (que Allah esté complacido con él): "Cuando subíamos, decíamos Allahu Akbar, y cuando bajábamos, decíamos Subhanallah." [Sahih al-Bujari 2993]' },
          { titre: 'REZAR DOS RAK\'AT EN LA MEZQUITA AL REGRESAR', texte: 'Según Ka\'b ibn Malik (que Allah esté complacido con él): "El Profeta ﷺ, al regresar de un viaje, empezaba por la mezquita y rezaba dos rak\'at." [Sahih al-Bujari 3088]' }
        ],
        de: [
          { titre: 'VOR JEDEM AUFBRUCH BISMILLAH SAGEN', texte: 'Der Prophet ﷺ sagte: „Wenn ein Mann sein Haus verlässt und sagt: Bismillah, tawakkaltu \'alallah, wird ihm gesagt: Du bist geleitet, geschützt und bewahrt." [Sahih Muslim 2727]' },
          { titre: 'WENN MÖGLICH AM DONNERSTAG AUFBRECHEN', texte: 'Gemäß Ka\'b ibn Malik (möge Allah mit ihm zufrieden sein): „Der Prophet ﷺ brach selten an einem anderen Tag als Donnerstag auf." [Sahih al-Bukhârî 2950]' },
          { titre: 'JEMANDEN VOR DER ABREISE INFORMIEREN', texte: 'Der Prophet ﷺ pflegte seine Familie und seine Lieben vor jeder Reise zu informieren.' },
          { titre: 'BEIM AUFSTIEG TAKBIR, BEIM ABSTIEG TASBIH', texte: 'Gemäß Jabir (möge Allah mit ihm zufrieden sein): „Wenn wir aufstiegen, sagten wir Allahu Akbar, und wenn wir abstiegen, sagten wir Subhanallah." [Sahih al-Bukhârî 2993]' },
          { titre: 'BEI DER RÜCKKEHR ZWEI RAK\'AH IN DER MOSCHEE BETEN', texte: 'Gemäß Ka\'b ibn Malik (möge Allah mit ihm zufrieden sein): „Der Prophet ﷺ begann bei seiner Rückkehr von einer Reise in der Moschee und betete zwei Rak\'ah." [Sahih al-Bukhârî 3088]' }
        ],
        it: [
          { titre: 'DIRE BISMILLAH PRIMA DI OGNI PARTENZA', texte: 'Il Profeta ﷺ disse: «Quando un uomo esce di casa e dice Bismillah, tawakkaltu \'alallah, gli viene detto: Sei guidato, protetto e preservato.» [Sahih Muslim 2727]' },
          { titre: 'PARTIRE DI GIOVEDÌ SE POSSIBILE', texte: 'Secondo Ka\'b ibn Malik (che Allah sia soddisfatto di lui): «Il Profeta ﷺ raramente intraprendeva un viaggio in un giorno diverso dal giovedì.» [Sahih al-Bukhārī 2950]' },
          { titre: 'AVVISARE QUALCUNO PRIMA DI PARTIRE', texte: 'Il Profeta ﷺ era solito avvisare la sua famiglia e i suoi cari prima di ogni viaggio.' },
          { titre: 'DIRE TAKBIR IN SALITA, TASBIH IN DISCESA', texte: 'Secondo Jabir (che Allah sia soddisfatto di lui): «Quando salivamo, dicevamo Allahu Akbar, e quando scendevamo, dicevamo Subhanallah.» [Sahih al-Bukhārī 2993]' },
          { titre: 'PREGARE DUE RAK\'AH ALLA MOSCHEA AL RITORNO', texte: 'Secondo Ka\'b ibn Malik (che Allah sia soddisfatto di lui): «Il Profeta ﷺ, al ritorno da un viaggio, iniziava dalla moschea e pregava due rak\'ah.» [Sahih al-Bukhārī 3088]' }
        ],
        nl: [
          { titre: 'BISMILLAH ZEGGEN VOOR ELKE VERTREK', texte: 'De Profeet ﷺ zei: "Wanneer een man zijn huis verlaat en zegt: Bismillah, tawakkaltu \'alallah, wordt hem gezegd: Je bent geleid, beschermd en bewaard." [Sahih Muslim 2727]' },
          { titre: 'INDIEN MOGELIJK OP DONDERDAG VERTREKKEN', texte: 'Volgens Ka\'b ibn Malik (moge Allah tevreden met hem zijn): "De Profeet ﷺ vertrok zelden op een andere dag dan donderdag." [Sahih al-Bukhârî 2950]' },
          { titre: 'IEMAND INFORMEREN VOOR VERTREK', texte: 'De Profeet ﷺ placht zijn familie en dierbaren te informeren voor elke reis.' },
          { titre: 'TAKBIR BIJ KLIMMEN, TASBIH BIJ DALEN', texte: 'Volgens Jabir (moge Allah tevreden met hem zijn): "Wanneer we omhoog gingen, zeiden we Allahu Akbar, en wanneer we omlaag gingen, zeiden we Subhanallah." [Sahih al-Bukhârî 2993]' },
          { titre: 'BIJ TERUGKOMST TWEE RAK\'AH BIDDEN IN DE MOSKEE', texte: 'Volgens Ka\'b ibn Malik (moge Allah tevreden met hem zijn): "De Profeet ﷺ begon bij zijn terugkeer van een reis in de moskee en bad twee rak\'ah." [Sahih al-Bukhârî 3088]' }
        ],
        pt: [
          { titre: 'DIZER BISMILLAH ANTES DE CADA PARTIDA', texte: 'O Profeta ﷺ disse: «Quando um homem sai de casa e diz Bismillah, tawakkaltu \'alallah, é-lhe dito: Estás guiado, protegido e preservado.» [Sahih Muslim 2727]' },
          { titre: 'PARTIR À QUINTA-FEIRA SE POSSÍVEL', texte: 'Segundo Ka\'b ibn Malik (que Allah esteja satisfeito com ele): «O Profeta ﷺ raramente partia em viagem num dia que não fosse quinta-feira.» [Sahih al-Bukhārī 2950]' },
          { titre: 'AVISAR ALGUÉM ANTES DE PARTIR', texte: 'O Profeta ﷺ tinha o hábito de avisar a sua família e entes queridos antes de qualquer viagem.' },
          { titre: 'DIZER TAKBIR A SUBIR, TASBIH A DESCER', texte: 'Segundo Jabir (que Allah esteja satisfeito com ele): «Quando subíamos, dizíamos Allahu Akbar, e quando descíamos, dizíamos Subhanallah.» [Sahih al-Bukhārī 2993]' },
          { titre: 'REZAR DUAS RAK\'AH NA MESQUITA AO REGRESSAR', texte: 'Segundo Ka\'b ibn Malik (que Allah esteja satisfeito com ele): «O Profeta ﷺ, ao regressar de uma viagem, começava pela mesquita e rezava duas rak\'ah.» [Sahih al-Bukhārī 3088]' }
        ],
        tr: [
          { titre: 'HER YOLCULUKTAN ÖNCE BİSMİLLAH DEMEK', texte: 'Peygamber ﷺ şöyle buyurdu: "Bir kimse evinden çıkıp Bismillah, tevekkeltü \'alellah dediğinde ona: Hidayete erdin, korundu ve muhafaza edildin denir." [Sahih Muslim 2727]' },
          { titre: 'MÜMKÜNSE PERŞEMBE GÜNÜ YOLA ÇIKMAK', texte: 'Ka\'b b. Mâlik\'ten (Allah ondan razı olsun): "Peygamber ﷺ yolculuğa nadiren Perşembe dışında bir günde çıkardı." [Sahihu\'l-Buhârî 2950]' },
          { titre: 'GİTMEDEN ÖNCE BİRİNİ HABERDAR ETMEK', texte: 'Peygamber ﷺ her yolculuktan önce ailesini ve yakınlarını haberdar ederdi.' },
          { titre: 'YOKUŞ ÇIKARKEN TEKBİR, İNERKEN TESBİH', texte: 'Câbir\'den (Allah ondan razı olsun): "Yüksek bir yere çıktığımızda Allahu Ekber, aşağıya indiğimizde Sübhanallah derdik." [Sahihu\'l-Buhârî 2993]' },
          { titre: 'DÖNÜŞTE MESCİDDE İKİ REKAT NAMAZ KILMAK', texte: 'Ka\'b b. Mâlik\'ten (Allah ondan razı olsun): "Peygamber ﷺ yolculuktan döndüğünde önce mescide gider ve iki rekat namaz kılardı." [Sahihu\'l-Buhârî 3088]' }
        ]
      },
      sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar' }
    }
