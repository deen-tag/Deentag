...
var DUAS = {
  ...
  repas: {
    ...
    acc2: {
      titre: {
        fr: 'Oubli de dire Bismillah',
        en: 'Forgot to say Bismillah',
        es: 'Olvidaste decir Bismillah'
      , de: 'Bismillah vergessen', it: 'Dimenticato il Bismillah', nl: 'Bismillah vergeten', pt: 'Esqueceu o Bismillah', tr: 'Besmeleyi unutma'},
    ...
    acc4: {
      titre: {
        fr: 'Les sunnahs du repas',
        en: 'Sunnahs of the meal',
        es: 'Sunnahs de la comida'
      , de: 'Sunnahs der Mahlzeit', it: 'Sunnah del pasto', nl: 'Soenna\'s van de maaltijd', pt: 'Sunnahs da refeição', tr: 'Yemek sünnetleri'},
      sunnah: true,
      items: {
        fr: [
  ...
  ablution: {
    ...
    acc1: {
      titre: { fr: 'Avant les ablutions', en: 'Before ablution', es: 'Antes de la ablución' , de: 'Vor der Waschung', it: 'Prima dell\'abluzione', nl: 'Voor de wassing', pt: 'Antes da ablução', tr: 'Abdestten önce'},
      arabe: 'بِسْمِ اللَّهِ',
      phonetique: { fr: 'Bismillâh', en: 'Bismillaah', es: 'Bismilláh', de: 'Bismillâh', it: 'Bismillāh', nl: 'Bismillâh', pt: 'Bismillāh', tr: 'Besmele' },
    ...
    acc2: {
      titre: { fr: 'Après les ablutions', en: 'After ablution', es: 'Después de la ablución' , de: 'Nach der Waschung', it: 'Dopo l\'abluzione', nl: 'Na de wassing', pt: 'Depois da ablução', tr: 'Abdestten sonra'},
    ...
    acc3: {
      titre: { fr: 'Après les ablutions (version complète)', en: 'After ablution (full version)', es: 'Después de la ablución (versión completa)' , de: 'Nach der Waschung (vollständige Version)', it: 'Dopo l\'abluzione (versione completa)', nl: 'Na de wassing (volledige versie)', pt: 'Depois da ablução (versão completa)', tr: 'Abdestten sonra (uzun versiyon)'},
  ...
  reveil: {
    ...
    acc1: {
      titre: { fr: 'Au réveil', en: 'Upon waking', es: 'Al despertar' , de: 'Beim Aufwachen', it: 'Al risveglio', nl: 'Bij het ontwaken', pt: 'Ao acordar', tr: 'Uyanınca'},
    ...
    acc2: {
      titre: { fr: 'Avant de dormir', en: 'Before sleeping', es: 'Antes de dormir' , de: 'Vor dem Schlafen', it: 'Prima di dormire', nl: 'Voor het slapen', pt: 'Antes de dormir', tr: 'Uyumadan önce'},
    ...
    acc3: {
      titre: { fr: 'Avant de dormir (version complète)', en: 'Before sleeping (full version)', es: 'Antes de dormir (versión completa)' , de: 'Vor dem Schlafen (vollständige Version)', it: 'Prima di dormire (versione completa)', nl: 'Voor het slapen (volledige versie)', pt: 'Antes de dormir (versão completa)', tr: 'Uyumadan önce (uzun versiyon)'},
    ...
    acc5: {
      titre: { fr: 'En cas de cauchemar', en: 'In case of a nightmare', es: 'En caso de pesadilla', de: 'Bei einem Albtraum', it: 'In caso di incubo', nl: 'Bij een nachtmerrie', pt: 'Em caso de pesadelo', tr: 'Kabus görünce' },
  ...
  toilettes: {
    ...
    acc1: {
      titre: { fr: 'Entrer aux toilettes', en: 'Entering the toilet', es: 'Entrar al baño' , de: 'Die Toilette betreten', it: 'Entrare in bagno', nl: 'Het toilet binnengaan', pt: 'Entrar na casa de banho', tr: 'Tuvalete girerken'},
    ...
    acc2: {
      titre: { fr: 'Sortir des toilettes', en: 'Leaving the toilet', es: 'Salir del baño' , de: 'Die Toilette verlassen', it: 'Uscire dal bagno', nl: 'Het toilet verlaten', pt: 'Sair da casa de banho', tr: 'Tuvaletten çıkarken'},
      arabe: 'غُفْرَانَكَ',
  ...
  maison: {
    ...
    acc1: {
      titre: { fr: 'Entrer chez soi', en: 'Entering home', es: 'Entrar en casa' , de: 'Zuhause ankommen', it: 'Entrare in casa', nl: 'Thuiskomen', pt: 'Entrar em casa', tr: 'Eve girerken'},
    ...
    acc2: {
      titre: { fr: 'Entrer chez soi (version complète)', en: 'Entering home (full version)', es: 'Entrar en casa (versión completa)' , de: 'Zuhause ankommen (vollständige Version)', it: 'Entrare in casa (versione completa)', nl: 'Thuiskomen (volledige versie)', pt: 'Entrar em casa (versão completa)', tr: 'Eve girerken (uzun versiyon)'},
    ...
    acc3: {
      titre: { fr: 'Sortir de chez soi', en: 'Leaving home', es: 'Salir de casa' , de: 'Das Haus verlassen', it: 'Uscire di casa', nl: 'Het huis verlaten', pt: 'Sair de casa', tr: 'Evden çıkarken'},
    ...
    acc4: {
      titre: { fr: 'Protection en quittant la maison', en: 'Protection when leaving home', es: 'Protección al salir de casa' , de: 'Schutz beim Verlassen des Hauses', it: 'Protezione uscendo di casa', nl: 'Bescherming bij het verlaten van huis', pt: 'Proteção ao sair de casa', tr: 'Evden çıkarken korunma'},
  ...
  tristesse: {
    ...
    acc1: {
      titre: { fr: 'Soucis, tristesse et dettes', en: 'Worries, sadness and debt', es: 'Preocupaciones, tristeza y deudas' , de: 'Sorgen, Traurigkeit und Schulden', it: 'Preoccupazioni, tristezza e debiti', nl: 'Zorgen, verdriet en schulden', pt: 'Preocupações, tristeza e dívidas', tr: 'Kaygı, üzüntü ve borç'},
    ...
    acc2: {
      titre: { fr: 'Apaiser son cœur', en: 'Soothing the heart', es: 'Calmar el corazón' , de: 'Das Herz beruhigen', it: 'Placare il cuore', nl: 'Het hart tot rust brengen', pt: 'Acalmar o coração', tr: 'Kalbi yatıştırmak'},
  ...
  enfants: {
    ...
    acc1: {
      titre: { fr: 'Protéger ses enfants', en: 'Protecting your children', es: 'Proteger a tus hijos' , de: 'Seine Kinder schützen', it: 'Proteggere i propri figli', nl: 'Je kinderen beschermen', pt: 'Proteger os seus filhos', tr: 'Çocukları korumak'},
    ...
    acc2: {
      titre: { fr: 'Protéger son enfant', en: 'Protecting your child', es: 'Proteger a tu hijo' , de: 'Sein Kind schützen', it: 'Proteggere il proprio figlio', nl: 'Je kind beschermen', pt: 'Proteger o seu filho', tr: 'Çocuğu korumak'},
    ...
    acc3: {
      titre: { fr: 'Les sunnahs de protection', en: 'Sunnahs of protection', es: 'Sunnahs de protección' , de: 'Schutz-Sunnahs', it: 'Sunnah di protezione', nl: 'Beschermende soenna\'s', pt: 'Sunnahs de proteção', tr: 'Koruma sünnetleri'},
      sunnah: true,
      items: {
        fr: [
  ...
  transport: {
    ...
    acc1: {
      titre: { fr: 'Monter dans un véhicule', en: 'Getting into a vehicle', es: 'Subir a un vehículo' , de: 'In ein Fahrzeug einsteigen', it: 'Salire su un veicolo', nl: 'Instappen in een voertuig', pt: 'Entrar num veículo', tr: 'Araca binerken'},
    ...
    acc2: {
      titre: { fr: 'Départ en voyage', en: 'Setting off on a journey', es: 'Salida de viaje', de: 'Reisebeginn', it: 'Partenza per il viaggio', nl: 'Vertrek op reis', pt: 'Partida de viagem', tr: 'Yolculuğa çıkarken' },
    ...
    acc3: {
      titre: { fr: 'Voyage (version complète)', en: 'Journey (full version)', es: 'Viaje (versión completa)' , de: 'Reise (vollständige Version)', it: 'Viaggio (versione completa)', nl: 'Reis (volledige versie)', pt: 'Viagem (versão completa)', tr: 'Yolculuk (uzun versiyon)'},
  ...
  mosquee: {
    ...
    acc1: {
      titre: { fr: 'Entrer à la mosquée', en: 'Entering the mosque', es: 'Entrar a la mezquita', de: 'Die Moschee betreten', it: 'Entrare in moschea', nl: 'De moskee binnengaan', pt: 'Entrar na mesquita', tr: 'Camiye girerken' },
    ...
    acc2: {
      titre: { fr: 'Sortir de la mosquée', en: 'Leaving the mosque', es: 'Salir de la mezquita', de: 'Die Moschee verlassen', it: 'Uscire dalla moschea', nl: 'De moskee verlaten', pt: 'Sair da mesquita', tr: 'Camiden çıkarken' },
  ...
  maladie: {
    ...
    acc1: {
      titre: { fr: 'Pour soi-même', en: 'For yourself', es: 'Para uno mismo', de: 'Für sich selbst', it: 'Per se stessi', nl: 'Voor jezelf', pt: 'Para si próprio', tr: 'Kendisi için' },
    ...
    acc2: {
      titre: { fr: 'Visiter un malade', en: 'Visiting a sick person', es: 'Visitar a un enfermo', de: 'Einen Kranken besuchen', it: 'Visitare un malato', nl: 'Een zieke bezoeken', pt: 'Visitar um doente', tr: 'Hasta ziyareti' },
  ...
  colere: {
    ...
    acc1: {
      titre: { fr: 'En cas de colère', en: 'In case of anger', es: 'En caso de ira', de: 'Bei Wut', it: 'In caso di rabbia', nl: 'Bij boosheid', pt: 'Em caso de raiva', tr: 'Öfkelenince' },
  ...
  rizq: {
    ...
    acc1: {
      titre: { fr: 'Pour la subsistance', en: 'For sustenance', es: 'Por el sustento', de: 'Für die Versorgung', it: 'Per il sostentamento', nl: 'Voor levensonderhoud', pt: 'Pelo sustento', tr: 'Rızık için' },
  ...
  ruqya: {
    ...
    acc1: {
      titre: { fr: 'Protection contre le mauvais œil', en: 'Protection from the evil eye', es: 'Protección contra el mal de ojo', de: 'Schutz vor dem bösen Blick', it: 'Protezione dal malocchio', nl: 'Bescherming tegen het boze oog', pt: 'Proteção contra o mau-olhado', tr: 'Nazardan korunma' },
  ...
  mariage: {
    ...
    acc1: {
      titre: { fr: 'Félicitations aux époux', en: 'Congratulating the newlyweds', es: 'Felicitaciones a los esposos', de: 'Glückwünsche an die Eheleute', it: 'Congratulazioni agli sposi', nl: 'Felicitaties aan het bruidspaar', pt: 'Felicitações aos noivos', tr: 'Evlilere tebrik' },
  ...
  ramadan: {
    ...
    acc1: {
      titre: { fr: 'Iftar', en: 'Iftar', es: 'Iftar', de: 'Iftar', it: 'Iftar', nl: 'Iftar', pt: 'Iftar', tr: 'İftar' },
    ...
    acc2: {
      titre: { fr: 'Nuit du Destin (Laylat al-Qadr)', en: 'Night of Decree (Laylat al-Qadr)', es: 'Noche del Decreto (Laylat al-Qadr)', de: 'Nacht der Bestimmung (Laylat al-Qadr)', it: 'Notte del Decreto (Laylat al-Qadr)', nl: 'Nacht van de Bestemming (Laylat al-Qadr)', pt: 'Noite do Decreto (Laylat al-Qadr)', tr: 'Kadir Gecesi (Laylat al-Qadr)' },
...
azan: {
  ...
  acc1: {
    titre: { fr: 'En entendant l\'appel à la prière (Adhan)', en: 'When hearing the call to prayer (Adhan)', es: 'Al escuchar la llamada a la oración (Adhan)', de: 'Beim Hören des Gebetsrufs (Adhan)', it: 'All\'ascolto della chiamata alla preghiera (Adhan)', nl: 'Bij het horen van de gebedsoproep (Adhan)', pt: 'Ao ouvir o chamado à oração (Adhan)', tr: 'Ezanı işitince (Ezan)' },
  ...
  acc2: {
    titre: { fr: 'Après l\'appel à la prière (Adhan)', en: 'After the call to prayer (Adhan)', es: 'Después de la llamada a la oración (Adhan)', de: 'Nach dem Gebetsruf (Adhan)', it: 'Dopo la chiamata alla preghiera (Adhan)', nl: 'Na de gebedsoproep (Adhan)', pt: 'Após o chamado à oração (Adhan)', tr: 'Ezandan sonra (Ezan)' },
...
salah: {
  ...
  acc1: {
    titre: { fr: 'Invocation d\'ouverture', en: 'Opening supplication', es: 'Súplica de apertura', de: 'Eröffnungsbittgebet', it: 'Invocazione di apertura', nl: 'Openingssmeekgebed', pt: 'Súplica de abertura', tr: 'Açılış duası' },
  ...
  acc2: {
    titre: { fr: 'En prosternation', en: 'In prostration', es: 'En la postración', de: 'In der Niederwerfung', it: 'Nella prosternazione', nl: 'In de neerwerping', pt: 'Na prostração', tr: 'Secdede' },
...
istikhara: {
  ...
  acc1: {
    titre: { fr: 'Prière de consultation (Istikhara)', en: 'Prayer of guidance (Istikhara)', es: 'Oración de consulta (Istikhara)', de: 'Konsultationsgebet (Istikhara)', it: 'Preghiera di consultazione (Istikhara)', nl: 'Consultatiegebed (Istikhara)', pt: 'Oração de consulta (Istikhara)', tr: 'İstihare namazı' },
...
mort: {
  ...
  acc1: {
    titre: { fr: 'À l\'annonce d\'un décès', en: 'Upon hearing of a death', es: 'Al conocer un fallecimiento', de: 'Bei der Nachricht eines Todesfalls', it: 'All\'annuncio di un decesso', nl: 'Bij het horen van een overlijden', pt: 'Ao saber de uma morte', tr: 'Bir ölüm haberi alınca' },
  ...
  acc2: {
    titre: { fr: 'Pour le défunt', en: 'For the deceased', es: 'Por el difunto', de: 'Für den Verstorbenen', it: 'Per il defunto', nl: 'Voor de overledene', pt: 'Pelo falecido', tr: 'Ölen için' },
...
hajjumra: {
  ...
  acc1: {
    titre: { fr: 'Formule du pèlerinage (Talbiyah)', en: 'Pilgrimage formula (Talbiyah)', es: 'Fórmula de la peregrinación (Talbiyah)', de: 'Pilgerformel (Talbiyah)', it: 'Formula del pellegrinaggio (Talbiyah)', nl: 'Bedevaartformule (Talbiyah)', pt: 'Fórmula da peregrinação (Talbiyah)', tr: 'Hac telbiyesi' },
  ...
  acc2: {
    titre: { fr: 'Jour d\'Arafat', en: 'Day of Arafat', es: 'Día de Arafat', de: 'Tag von Arafat', it: 'Giorno di Arafat', nl: 'Dag van Arafat', pt: 'Dia de Arafat', tr: 'Arefe Günü' },
...
nouveaune: {
  ...
  acc1: {
    titre: { fr: 'Protection du nouveau-né', en: 'Protection of the newborn', es: 'Protección del recién nacido', de: 'Schutz des Neugeborenen', it: 'Protezione del neonato', nl: 'Bescherming van de pasgeborene', pt: 'Proteção do recém-nascido', tr: 'Yeni doğan koruması' },
    arabe: 'أُعِيذُكَ بِكَلِمَاتِ اللَّهِ التَّامَّةِ، مِنْ كُلِّ شَيْطَانٍ وَهَامَّةٍ، وَمِنْ كُلِّ عَيْنٍ لَامَّةٍ',
...
pluie: {
  ...
  acc1: {
    titre: { fr: 'Quand il pleut', en: 'When it rains', es: 'Cuando llueve', de: 'Wenn es regnet', it: 'Quando piove', nl: 'Als het regent', pt: 'Quando chove', tr: 'Yağmur yağınca' },
  ...
  acc2: {
    titre: { fr: 'Après la pluie', en: 'After the rain', es: 'Después de la lluvia', de: 'Nach dem Regen', it: 'Dopo la pioggia', nl: 'Na de regen', pt: 'Depois da chuva', tr: 'Yağmurdan sonra' },
