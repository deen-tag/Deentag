...
en: 'BEFORE EATING',
es: 'ANTES DE COMER', de: 'VOR DEM ESSEN', it: 'PRIMA DI MANGIARE', nl: 'VOOR HET ETEN', pt: 'ANTES DE COMER', tr: 'YEMEKTEN ÖNCE' }
},
...
audio: 'repas1.mp3',
sheet: { sub_fr: 'Bismillah', sub_en: 'Bismillah', sub_es: 'Bismillah' , sub_de: 'Bismillah', sub_it: 'Bismillah', sub_nl: 'Bismillah', sub_pt: 'Bismillah', sub_tr: 'Bismillah'  }
},
acc2: {
titre: {
fr: 'SI OUBLI DE DIRE BISMILLAH AU DÉBUT',
en: 'IF YOU FORGET BISMILLAH AT THE START',
es: 'SI OLVIDAS DECIR BISMILLAH AL INICIO', de: 'WENN DU BISMILLAH AM ANFANG VERGISST', it: 'SE DIMENTICHI IL BISMILLAH ALL\'INIZIO', nl: 'ALS JE BISMILLAH AAN HET BEGIN VERGEET', pt: 'SE ESQUECERES O BISMILLAH NO INÍCIO', tr: 'BAŞTA BİSMİLLAH SÖYLEMEYI UNUTURSAN' }
},
...
es: 'En el nombre de Allah, al principio y al final', de: 'Im Namen Allahs, am Anfang und am Ende', it: 'Nel nome di Allah, all\'inizio e alla fine', nl: 'In de naam van Allah, aan het begin en aan het einde', pt: 'Em nome de Allah, no início e no fim', tr: 'Allah\'ın adıyla }, başında ve sonunda' }
},
hadith: {
...
es: 'DESPUÉS DE TERMINAR DE COMER', de: 'NACH DEM ESSEN', it: 'DOPO AVER MANGIATO', nl: 'NA HET ETEN', pt: 'DEPOIS DE COMER', tr: 'YEMEKTEN SONRA' }
},
...
es: 'SUNNAH DEL PROFETA ﷺ', de: 'SUNNA DES PROPHETEN ﷺ', it: 'SUNNAH DEL PROFETA ﷺ', nl: 'SOENNA VAN DE PROFEET ﷺ', pt: 'SUNNAH DO PROFETA ﷺ', tr: 'PEYGAMBERİN ﷺ SÜNNETİ' }
},
sunnah: true,
items: {
fr: [
...
de: [
{ titre: 'MIT DER RECHTEN HAND ESSEN UND TRINKEN', texte: 'Gemäß Umaysa bint Milhan (möge Allah mit ihr zufrieden sein) sagte der Prophet ﷺ: „Wenn einer von euch isst, soll er mit der rechten Hand essen; wenn er trinkt, soll er mit der rechten Hand trinken, denn Satan isst und trinkt mit der linken Hand.“ [Sahih Muslim 2020]' },
{ titre: 'VON DEM ESSEN, WAS VOR DIR IST', texte: 'Gemäß Abu Hurayra (möge Allah mit ihm zufrieden sein) sagte der Prophet ﷺ: „Iss von dem, was vor dir ist.“ [Sahih Muslim 2033]' },
{ titre: 'ESSEN NICHT KRITISIEREN', texte: 'Gemäß Abu Hurayra (möge Allah mit ihm zufrieden sein) kritisierte der Prophet ﷺ niemals Essen: Wenn er es mochte, aß er es; wenn nicht, ließ er es. [Sahih al-Bukhârî 5409]' },
{ titre: 'MÄSSIG ESSEN', texte: 'Gemäß Miqdam ibn Ma\'dikarib (möge Allah mit ihm zufrieden sein) sagte der Prophet ﷺ: „Kein Mensch hat je ein schlechteres Gefäß gefüllt als seinen Magen. Dem Sohn Adams reichen ein paar Bissen, um seinen Rücken aufrecht zu halten. Falls er ihn unbedingt füllen muss: ein Drittel für seine Speise, ein Drittel für sein Getränk und ein Drittel für seinen Atem.“ [Sunan at-Tirmidhi 2380]' },
{ titre: 'NICHT IM STEHEN ESSEN', texte: 'Gemäß Abu Hurayra (möge Allah mit ihm zufrieden sein) verbot der Prophet ﷺ das Essen im Stehen, außer wenn man sich nicht setzen kann. [Sahih Muslim 2016]' }
],
it: [
{ titre: 'MANGIARE E BERE CON LA MANO DESTRA', texte: 'Secondo Umaysa bint Milhan (che Allah sia soddisfatta di lei), il Profeta ﷺ disse: «Quando uno di voi mangia, mangi con la mano destra; quando beve, beva con la mano destra, poiché Satana mangia e beve con la mano sinistra.» [Sahih Muslim 2020]' },
{ titre: 'MANGIARE CIÒ CHE HAI DAVANTI', texte: 'Secondo Abu Hurayra (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «Mangia da ciò che hai davanti.» [Sahih Muslim 2033]' },
{ titre: 'NON CRITICARE IL CIBO', texte: 'Secondo Abu Hurayra (che Allah sia soddisfatto di lui), il Profeta ﷺ non criticava mai il cibo: se gli piaceva lo mangiava, altrimenti lo lasciava. [Sahih al-Bukhārī 5409]' },
{ titre: 'MANGIARE CON MODERAZIONE', texte: 'Secondo Miqdam ibn Ma\'dikarib (che Allah sia soddisfatto di lui), il Profeta ﷺ disse: «Nessun uomo ha mai riempito un recipiente peggiore del suo stomaco. Al figlio di Adamo bastano pochi bocconi per tenere la schiena dritta. Se deve riempirlo: un terzo per il cibo, un terzo per la bevanda e un terzo per il respiro.» [Sunan at-Tirmidhi 2380]' },
{ titre: 'NON MANGIARE IN PIEDI', texte: 'Secondo Abu Hurayra (che Allah sia soddisfatto di lui), il Profeta ﷺ proibiva di mangiare in piedi salvo se non ci si può sedere. [Sahih Muslim 2016]' }
],
nl: [
{ titre: 'ETEN EN DRINKEN MET DE RECHTERHAND', texte: 'Volgens Umaysa bint Milhan (moge Allah tevreden met haar zijn) zei de Profeet ﷺ: "Wanneer een van jullie eet, laat hem eten met zijn rechterhand; wanneer hij drinkt, laat hem drinken met zijn rechterhand, want Satan eet en drinkt met zijn linkerhand." [Sahih Muslim 2020]' },
{ titre: 'ETEN WAT VOOR JE STAAT', texte: 'Volgens Abu Hurairah (moge Allah tevreden met hem zijn) zei de Profeet ﷺ: "Eet van wat voor je staat." [Sahih Muslim 2033]' },
{ titre: 'ETEN NIET BEKRITISEREN', texte: 'Volgens Abu Hurairah (moge Allah tevreden met hem zijn) bekritiseerde de Profeet ﷺ nooit eten: als hij het lekker vond at hij het; zo niet liet hij het staan. [Sahih al-Bukhârî 5409]' },
{ titre: 'MATIG ETEN', texte: 'Volgens Miqdam ibn Ma\'dikarib (moge Allah tevreden met hem zijn) zei de Profeet ﷺ: "Geen mens heeft ooit een slechter vat gevuld dan zijn maag. De zoon van Adam heeft slechts een paar happen nodig om zijn rug recht te houden. Als hij het per se moet vullen: een derde voor zijn voedsel, een derde voor zijn drank en een derde voor zijn ademhaling." [Sunan at-Tirmidhi 2380]' },
{ titre: 'NIET STAAND ETEN', texte: 'Volgens Abu Hurairah (moge Allah tevreden met hem zijn) verbood de Profeet ﷺ het eten in staande positie, tenzij men niet kan zitten. [Sahih Muslim 2016]' }
],
pt: [
{ titre: 'COMER E BEBER COM A MÃO DIREITA', texte: 'Segundo Umaysa bint Milhan (que Allah esteja satisfeito com ela), o Profeta ﷺ disse: «Quando um de vós comer, que coma com a mão direita; quando beber, que beba com a mão direita, pois Satanás come e bebe com a mão esquerda.» [Sahih Muslim 2020]' },
{ titre: 'COMER O QUE ESTÁ À TUA FRENTE', texte: 'Segundo Abu Hurayra (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «Come do que está à tua frente.» [Sahih Muslim 2033]' },
{ titre: 'NÃO CRITICAR A COMIDA', texte: 'Segundo Abu Hurayra (que Allah esteja satisfeito com ele), o Profeta ﷺ nunca criticava a comida: se gostava comia; se não deixava-a. [Sahih al-Bukhārī 5409]' },
{ titre: 'COMER COM MODERAÇÃO', texte: 'Segundo Miqdam ibn Ma\'dikarib (que Allah esteja satisfeito com ele), o Profeta ﷺ disse: «Nenhum ser humano encheu um recipiente pior do que o seu estômago. Ao filho de Adão bastam algumas bocas para manter as costas direitas. Se tiver de o encher: um terço para a comida, um terço para a bebida e um terço para a respiração.» [Sunan at-Tirmidhi 2380]' },
{ titre: 'NÃO COMER DE PÉ', texte: 'Segundo Abu Hurayra (que Allah esteja satisfeito com ele), o Profeta ﷺ proibia comer de pé, salvo se não se puder sentar. [Sahih Muslim 2016]' }
],
tr: [ }
{ titre: 'SAĞ ELLE YEMEK VE İÇMEK', texte: 'Ümeyme binti Milhan\'dan (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ şöyle buyurdu: "Biriniz yemek yediğinde sağ eliyle yesin; içtiğinde sağ eliyle içsin. Zira şeytan sol eliyle yer ve içer." [Sahih Muslim 2020]' },
{ titre: 'ÖNÜNDEKINDEN YE', texte: 'Ebû Hüreyre\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ şöyle buyurdu: "Önündekinden ye." [Sahih Muslim 2033]' },
{ titre: 'YEMEĞİ ELEŞTİRME', texte: 'Ebû Hüreyre\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ hiçbir zaman yemeği eleştirmezdi: beğenirse yerdi beğenmezse bırakırdı. [Sahihu\'l-Buhârî 5409]' },
{ titre: 'İTİDALLİ YE', texte: 'Mikdâm b. Ma\'dikerib\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ şöyle buyurdu: "İnsan oğlu karnından daha kötü bir kap doldurmamıştır. Ademoğluna belini dik tutacak birkaç lokma yeterlidir. Mutlaka doldurması gerekiyorsa: üçte biri yemeğe üçte biri içeceğe üçte biri de nefesine." [Sünen-i Tirmizî 2380]' },
{ titre: 'AYAKTA YEME', texte: 'Ebû Hüreyre\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ oturma imkânı varken ayakta yemeyi yasaklamıştır. [Sahih Muslim 2016]' }
]
},
...
traduction: { fr: 'Au nom d\'Allah', en: 'In the name of Allah', es: 'En el nombre de Allah' , de: 'Bismillâh', it: 'Bismillāh', nl: 'Bismillaah', pt: 'Bismillāh', tr: 'Bismillâh' }      hadith: { }
...
de: [
{ titre: 'MIT BISMILLAH BEGINNEN', texte: 'Der Prophet ﷺ sagte: „Die Waschung desjenigen, der Allahs Namen nicht nennt, ist unvollständig.“ [Sunan Abî Dâwûd 101]' },
{ titre: 'MIT DER RECHTEN HAND BEGINNEN', texte: '\'Â\'isha (möge Allah mit ihr zufrieden sein) berichtete, dass der Prophet ﷺ beim Kleiden, Kämmen und bei den Ablutionen gerne von rechts begann. [Sahih al-Bukhârî 168]' },
...
{ titre: 'WUDU VOLLSTÄNDIG AUSFÜHREN', texte: 'Der Prophet ﷺ sagte: „Wehe den Fersen vor dem Feuer!“ als er Menschen sah, die ihre Fersen beim Wudu nicht waschen. [Sahih al-Bukhârî 165]' }
],
it: [
{ titre: 'INIZIARE CON BISMILLAH', texte: 'Il Profeta ﷺ disse: «L\'abluzione di chi non menziona il nome di Allah non è completa.» [Sunan Abî Dâwûd 101]' },
{ titre: 'INIZIARE CON LA MANO DESTRA', texte: '\'Â\'isha (che Allah sia soddisfatta di lei) riferì che il Profeta ﷺ amava iniziare da destra quando si vestiva, si pettinava e nelle ablucioni. [Sahih al-Bukhārī 168]' },
...
{ titre: 'ESEGUIRE IL WUDU COMPLETAMENTE', texte: 'Il Profeta ﷺ disse: «Guai ai talloni dal fuoco!» quando vide persone che non lavavano i talloni durante il wudu. [Sahih al-Bukhārī 165]' }
],
nl: [
{ titre: 'BEGINNEN MET BISMILLAH', texte: 'De Profeet ﷺ zei: "De reiniging van degene die de naam van Allah niet noemt is onvolledig." [Sunan Abî Dâwûd 101]' },
{ titre: 'BEGINNEN MET DE RECHTERHAND', texte: '\'Â\'isha (moge Allah tevreden met haar zijn) vertelde dat de Profeet ﷺ graag van rechts begon bij het aankleden, kammen en bij de reiniging. [Sahih al-Bukhârî 168]' },
...
{ titre: 'WUDU VOLLEDIG UITVOEREN', texte: 'De Profeet ﷺ zei: "Wee de hielen voor het vuur!" toen hij mensen zag die hun hielen niet wasten tijdens de wudu. [Sahih al-Bukhârî 165]' }
],
pt: [
{ titre: 'COMEÇAR COM BISMILLAH', texte: 'O Profeta ﷺ disse: «A ablução de quem não menciona o nome de Allah não está completa.» [Sunan Abî Dâwûd 101]' },
{ titre: 'COMEÇAR PELA MÃO DIREITA', texte: '\'Â\'isha (que Allah esteja satisfeito com ela) relatou que o Profeta ﷺ gostava de começar pelo lado direito ao vestir-se, pentear-se e nas ablucões. [Sahih al-Bukhārī 168]' },
...
{ titre: 'REALIZAR O WUDU COMPLETAMENTE', texte: 'O Profeta ﷺ disse: «Ai dos calcanhares do fogo!» quando viu pessoas que não lavavam os calcanhares durante o wudu. [Sahih al-Bukhārī 165]' }
],
tr: [ }
{ titre: 'BİSMİLLAH İLE BAŞLAMAK', texte: 'Peygamber ﷺ şöyle buyurdu: "Allah\'ın adını zikretmeyen kimsenin abdesti tamam değildir." [Sünen-i Ebî Dâvûd 101]' },
{ titre: 'SAĞ ELDEN BAŞLAMAK', texte: '\'Âişe\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ giyinirken, taranırken ve abdest alırken sağdan başlamayı severdi. [Sahihu\'l-Buhârî 168]' },
...
{ titre: 'ABDEST UZUVLARINI TAM YIKAMAK', texte: 'Peygamber ﷺ topuklarını yıkamamış insanları görünce: "Ateşten topuklara yazıklar olsun!" buyurdu. [Sahihu\'l-Buhârî 165]' }
]
},
sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar'  }
}
...
es: 'Bismika Alláhummaa amúutu wa ahyáa.', de: 'Bismika Allâhumma amûtu wa ahyâ.', it: 'Bismika Allāhummā amūtu wa aḥyā.', nl: 'Bismika Allaahummaa amootu wa ahyaa.', pt: 'Bismika Allāhummā amūtu wa aḥyā.', tr: 'Bismike Allâhümme emûtü ve ahyâ.' }
},
traduction: {
fr: 'C\'est en Ton nom, ô Allah, que je meurs et que je vis',
en: 'In Your name, O Allah, I die and I live.',
es: 'En Tu nombre, oh Allah, muero y vivo.', de: 'In Deinem Namen, o Allah, sterbe ich und lebe ich.', it: 'Nel Tuo nome, o Allah, muoio e vivo.', nl: 'In Uw naam, o Allah, sterf ik en leef ik.', pt: 'Em Teu nome, ó Allah, morro e vivo.', tr: 'Senin adınla }, ey Allah\'ım, ölürüm ve yaşarım.' }
},
hadith: {
...
de: [
{ titre: 'AUF DER RECHTEN SEITE SCHLAFEN', texte: 'Gemäß ʿAʿisha (möge Allah mit ihr zufrieden sein) schlief der Prophet ﷺ auf seiner rechten Seite. [Sahih al-Bukhârî 6311]' },
{ titre: 'IN EINEM ZUSTAND DER REINHEIT SCHLAFEN', texte: 'Der Prophet ﷺ sagte: „Das Bett aufsuchen sollst du in Reinheit.“ [Sahih al-Bukhârî 6311]' },
{ titre: 'DIE HÄNDE BLASEN UND REZITIEREN', texte: 'ʿAʿisha (möge Allah mit ihr zufrieden sein) berichtete: Der Prophet ﷺ blies in seine Hände, rezitierte die drei Quls und wischte damit über seinen Körper. [Sahih al-Bukhârî 5748]' },
{ titre: 'DAS BETT AUSSCHÜTTELN', texte: 'Der Prophet ﷺ sagte: „Wenn einer von euch schlafen geht, soll er sein Bett ausschütteln.“ [Sahih al-Bukhârî 6320]' },
{ titre: 'DEN TAG MIT DHIKR BEGINNEN', texte: 'Der Prophet ﷺ sagte: „Wenn einer von euch morgens aufwacht, soll er sagen: Al-hamdu lillâhi lladhî alyânâ...“ [Sahih al-Bukhârî 6312]' }
],
it: [
{ titre: 'DORMIRE SUL LATO DESTRO', texte: 'Secondo \'Â\'isha (che Allah sia soddisfatta di lei) il Profeta ﷺ dormiva sul lato destro. [Sahih al-Bukhārī 6311]' },
{ titre: 'DORMIRE IN STATO DI PUREZZA', texte: 'Il Profeta ﷺ disse: «Quando vuoi andare a letto, fai le abluzioni come per la preghiera.» [Sahih al-Bukhārī 6311]' },
...
{ titre: 'SCUOTERE IL LETTO', texte: 'Il Profeta ﷺ disse: «Quando uno di voi va a letto, che scuota il suo letto.» [Sahih al-Bukhārī 6320]' },
{ titre: 'INIZIARE LA GIORNATA CON DHIKR', texte: 'Il Profeta ﷺ disse: «Quando uno di voi si sveglia, dica: Al-hamdu lillâhi lladhî ahyânâ...» [Sahih al-Bukhārī 6312]' }
],
nl: [
{ titre: 'SLAPEN OP DE RECHTERZIJDE', texte: 'Volgens \'Â\'isha (moge Allah tevreden met haar zijn) sliep de Profeet ﷺ op zijn rechterzijde. [Sahih al-Bukhârî 6311]' },
{ titre: 'SLAPEN IN STAAT VAN REINHEID', texte: 'De Profeet ﷺ zei: "Wanneer je naar bed wilt gaan, voer dan de wassing uit zoals voor het gebed." [Sahih al-Bukhârî 6311]' },
{ titre: 'IN HANDEN BLAZEN EN RECITEREN', texte: '\'Â\'isha vertelde: de Profeet ﷺ blies in zijn handen, reciteerde de drie Qul\'s en wreef daarmee over zijn lichaam. [Sahih al-Bukhârî 5748]' },
{ titre: 'HET BED AFSCHUDDEN', texte: 'De Profeet ﷺ zei: "Wanneer een van jullie gaat slapen, laat hem zijn bed afschudden." [Sahih al-Bukhârî 6320]' },
{ titre: 'DE DAG BEGINNEN MET DHIKR', texte: 'De Profeet ﷺ zei: "Wanneer een van jullie \'s ochtends wakker wordt, laat hem zeggen: Al-hamdu lillâhi lladhî ahyânâ..." [Sahih al-Bukhârî 6312]' }
],
pt: [
{ titre: 'DORMIR SOBRE O LADO DIREITO', texte: 'Segundo \'Â\'isha (que Allah esteja satisfeito com ela) o Profeta ﷺ dormia sobre o lado direito. [Sahih al-Bukhārī 6311]' },
{ titre: 'DORMIR EM ESTADO DE PUREZA', texte: 'O Profeta ﷺ disse: «Quando quiseres ir dormir, faz a ablução como para a oração.» [Sahih al-Bukhārī 6311]' },
{ titre: 'SOPRAR NAS MÃOS E RECITAR', texte: '\'Â\'isha relatou: o Profeta ﷺ soprava nas mãos, recitava as três Qul e passava-as pelo corpo. [Sahih al-Bukhārī 5748]' },
{ titre: 'SACUDIR A CAMA', texte: 'O Profeta ﷺ disse: «Quando um de vós for dormir, que sacuda a sua cama.» [Sahih al-Bukhārī 6320]' },
{ titre: 'COMEÇAR O DIA COM DHIKR', texte: 'O Profeta ﷺ disse: «Quando um de vós acordar, que diga: Al-hamdu lillâhi lladhî ahyânâ...» [Sahih al-Bukhārī 6312]' }
],
tr: [ }
{ titre: 'SAĞ TARAFA YATMAK', texte: '\'Âişe\'den (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ sağ yanı üzerine yatardı. [Sahihu\'l-Buhârî 6311]' },
{ titre: 'ABDESTLİ UYUMAK', texte: 'Peygamber ﷺ şöyle buyurdu: "Yatmak istediğinde namaz abdesti gibi abdest al." [Sahihu\'l-Buhârî 6311]' },
{ titre: 'ELLERİNE ÜFLEYEREK OKUMAK', texte: '\'Âişe\'den rivayet edilmiştir: Peygamber ﷺ ellerine üfler, üç Kul surelerini okur ve ellerini vücuduna sürerdi. [Sahihu\'l-Buhârî 5748]' },
{ titre: 'YATAĞINI SILKMAK', texte: 'Peygamber ﷺ şöyle buyurdu: "Biriniz yatağa gideceğinde yatağını silksin." [Sahihu\'l-Buhârî 6320]' },
{ titre: 'GÜNE ZİKİRLE BAŞLAMAK', texte: 'Peygamber ﷺ şöyle buyurdu: "Biriniz sabah uyandığında: Elhamdü lillâhillezî ahyânâ... desin." [Sahihu\'l-Buhârî 6312]' }
]' },
...
arabe: 'غُفْرَانَكَ',
phonetique: { fr: 'Ghufrânak', en: 'Ghufraanak', es: 'Ghufraanak', de: 'Ghufrânak', it: 'Ghufrānak', nl: 'Ghufraanak', pt: 'Ghufrānak', tr: 'Gufrâneke'  , de: 'Ghufrânak', it: 'Ghufrānak', nl: 'Ghufraanak', pt: 'Ghufrānak', tr: 'Gufrâneke' },      traduction: { fr: '(Ô Allah) Pardonne-moi', en: '(O Allah) Grant me Your forgiveness', es: '(Oh Allah) Concédeme Tu perdón' , de: '(O Allah) Vergib mir', it: '(O Allah) Concedimi il Tuo perdono', nl: '(O Allah) Schenk mij Uw vergiffenis', pt: '(Ó Allah) Concede-me o Teu perdão', tr: '(Allah\'ım) Bağışlamanı dilerim' },      hadith: { }
...
es: 'Bismilláah, tawakkaltu \'alalláah, wa laa hawla wa laa qúwwata illaa billáah', de: 'Bismillâh, tawakkaltu \'alâ Allâh, wa lâ hawla wa lâ quwwata illâ billâh', it: 'Bismillāh, tawakkaltu \'alā Allāh, wa lā ḥawla wa lā quwwata illā billāh', nl: 'Bismillaah, tawakkaltu \'alallaah, wa laa hawla wa laa quwwata illaa billaah', pt: 'Bismillāh, tawakkaltu \'alā Allāh, wa lā ḥawla wa lā quwwata illā billāh', tr: 'Bismillâh }, tevekkeltü \'alellâh, ve lâ havle ve lâ kuvvete illâ billâh' }
},
traduction: {
...
de: [
{ titre: 'MIT DEM LINKEN FUSS EINTRETEN', texte: 'Es ist Sunnah, die Toilette mit dem linken Fuss zuerst zu betreten. [Allgemeine Praxis des Propheten]' },
{ titre: 'KOPFBEDECKUNG TRAGEN', texte: 'Es wurde berichtet, dass der Prophet ﷺ beim Betreten der Toilette stets seine Kopfbedeckung trug. [Allgemeine Praxis des Propheten]' },
{ titre: 'NICHT IN STEHENDEM WASSER URINIEREN', texte: 'Der Prophet ﷺ verbot das Urinieren in stehendes Wasser. [Sahih Muslim 281]' },
{ titre: 'NICHT MIT DEM GESICHT ZUR QIBLA', texte: 'Der Prophet ﷺ sagte: „Wenn ihr die Notdurft verrichtet, wendet weder euer Gesicht noch euren Rücken der Qibla zu.“ [Sahih al-Bukhârî 394]' },
{ titre: 'NICHT MIT DER RECHTEN HAND REINIGEN', texte: 'Der Prophet ﷺ sagte: „Wenn einer von euch uriniert, soll er sein männliches Glied nicht mit seiner rechten Hand halten.“ [Sahih al-Bukhârî 154]' }
],
it: [
{ titre: 'ENTRARE CON IL PIEDE SINISTRO', texte: 'E\' sunnah entrare in bagno con il piede sinistro per primo. [Pratica generale del Profeta]' },
{ titre: 'INDOSSARE UN COPRICAPO', texte: 'Fu riportato che il Profeta ﷺ indossava sempre il copricapo entrando in bagno. [Pratica generale del Profeta]' },
{ titre: 'NON URINARE IN ACQUA STAGNANTE', texte: 'Il Profeta ﷺ proibiva di urinare in acqua stagnante. [Sahih Muslim 281]' },
{ titre: 'NON VOLTARSI VERSO LA QIBLA', texte: 'Il Profeta ﷺ disse: «Quando fate i vostri bisogni, non rivolgetevi con la faccia né con la schiena verso la Qibla.» [Sahih al-Bukhārī 394]' },
{ titre: 'NON PULIRSI CON LA MANO DESTRA', texte: 'Il Profeta ﷺ disse: «Quando uno di voi urina, non tenga il suo membro con la mano destra.» [Sahih al-Bukhārī 154]' }
],
nl: [
{ titre: 'BINNENGAAN MET DE LINKERVOET', texte: 'Het is sunnah om het toilet te betreden met de linkervoet als eerste. [Algemene praktijk van de Profeet]' },
{ titre: 'EEN HOOFDBEDEKKING DRAGEN', texte: 'Er werd gemeld dat de Profeet ﷺ bij het betreden van het toilet altijd zijn hoofdbedekking ophield. [Algemene praktijk van de Profeet]' },
{ titre: 'NIET URINEREN IN STILSTAAND WATER', texte: 'De Profeet ﷺ verbood te urineren in stilstaand water. [Sahih Muslim 281]' },
{ titre: 'NIET RICHTING DE QIBLA', texte: 'De Profeet ﷺ zei: "Wanneer jullie je behoefte doen, keer je gezicht noch je rug naar de Qibla." [Sahih al-Bukhârî 394]' },
{ titre: 'NIET REINIGEN MET DE RECHTERHAND', texte: 'De Profeet ﷺ zei: "Wanneer een van jullie urineert, laat hem zijn geslachtsorgaan niet met zijn rechterhand vasthouden." [Sahih al-Bukhârî 154]' }
],
pt: [
{ titre: 'ENTRAR COM O PÉ ESQUERDO', texte: 'É sunnah entrar na casa de banho primeiro com o pé esquerdo. [Prática geral do Profeta]' },
{ titre: 'USAR UMA COBERTURA DE CABEÇA', texte: 'Foi relatado que o Profeta ﷺ sempre usava cobertura de cabeça ao entrar na casa de banho. [Prática geral do Profeta]' },
{ titre: 'NÃO URINAR EM ÁGUA PARADA', texte: 'O Profeta ﷺ proibia urinar em água parada. [Sahih Muslim 281]' },
{ titre: 'NÃO VIRAR-SE PARA A QIBLA', texte: 'O Profeta ﷺ disse: «Quando fazeis as vossas necessidades, não volteis o rosto nem as costas para a Qibla.» [Sahih al-Bukhārī 394]' },
{ titre: 'NÃO LIMPAR COM A MÃO DIREITA', texte: 'O Profeta ﷺ disse: «Quando um de vós urinar, que não segure o seu órgão com a mão direita.» [Sahih al-Bukhārī 154]' }
],
tr: [ }
{ titre: 'SOL AYAKLA GİRMEK', texte: 'Tuvalete sol ayakla girmek sünnettir. [Peygamberin genel uygulaması]' },
{ titre: 'BAŞINI ÖRTMEK', texte: 'Peygamber ﷺ\'in tuvalete girerken edep olarak başını örttüğü rivayet edilmiştir. [Peygamberin genel uygulaması]' },
{ titre: 'DURGUN SUYA İDRAR YAPMAMAK', texte: 'Peygamber ﷺ durgun suya idrar yapmayı yasaklamıştır. [Sahih Muslim 281]' },
{ titre: 'KIBLÉYE DÖNMEMEK', texte: 'Peygamber ﷺ şöyle buyurdu: "Hacetinizi giderirken kıbleye ne yüzünüzü ne de arkanızı dönün." [Sahihu\'l-Buhârî 394]' },
{ titre: 'SAĞ ELLE TEMİZLENMEMEK', texte: 'Peygamber ﷺ şöyle buyurdu: "Biriniz idrar yaparken tenasül uzvunu sağ eliyle tutmasın." [Sahihu\'l-Buhârî 154]' }
]' },
...
de: [
{ titre: 'SALAM BEIM EINTRETEN', texte: 'Allah sagt: „Wenn ihr in Häuser eintretet, grüßt euch untereinander mit einem Gruß von Allah, gesegnet und gut.“ [Koran 24:61] Der Prophet ﷺ pflegte beim Eintreten ins Haus zu grüßen. [Sunan Abî Dâwûd 5096]' },
{ titre: 'MIT DEM RECHTEN FUSS EINTRETEN', texte: 'Der Prophet ﷺ betrat das Haus immer zuerst mit dem rechten Fuß. [Musnad Ahmad]' },
{ titre: 'DAS HAUS SAUBER HALTEN', texte: 'Der Prophet ﷺ sagte: „Allah ist rein und liebt die Reinheit.“ [Tirmidhi 2799]' },
{ titre: 'BEVOR MAN SCHLÄFT AUFRÄUMEN', texte: 'Der Prophet ﷺ sagte: „Löscht die Lampen bei Nacht aus, schließt die Türen und deckt die Gefäße ab.“ [Sahih al-Bukhârî 3280]' },
{ titre: 'SURAH AL-BAQARAH REZITIEREN', texte: 'Der Prophet ﷺ sagte: „Rezitiert Surah al-Baqarah in euren Häusern, denn Satan flieht vor dem Haus, in dem sie rezitiert wird.“ [Sahih Muslim 780]' }
],
it: [
{ titre: 'SALUTO ALL\'ENTRATA', texte: 'Allah dice: «Quando entrate nelle case, salutatevi con un saluto da Allah, benedetto e buono.» [Corano 24:61] Il Profeta ﷺ era solito salutare quando entrava in casa. [Sunan Abî Dâwûd 5096]' },
{ titre: 'ENTRARE CON IL PIEDE DESTRO', texte: 'Il Profeta ﷺ entrava sempre in casa con il piede destro per primo. [Musnad Ahmad]' },
{ titre: 'MANTENERE LA CASA PULITA', texte: 'Il Profeta ﷺ disse: «Allah è puro e ama la purezza.» [Tirmidhi 2799]' },
{ titre: 'RIORDINARE PRIMA DI DORMIRE', texte: 'Il Profeta ﷺ disse: «Spegnete le lampade di notte, chiudete le porte e coprite i recipienti.» [Sahih al-Bukhārī 3280]' },
{ titre: 'RECITARE SURAH AL-BAQARAH', texte: 'Il Profeta ﷺ disse: «Recitate Surah al-Baqarah nelle vostre case, poiché Satana fugge dalla casa in cui viene recitata.» [Sahih Muslim 780]' }
],
nl: [
{ titre: 'SALAM BIJ BINNENKOMST', texte: 'Allah zegt: «Wanneer jullie huizen betreden, groet elkaar met een groet van Allah, gezegend en goed.» [Koran 24:61] De Profeet ﷺ placht te groeten bij het binnengaan van het huis. [Sunan Abî Dâwûd 5096]' },
{ titre: 'BINNENGAAN MET DE RECHTERVOET', texte: 'De Profeet ﷺ betrad het huis altijd als eerste met de rechtervoet. [Musnad Ahmad]' },
{ titre: 'HET HUIS SCHOON HOUDEN', texte: 'De Profeet ﷺ zei: "Allah is rein en houdt van reinheid." [Tirmidhi 2799]' },
{ titre: 'OPRUIMEN VOOR HET SLAPEN', texte: 'De Profeet ﷺ zei: "Doof de lampen \'s nachts, sluit de deuren en dek de vaten af." [Sahih al-Bukhârî 3280]' },
{ titre: 'SURAH AL-BAQARAH RECITEREN', texte: 'De Profeet ﷺ zei: "Reciteer Surah al-Baqarah in jullie huizen, want Satan vlucht uit het huis waar zij gereciteerd wordt." [Sahih Muslim 780]' }
],
pt: [
{ titre: 'SALAM AO ENTRAR', texte: 'Allah diz: «Quando entrardes nas casas, saudai-vos com uma saudação de Allah, abençoada e boa.» [Alcorão 24:61] O Profeta ﷺ costumava cumprimentar ao entrar em casa. [Sunan Abî Dâwûd 5096]' },
{ titre: 'ENTRAR COM O PÉ DIREITO', texte: 'O Profeta ﷺ entrava sempre em casa primeiro com o pé direito. [Musnad Ahmad]' },
{ titre: 'MANTER A CASA LIMPA', texte: 'O Profeta ﷺ disse: «Allah é puro e ama a pureza.» [Tirmidhi 2799]' },
{ titre: 'ARRUMAR ANTES DE DORMIR', texte: 'O Profeta ﷺ disse: «Apagai as lâmpadas à noite, fechai as portas e tapai os recipientes.» [Sahih al-Bukhārī 3280]' },
{ titre: 'RECITAR A SURAH AL-BAQARAH', texte: 'O Profeta ﷺ disse: «Recitai a Surah al-Baqarah nas vossas casas, pois Satanás foge da casa onde é recitada.» [Sahih Muslim 780]' }
],
tr: [ }
{ titre: 'GİRERKEN SELAM VERMEK', texte: 'Allah şöyle buyurur: «Evlere girdiğinizde Allah\'tan bereketli ve güzel bir selam olan birbirinize selam verin.» [Kur\'an 24:61] Peygamber ﷺ eve girerken selam verirdi. [Sünen-i Ebî Dâvûd 5096]' },
{ titre: 'SAĞ AYAKLA GİRMEK', texte: 'Peygamber ﷺ her zaman önce sağ ayağıyla eve girerdi. [Müsned-i Ahmed]' },
{ titre: 'EVİ TEMİZ TUTMAK', texte: 'Peygamber ﷺ şöyle buyurdu: "Allah temizdir, temizliği sever." [Tirmizî 2799]' },
{ titre: 'UYUMADAN ÖNCE TOPLAMAK', texte: 'Peygamber ﷺ şöyle buyurdu: "Yatarken kandilleri söndürün, kapıları kapatın, kapları örtün." [Sahihu\'l-Buhârî 3280]' },
{ titre: 'BAKARA SURESİ OKUMAK', texte: 'Peygamber ﷺ şöyle buyurdu: "Evlerinizde Bakara suresini okuyun; zira şeytan içinde okunduğu evden kaçar." [Sahih Muslim 780]' }
]
},
sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar'  }
}
...
es: 'Alláhummaa innee \'abduka ibnu \'abdika ibnu amatika, naasiyatee biyadika... an taj\'alal-Qur\'aana rabee\'a qalbee, wa núura sadree, wa yalaa\'a huznee, wa dhahaaba hammee.', de: 'Allâhumma innî \'abduka ibnu \'abdika ibnu amatika, nâsiyatî biyadika... an taj\'ala l-Qur\'âna rabî\'a qalbî, wa nûra sadrî, wa jalâ\'a huznî, wa dhahâba hammî.', it: 'Allāhummā innī \'abduka ibnu \'abdika ibnu amatika, nāsiyatī biyadika... an taj\'alal-Qur\'āna rabī\'a qalbī, wa nūra ṣadrī, wa jalā\'a ḥuznī, wa dhahāba hammī.', nl: 'Allaahummaa innee \'abduka ibnu \'abdika ibnu amatika, naasiyatee biyadika... an taj\'alal-Qur\'aana rabee\'a qalbee, wa noora sadree, wa jalaa\'a huznee, wa dhahaaba hammee.', pt: 'Allāhummā innī \'abduka ibnu \'abdika ibnu amatika, nāsiyatī biyadika... an taj\'alal-Qur\'āna rabī\'a qalbī, wa nūra ṣadrī, wa jalā\'a ḥuznī, wa dhahāba hammī.', tr: 'Allâhümme innî abdüke }, ibnü abdike, ibnü emetike, nâsıyetî bi-yedike... en tec\'alel-Kur\'âne rebî\'a kalbî, ve nûra sadrî, ve celâe huznî, ve zehâbe hemmî.' }
},
traduction: {
...
de: [
{ titre: 'DEN KORAN ALS TÄGLICHES HEILMITTEL NUTZEN', texte: 'Der Prophet ﷺ sagte: „Es gibt keine Krankheit, gegen die Allah keine Heilung geschaffen hat.“ Lies täglich den Koran als Heilmittel für das Herz. [Sunan Ibn Mâjah 3438]' },
{ titre: 'VIEL ISTIGHFAR SPRECHEN', texte: 'Der Prophet ﷺ sagte: „Wer viel um Vergebung bittet, dem wird Allah für jede Sorge einen Ausweg schaffen.“ [Sunan Abî Dâwûd 1518]' },
{ titre: 'DIE SCHUTZGEBETE REZITIEREN', texte: 'Der Prophet ﷺ pflegte morgens und abends Surah al-Ikhlas sowie al-Falaq und an-Nas dreimal zu rezitieren. [Sunan Abî Dâwûd 5082]' },
{ titre: 'GEBET UND GEDULD', texte: 'Allah sagt: „O ihr, die ihr glaubt, sucht Hilfe in Geduld und Gebet. Wahrlich, Allah ist mit den Geduldigen.“ [Koran 2:153]' },
{ titre: 'VIEL SALAWAT SPRECHEN', texte: 'Der Prophet ﷺ sagte: „Wer einmal für mich Salawat spricht, dem sendet Allah zehnmal Segnungen.“ [Sahih Muslim 408]' }
],
it: [
{ titre: 'FAR DEL CORANO IL TUO RIMEDIO QUOTIDIANO', texte: 'Il Profeta ﷺ disse: «Non c\'è malattia per cui Allah non abbia creato una cura.» Leggi il Corano ogni giorno come rimedio per il cuore. [Sunan Ibn Mâjah 3438]' },
{ titre: 'FARE MOLTO ISTIGHFAR', texte: 'Il Profeta ﷺ disse: «Chi fa molto istighfar, Allah gli aprirà una via d\'uscita da ogni preoccupazione.» [Sunan Abî Dâwûd 1518]' },
{ titre: 'RECITARE LE SURE DI PROTEZIONE', texte: 'Il Profeta ﷺ era solito recitare al mattino e alla sera tre volte le Qul. [Sunan Abî Dâwûd 5082]' },
{ titre: 'PREGHIERA E PAZIENZA', texte: 'Allah dice: «O voi che credete, cercate aiuto nella pazienza e nella preghiera. In verità Allah è con i pazienti.» [Corano 2:153]' },
{ titre: 'FARE MOLTO SALAWAT', texte: 'Il Profeta ﷺ disse: «Chi pronuncia una salawat per me, Allah gli invierà dieci benedizioni.» [Sahih Muslim 408]' }
],
nl: [
{ titre: 'MAAK DE KORAN JE DAGELIJKS GENEESMIDDEL', texte: 'De Profeet ﷺ zei: "Er is geen ziekte waarvoor Allah geen genezing heeft geschapen." Lees dagelijks de Koran als geneesmiddel voor het hart. [Sunan Ibn Mâjah 3438]' },
{ titre: 'VEEL ISTIGHFAR ZEGGEN', texte: 'De Profeet ﷺ zei: "Wie veel istighfar zegt, zal Allah voor elke zorg een uitweg geven." [Sunan Abî Dâwûd 1518]' },
...
{ titre: 'GEBED EN GEDULD', texte: 'Allah zegt: «O jullie die geloven, zoek hulp in geduld en gebed. Voorwaar, Allah is met de geduldigen.» [Koran 2:153]' },
{ titre: 'VEEL SALAWAT ZEGGEN', texte: 'De Profeet ﷺ zei: "Wie eenmaal salawat voor mij zegt, zal Allah tienmaal zegeningen sturen." [Sahih Muslim 408]' }
],
pt: [
{ titre: 'FAZ DO ALCORÃO O TEU REMÉDIO DIÁRIO', texte: 'O Profeta ﷺ disse: «Não há doença para a qual Allah não tenha criado uma cura.» Lê o Alcorão diariamente como remédio para o coração. [Sunan Ibn Mâjah 3438]' },
{ titre: 'FAZ MUITO ISTIGHFAR', texte: 'O Profeta ﷺ disse: «Quem fizer muito istighfar, Allah abrirá uma saída para cada preocupação.» [Sunan Abî Dâwûd 1518]' },
...
{ titre: 'ORAÇÃO E PACIÊNCIA', texte: 'Allah diz: «Ó vós que credes, buscai ajuda na paciência e na oração. Em verdade, Allah está com os pacientes.» [Alcorão 2:153]' },
{ titre: 'FAZ MUITO SALAWAT', texte: 'O Profeta ﷺ disse: «Quem pronunciar um salawat por mim, Allah lhe enviará dez bênçãos.» [Sahih Muslim 408]' }
],
tr: [ }
{ titre: 'KUR\'ANI GÜNLÜK İLACIN YAP', texte: 'Peygamber ﷺ şöyle buyurdu: "Allah\'ın şifa yaratmadığı hiçbir hastalık yoktur." Kalp için her gün Kur\'an oku. [İbn Mâce 3438]' },
{ titre: 'ÇOK İSTİĞFAR ET', texte: 'Peygamber ﷺ şöyle buyurdu: "Kim çok istiğfar ederse Allah ona her sıkıntıdan bir çıkış yolu açar." [Sünen-i Ebî Dâvûd 1518]' },
{ titre: 'KORUMA SURELERİNİ OKU', texte: 'Peygamber ﷺ sabah akşam İhlâs, Felak ve Nâs surelerini üçer kez okurdu. [Sünen-i Ebî Dâvûd 5082]' },
{ titre: 'NAMAZ VE SABIR', texte: 'Allah şöyle buyurur: «Ey iman edenler! Sabır ve namazla yardım isteyin. Şüphesiz Allah sabredenlerle beraberdir.» [Kur\'an 2:153]' },
{ titre: 'ÇOK SALAVAT GETİR', texte: 'Peygamber ﷺ şöyle buyurdu: "Kim bana bir kez salavat getirirse Allah ona on kez salat eder." [Sahih Muslim 408]' }
]' },
...
closingDua: { fr: 'Que Allah protège tes enfants de tout mal, visible ou invisible, et les garde dans Sa miséricorde', en: 'May Allah protect your children from all evil, visible or invisible, and keep them in His mercy', es: 'Que Allah proteja a tus hijos de todo mal, visible o invisible, y los guarde en Su misericordia' , de: 'Möge Allah deine Kinder vor allem Bösen, sichtbarem wie unsichtbarem, schützen und sie in Seiner Barmherzigkeit bewahren', it: 'Che Allah protegga i tuoi figli da ogni male, visibile o invisibile, e li tenga nella Sua misericordia', nl: 'Moge Allah jouw kinderen beschermen tegen alle kwaad, zichtbaar of onzichtbaar, en hen bewaren in Zijn genade', pt: 'Que Allah proteja os teus filhos de todo o mal, visível ou invisível, e os guarde na Sua misericórdia', tr: 'Allah çocuklarını görünen ve görünmeyen tüm kötülüklerden korusun ve onları rahmetinde muhafaza etsin' }
},
acc1: {
...
de: [
{ titre: 'DIE SCHUTZGEBETE ÜBER KINDER REZITIEREN', texte: 'Gemäß Aïcha rezitierte der Prophet ﷺ morgens und abends die drei Quls über sich selbst. Dasselbe empfiehlt sich zum Schutz der Kinder. [Sahih al-Bukhârî 5748]' },
{ titre: 'KINDER IN DEN SCHLAF BEGLEITEN', texte: 'Der Prophet ﷺ empfahl, jeden Abend Schutzgebete über Kinder zu sprechen, bevor sie schlafen. [Allgemeine Praxis des Propheten]' },
...
{ titre: 'IM NAMEN ALLAHS FÜR DIE KINDER BETEN', texte: 'Der Prophet ﷺ betete: „Ô Allah, schütze meine Familie.“ [Sahih Muslim]' },
{ titre: 'KINDER DEN KORAN LEHREN', texte: 'Der Prophet ﷺ sagte: „Der Beste unter euch ist, wer den Koran lernt und ihn lehrt.“ [Sahih al-Bukhârî 5027]' }
],
it: [
{ titre: 'RECITARE LE SURE DI PROTEZIONE SUI BAMBINI', texte: 'Secondo \'Â\'isha, il Profeta ﷺ recitava le tre Qul su se stesso mattina e sera. Lo stesso si raccomanda per la protezione dei bambini. [Sahih al-Bukhārī 5748]' },
{ titre: 'ACCOMPAGNARE I BAMBINI AL SONNO', texte: 'Il Profeta ﷺ raccomandava di recitare invocazioni protettive sui bambini ogni sera. [Pratica generale del Profeta]' },
...
{ titre: 'PREGARE PER I BAMBINI', texte: 'Il Profeta ﷺ pregava: «O Allah, proteggi la mia famiglia.» [Sahih Muslim]' },
{ titre: 'INSEGNARE IL CORANO AI BAMBINI', texte: 'Il Profeta ﷺ disse: «Il migliore tra voi è colui che impara il Corano e lo insegna.» [Sahih al-Bukhārī 5027]' }
],
nl: [
{ titre: 'DE BESCHERMENDE SURA\'S OVER KINDEREN RECITEREN', texte: 'Volgens \'Â\'isha reciteerde de Profeet ﷺ \'s ochtends en \'s avonds de drie Qul\'s over zichzelf. Hetzelfde wordt aanbevolen voor kinderen. [Sahih al-Bukhârî 5748]' },
{ titre: 'KINDEREN BEGELEIDEN NAAR DE SLAAP', texte: 'De Profeet ﷺ adviseerde elke avond beschermende smeekgebeden over kinderen te reciteren. [Algemene praktijk van de Profeet]' },
...
{ titre: 'BIDDEN VOOR KINDEREN', texte: 'De Profeet ﷺ bad: "O Allah, bescherm mijn familie." [Sahih Muslim]' },
{ titre: 'KINDEREN DE KORAN LEREN', texte: 'De Profeet ﷺ zei: "De beste onder jullie is degene die de Koran leert en het onderwijst." [Sahih al-Bukhârî 5027]' }
],
pt: [
{ titre: 'RECITAR AS SURAS DE PROTEÇÃO SOBRE AS CRIANÇAS', texte: 'Segundo \'Â\'isha, o Profeta ﷺ recitava as três Qul sobre si mesmo de manhã e à tarde. O mesmo é recomendado para proteger as crianças. [Sahih al-Bukhārī 5748]' },
{ titre: 'ACOMPANHAR AS CRIANÇAS NO SONO', texte: 'O Profeta ﷺ recomendava recitar invocações protetoras sobre as crianças cada noite. [Prática geral do Profeta]' },
...
{ titre: 'REZAR PELAS CRIANÇAS', texte: 'O Profeta ﷺ rezava: «Ó Allah, protege a minha família.» [Sahih Muslim]' },
{ titre: 'ENSINAR O ALCORÃO ÀS CRIANÇAS', texte: 'O Profeta ﷺ disse: «O melhor entre vós é quem aprende o Alcorão e o ensina.» [Sahih al-Bukhārī 5027]' }
],
tr: [ }
{ titre: 'ÇOCUKLAR ÜZERINE KORUMA SURELERİ OKUMAK', texte: '\'Âişe\'den rivayet edilmiştir; Peygamber ﷺ sabah akşam üç Kul suresini kendine okurdu. Çocukların korunması için de tavsiye edilir. [Sahihu\'l-Buhârî 5748]' },
{ titre: 'ÇOCUKLARI UYURKEN KORUMAK', texte: 'Peygamber ﷺ her akşam çocuklar uyumadan önce koruma duaları okunmasını tavsiye ederdi. [Peygamberin genel uygulaması]' },
...
{ titre: 'ÇOCUKLARA DUA ETMEK', texte: 'Peygamber ﷺ şöyle dua ederdi: "Allah\'ım! Ailemi koru." [Sahih Muslim]' },
{ titre: 'ÇOCUKLARA KUR\'AN ÖĞRETMEk', texte: 'Peygamber ﷺ şöyle buyurdu: "Sizin en hayırlınız Kur\'an\'ı öğrenen ve öğretendir." [Sahihu\'l-Buhârî 5027]' }
]' },
...
de: [
{ titre: 'WUDU VOR DER REISE', texte: 'Der Prophet ﷺ empfahl, in einem Zustand ritueller Reinheit zu reisen, wann immer möglich. [Allgemeine Praxis des Propheten]' },
{ titre: 'DONNERSTAGS ABREISEN', texte: 'Ka\'b ibn Mâlik (möge Allah mit ihm zufrieden sein) berichtete, dass der Prophet ﷺ es liebte, donnerstags aufzubrechen. [Sahih al-Bukhârî 2950]' },
{ titre: 'JEMANDEM BESCHEID GEBEN', texte: 'Der Prophet ﷺ pflegte, jemanden zu informieren, wenn er reiste, damit für ihn gebetet werden konnte. [Allgemeine Praxis des Propheten]' },
{ titre: 'TAKBIR AUF DEM WEG', texte: 'Jâbir (möge Allah mit ihm zufrieden sein): „Wenn wir einen Aufstieg nahmen, riefen wir Allâhu Akbar; wenn wir hinabstiegen, sagten wir Subhânallah.“ [Sahih al-Bukhârî 2993]' },
{ titre: 'BEI DER RÜCKKEHR BETEN', texte: 'Der Prophet ﷺ betete zwei Rak\'at in der Moschee bei seiner Rückkehr von einer Reise. [Sahih al-Bukhârî 3088]' }
],
it: [
{ titre: 'FARE IL WUDU PRIMA DEL VIAGGIO', texte: 'Il Profeta ﷺ raccomandava di viaggiare in stato di purezza rituale quando possibile. [Pratica generale del Profeta]' },
{ titre: 'PARTIRE DI GIOVEDÌ', texte: 'Ka\'b ibn Mâlik (che Allah sia soddisfatto di lui) riferì che il Profeta ﷺ amava partire di giovedì. [Sahih al-Bukhārī 2950]' },
{ titre: 'INFORMARE QUALCUNO', texte: 'Il Profeta ﷺ era solito informare qualcuno prima di un viaggio affinché potessero pregare per lui. [Pratica generale del Profeta]' },
{ titre: 'TAKBIR LUNGO IL CAMMINO', texte: 'Jâbir (che Allah sia soddisfatto di lui): «Quando salivamo dicevamo Allâhu Akbar; quando scendevamo dicevamo Subhânallah.» [Sahih al-Bukhārī 2993]' },
{ titre: 'PREGARE AL RITORNO', texte: 'Il Profeta ﷺ pregava due rak\'at nella moschea al suo ritorno da un viaggio. [Sahih al-Bukhārī 3088]' }
],
nl: [
{ titre: 'WUDU DOEN VOOR DE REIS', texte: 'De Profeet ﷺ adviseerde om in staat van rituele reinheid te reizen wanneer mogelijk. [Algemene praktijk van de Profeet]' },
{ titre: 'VERTREKKEN OP DONDERDAG', texte: 'Ka\'b ibn Mâlik (moge Allah tevreden met hem zijn) vertelde dat de Profeet ﷺ graag op donderdag vertrok. [Sahih al-Bukhârî 2950]' },
{ titre: 'IEMAND INLICHTEN', texte: 'De Profeet ﷺ placht iemand te informeren wanneer hij op reis ging zodat er voor hem gebeden kon worden. [Algemene praktijk van de Profeet]' },
{ titre: 'TAKBIR ONDERWEG', texte: 'Jâbir (moge Allah tevreden met hem zijn): "Wanneer wij omhooggingen riepen wij Allâhu Akbar; wanneer wij neerdaalden zeiden wij Subhânallah." [Sahih al-Bukhârî 2993]' },
{ titre: 'BIDDEN BIJ TERUGKOMST', texte: 'De Profeet ﷺ bad twee rak\'at in de moskee bij zijn terugkeer van een reis. [Sahih al-Bukhârî 3088]' }
],
pt: [
{ titre: 'FAZER WUDU ANTES DA VIAGEM', texte: 'O Profeta ﷺ recomendava viajar em estado de pureza ritual sempre que possível. [Prática geral do Profeta]' },
{ titre: 'PARTIR À QUINTA-FEIRA', texte: 'Ka\'b ibn Mâlik (que Allah esteja satisfeito com ele) relatou que o Profeta ﷺ gostava de partir às quintas-feiras. [Sahih al-Bukhārī 2950]' },
{ titre: 'INFORMAR ALGUÉM', texte: 'O Profeta ﷺ costumava informar alguém antes de viajar para que pudessem rezar por ele. [Prática geral do Profeta]' },
{ titre: 'TAKBIR PELO CAMINHO', texte: 'Jâbir (que Allah esteja satisfeito com ele): «Quando subíamos dizíamos Allâhu Akbar; quando descíamos dizíamos Subhânallah.» [Sahih al-Bukhārī 2993]' },
{ titre: 'REZAR AO REGRESSAR', texte: 'O Profeta ﷺ rezava duas rak\'at na mesquita ao regressar de uma viagem. [Sahih al-Bukhārī 3088]' }
],
tr: [ }
{ titre: 'YOLCULUKTAN ÖNCE ABDEST ALMAK', texte: 'Peygamber ﷺ mümkün olduğunda abdestli olarak yolculuğa çıkmayı tavsiye ederdi. [Peygamberin genel uygulaması]' },
{ titre: 'PERŞEMBE YOLA ÇIKMAK', texte: 'Ka\'b b. Mâlik\'ten (Allah ondan razı olsun) rivayet edilmiştir; Peygamber ﷺ perşembe günü yola çıkmayı severdi. [Sahihu\'l-Buhârî 2950]' },
{ titre: 'BİRİNİ BİLGİLENDİRMEK', texte: 'Peygamber ﷺ yolculuğa çıkmadan önce birine haber verirdi ki ona dua edilsin. [Peygamberin genel uygulaması]' },
{ titre: 'YOL BOYUNCA TEKBİR GETİRMEK', texte: 'Câbir\'den (Allah ondan razı olsun): "Yokuş çıkarken Allahu Ekber, inerken Sübhanallah derdik." [Sahihu\'l-Buhârî 2993]' },
{ titre: 'DÖNERKEN NAMAZ KILMAK', texte: 'Peygamber ﷺ yolculuktan döndüğünde mescitte iki rekat namaz kılardı. [Sahihu\'l-Buhârî 3088]' }
]
},
sheet: { sub_fr: 'Pratiques recommandées', sub_en: 'Recommended practices', sub_es: 'Prácticas recomendadas', sub_de: 'Empfohlene Praktiken', sub_it: 'Pratiche raccomandate', sub_nl: 'Aanbevolen praktijken', sub_pt: 'Práticas recomendadas', sub_tr: 'Tavsiye edilen uygulamalar'  }
}
