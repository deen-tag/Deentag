...
// ===== SVG ICÔNES =====
const SVG = {
  // ﷺ calligraphie pour tous les Sunnahs
  sunnah: `<svg viewBox="0 0 40 24" width="36" height="22" xmlns="http://www.w3.org/2000/svg"><text x="20" y="19" text-anchor="middle" font-family="Amiri,serif" font-size="18" fill="#C9A84C">ﷺ</text></svg>`,

  // Maison
  enter:      `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M13 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-5"/><polyline points="16 12 20 12 20 8"/><line x1="10" y1="12" x2="20" y2="12"/></svg>`,
  leave:      `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-5"/><polyline points="14 12 10 12 10 8"/><line x1="14" y1="12" x2="4" y2="12"/></svg>`,
  variant:    `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/><circle cx="19" cy="5" r="3" fill="#C9A84C" stroke="none"/><text x="19" y="8" text-anchor="middle" font-size="4" fill="#0d0a04">+</text></svg>`,
  protection: `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>`,

  // Repas
  before_eat: `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="2" x2="12" y2="6"/><path d="M12 6C9 6 7 8 7 11c0 2.5 1.5 4.5 5 5v4"/><line x1="17" y1="2" x2="17" y2="11"/><line x1="7" y1="2" x2="7" y2="6"/></svg>`,
  forgot_bis: `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>`,
  after_eat:  `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2z"/><path d="M8 12h8"/><path d="M9 9l3 3-3 3"/></svg>`,

  // Réveil
  waking:     `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>`,
  sleeping:   `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>`,

  // Tristesse
  sadness:    `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M16 16s-1.5-2-4-2-4 2-4 2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>`,
  quran:      `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><line x1="12" y1="7" x2="12" y2="13"/><line x1="9" y1="10" x2="15" y2="10"/></svg>`,

  // Toilettes
  before_wc:  `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l3 7h7l-5.5 4 2 7L12 16l-6.5 4 2-7L2 9h7z"/></svg>`,
  after_wc:   `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`,

  // Ablution
  before_wudu:`<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v6l3 3-3 3v6"/><path d="M7 7c0 0-3 3-3 6s3 6 3 6"/><path d="M17 7c0 0 3 3 3 6s-3 6-3 6"/></svg>`,
  shahada:    `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`,
  dua_after:  `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>`,

  // Enfants
  protect:    `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><line x1="12" y1="8" x2="12" y2="13"/><circle cx="12" cy="16" r="0.5" fill="#C9A84C"/></svg>`,
  one_child:  `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="7" r="4"/><path d="M6 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><path d="M12 14v7"/></svg>`,

  // Transport
  boarding:   `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13" rx="2"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>`,
  long_trip:  `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#C9A84C" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
};
