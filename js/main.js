...
// ← AJOUTER UNE LANGUE ICI UNIQUEMENT (ex: 'de', 'it', 'nl', 'tr')
...
function playAudio(accId, type, btn, audioFile) {
  ...
  // Préchargement (cache navigateur)
  player.preload = 'auto';
  ...
  player.play().catch(() => {
    stopAudio();
    // Marquer le bouton comme audio manquant
...
// ===== POLICE ADAPTÉE (OpenDyslexic / Atkinson) =====
...
function showWelcomeIfNeeded() {
  ...
  bubble.innerHTML =
    ...
    '<span class="welcome-text">' +
      '<span class="lang-block active" data-lang-block="fr">Tape sur une catégorie, puis choisis ton invocation.</span>' +
      '<span class="lang-block" data-lang-block="en">Tap a category, then choose your supplication.</span>' +
      '<span class="lang-block" data-lang-block="es">Toca una categoría y elige tu invocación.</span>' +
    '</span>' +
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Appliquer la police sauvegardée
