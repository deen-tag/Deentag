...
window.addEventListener('DOMContentLoaded', () => {
  ...
  sheet.addEventListener('touchend', e => {
    ...
    if (swipeDY > 150) {
      // Swipe suffisant — continuer vers le bas et fermer
