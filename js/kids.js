...
window.addEventListener('deentag:profileChanged', () => {
  // Si on est sur la page catégorie, on revient à l'accueil pour refléter
  // la progression du profil nouvellement sélectionné.
  if (currentCat) { showHome(); } else { renderHome(); }
});
