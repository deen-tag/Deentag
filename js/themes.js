...
function openThemePanel() {
  ...
  document.getElementById('dt-theme-overlay').classList.add('open');
}

function closeThemePanel() {
  document.getElementById('dt-theme-panel').classList.remove('open');
  document.getElementById('dt-theme-overlay').classList.remove('open');
}
...
function buildThemePanel() {
  ...
  overlay.style.cssText = 'position:fixed;inset:0;background:rgba(0,0,0,0.50);z-index:480;display:none;';
