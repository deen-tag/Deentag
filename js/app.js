...
function renderDua(cat, accId) {
  ...
  if (isSunnah) {
    ...
    const authenticBadge = '<div class="hadith-source-row"><span class="authentic-badge"><span class="authentic-badge-check">✓</span>Authentique</span></div>';
    const hdHtml = hd[lang] ? '<div class="hadith-block">' + hd[lang] + authenticBadge + '</div>' : '';
