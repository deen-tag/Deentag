...
var DUAS = {
  ...
  repas: {
    ...
    acc1: {
      ...
      audio: 'repas1.mp3',
      sheet: { sub_fr: 'Avant de manger', sub_en: 'Before eating', sub_es: 'Antes de comer', sub_de: 'Vor dem Essen', sub_it: 'Prima di mangiare', sub_nl: 'Voor het eten', sub_pt: 'Antes de comer', sub_tr: 'Yemekten önce' }
    },
    acc2: {
      titre: {
      ...
      audio: 'repas2.mp3',
      sheet: { sub_fr: 'Oubli de dire Bismillah', sub_en: 'Forgot to say Bismillah', sub_es: 'Olvidaste decir Bismillah', sub_de: 'Bismillah vergessen', sub_it: 'Bismillah dimenticato', sub_nl: 'Bismillah vergeten', sub_pt: 'Esqueceu o Bismillah', sub_tr: 'Besmeleyi unutunca' }
    },
    acc3: {
      titre: {
      ...
      audio: 'repas3.mp3',
      sheet: { sub_fr: 'Après avoir mangé', sub_en: 'After eating', sub_es: 'Después de comer', sub_de: 'Nach dem Essen', sub_it: 'Dopo aver mangiato', sub_nl: 'Na het eten', sub_pt: 'Depois de comer', sub_tr: 'Yemekten sonra' }
    },
    acc4: {
      titre: {
      ...
      sheet: { sub_fr: 'Les sunnahs du repas', sub_en: 'Sunnahs of the meal', sub_es: 'Sunnahs de la comida', sub_de: 'Sunnahs der Mahlzeit', sub_it: 'Sunnah del pasto', sub_nl: 'Soenna\'s van de maaltijd', sub_pt: 'Sunnahs da refeição', sub_tr: 'Yemek sünnetleri' }
    }
  },
  ...
  ablution: {
    ...
    acc1: {
      ...
      audio: 'ablution1.mp3',
      sheet: { sub_fr: 'Avant les ablutions', sub_en: 'Before ablution', sub_es: 'Antes de la ablución', sub_de: 'Vor der Waschung', sub_it: 'Prima dell\'abluzione', sub_nl: 'Voor de wassing', sub_pt: 'Antes da ablução', sub_tr: 'Abdestten önce' }
    },
    acc2: {
      ...
      audio: 'ablution2.mp3',
      sheet: { sub_fr: 'Après les ablutions', sub_en: 'After ablution', sub_es: 'Después de la ablución', sub_de: 'Nach der Waschung', sub_it: 'Dopo l\'abluzione', sub_nl: 'Na de wassing', sub_pt: 'Depois da ablução', sub_tr: 'Abdestten sonra' }
    },
    acc3: {
      ...
      audio: 'ablution3.mp3',
      sheet: { sub_fr: 'Après les ablutions (version complète)', sub_en: 'After ablution (full version)', sub_es: 'Después de la ablución (versión completa)', sub_de: 'Nach der Waschung (vollständige Version)', sub_it: 'Dopo l\'abluzione (versione completa)', sub_nl: 'Na de wassing (volledige versie)', sub_pt: 'Depois da ablução (versão completa)', sub_tr: 'Abdestten sonra (uzun versiyon)' }
    },
    acc4: {
      ...
      sheet: { sub_fr: 'Les sunnahs des ablutions', sub_en: 'Sunnahs of ablution', sub_es: 'Sunnahs de la ablución', sub_de: 'Sunnahs der Waschung', sub_it: 'Sunnah dell\'abluzione', sub_nl: 'Soenna\'s van de wassing', sub_pt: 'Sunnahs da ablução', sub_tr: 'Abdest sünnetleri' }
    }
  },
  ...
  reveil: {
    ...
    acc1: {
      ...
      audio: 'reveil1.mp3',
      sheet: { sub_fr: 'Au réveil', sub_en: 'Upon waking', sub_es: 'Al despertar', sub_de: 'Beim Aufwachen', sub_it: 'Al risveglio', sub_nl: 'Bij het ontwaken', sub_pt: 'Ao acordar', sub_tr: 'Uyanınca' }
    },
    acc2: {
      ...
      audio: 'reveil2.mp3',
      sheet: { sub_fr: 'Avant de dormir', sub_en: 'Before sleeping', sub_es: 'Antes de dormir', sub_de: 'Vor dem Schlafen', sub_it: 'Prima di dormire', sub_nl: 'Voor het slapen', sub_pt: 'Antes de dormir', sub_tr: 'Uyumadan önce' }
    },
    acc3: {
      ...
      audio: 'reveil3.mp3',
      sheet: { sub_fr: 'Avant de dormir (version complète)', sub_en: 'Before sleeping (full version)', sub_es: 'Antes de dormir (versión completa)', sub_de: 'Vor dem Schlafen (vollständige Version)', sub_it: 'Prima di dormire (versione completa)', sub_nl: 'Voor het slapen (volledige versie)', sub_pt: 'Antes de dormir (versão completa)', sub_tr: 'Uyumadan önce (uzun versiyon)' }
    },
    acc4: {
      titre: { fr: 'SUNNAHS DU PROPHÈTE ﷺ', en: 'PROPHET\'S ﷺ SUNNAH', es: 'SUNNAH DEL PROFETA ﷺ' },
      sunnah: true,
      ...
      sheet: { sub_fr: 'Les sunnahs du coucher', sub_en: 'Sunnahs of bedtime', sub_es: 'Sunnahs para dormir', sub_de: 'Sunnahs der Schlafenszeit', sub_it: 'Sunnah del sonno', sub_nl: 'Soenna\'s voor het slapen', sub_pt: 'Sunnahs para dormir', sub_tr: 'Yatma sünnetleri' }
    },
    acc5: {
      ...
      audio: null,
      sheet: { sub_fr: 'En cas de cauchemar', sub_en: 'In case of a nightmare', sub_es: 'En caso de pesadilla', sub_de: 'Bei einem Albtraum', sub_it: 'In caso di incubo', sub_nl: 'Bij een nachtmerrie', sub_pt: 'Em caso de pesadelo', sub_tr: 'Kabus görünce' }
    }
  },
  ...
  toilettes: {
    ...
    acc1: {
      ...
      sheet: { sub_fr: 'Entrer aux toilettes', sub_en: 'Entering the toilet', sub_es: 'Entrar al baño', sub_de: 'Die Toilette betreten', sub_it: 'Entrare in bagno', sub_nl: 'Het toilet binnengaan', sub_pt: 'Entrar na casa de banho', sub_tr: 'Tuvalete girerken' }
    },
    acc2: {
      ...
      sheet: { sub_fr: 'Sortir des toilettes', sub_en: 'Leaving the toilet', sub_es: 'Salir del baño', sub_de: 'Die Toilette verlassen', sub_it: 'Uscire dal bagno', sub_nl: 'Het toilet verlaten', sub_pt: 'Sair da casa de banho', sub_tr: 'Tuvaletten çıkarken' }
    },
    acc3: {
      titre: { fr: 'SUNNAHS DU PROPHÈTE ﷺ', en: 'PROPHET\'S ﷺ SUNNAH', es: 'SUNNAH DEL PROFETA ﷺ' },
      sunnah: true,
      ...
      sheet: { sub_fr: 'Les sunnahs des toilettes', sub_en: 'Sunnahs of the toilet', sub_es: 'Sunnahs del baño', sub_de: 'Sunnahs der Toilette', sub_it: 'Sunnah del bagno', sub_nl: 'Soenna\'s van het toilet', sub_pt: 'Sunnahs da casa de banho', sub_tr: 'Tuvalet sünnetleri' }
    }
  },
  ...
  maison: {
    ...
    acc1: {
      ...
      audio: 'maison1.mp3',
      sheet: { sub_fr: 'Entrer chez soi', sub_en: 'Entering home', sub_es: 'Entrar en casa', sub_de: 'Zuhause ankommen', sub_it: 'Entrare in casa', sub_nl: 'Thuiskomen', sub_pt: 'Entrar em casa', sub_tr: 'Eve girerken' }
    },
    acc2: {
      ...
      audio: 'maison2.mp3',
      sheet: { sub_fr: 'Entrer chez soi (version complète)', sub_en: 'Entering home (full version)', sub_es: 'Entrar en casa (versión completa)', sub_de: 'Zuhause ankommen (vollständige Version)', sub_it: 'Entrare in casa (versione completa)', sub_nl: 'Thuiskomen (volledige versie)', sub_pt: 'Entrar em casa (versão completa)', sub_tr: 'Eve girerken (uzun versiyon)' }
    },
    acc3: {
      ...
      audio: 'maison3.mp3',
      sheet: { sub_fr: 'Sortir de chez soi', sub_en: 'Leaving home', sub_es: 'Salir de casa', sub_de: 'Das Haus verlassen', sub_it: 'Uscire di casa', sub_nl: 'Het huis verlaten', sub_pt: 'Sair de casa', sub_tr: 'Evden çıkarken' }
    },
    acc4: {
      ...
      audio: null,
      sheet: { sub_fr: 'Protection en quittant la maison', sub_en: 'Protection when leaving home', sub_es: 'Protección al salir de casa', sub_de: 'Schutz beim Verlassen des Hauses', sub_it: "Protezione nell'uscire di casa", sub_nl: 'Bescherming bij het verlaten van het huis', sub_pt: 'Proteção ao sair de casa', sub_tr: 'Evden çıkarken korunma' }
    },
    acc5: {
      titre: { fr: 'SUNNAHS DU PROPHÈTE ﷺ', en: 'PROPHET\'S ﷺ SUNNAH', es: 'SUNNAH DEL PROFETA ﷺ' },
      sunnah: true,
      ...
      sheet: { sub_fr: 'Les sunnahs de la maison', sub_en: 'Sunnahs of the home', sub_es: 'Sunnahs del hogar', sub_de: 'Sunnahs des Hauses', sub_it: 'Sunnah della casa', sub_nl: 'Soenna\'s van het huis', sub_pt: 'Sunnahs do lar', sub_tr: 'Ev sünnetleri' }
    }
  },
  ...
  tristesse: {
    ...
    acc1: {
      ...
      sheet: { sub_fr: 'Soucis, tristesse et dettes', sub_en: 'Worries, sadness and debt', sub_es: 'Preocupaciones, tristeza y deudas', sub_de: 'Sorgen, Traurigkeit und Schulden', sub_it: 'Preoccupazioni, tristezza e debiti', sub_nl: 'Zorgen, verdriet en schulden', sub_pt: 'Preocupações, tristeza e dívidas', sub_tr: 'Kaygı, üzüntü ve borç' }
    },
    acc2: {
      ...
      sheet: { sub_fr: 'Apaiser son cœur', sub_en: 'Soothing the heart', sub_es: 'Calmar el corazón', sub_de: 'Das Herz beruhigen', sub_it: 'Placare il cuore', sub_nl: 'Het hart tot rust brengen', sub_pt: 'Acalmar o coração', sub_tr: 'Kalbi yatıştırmak' }
    },
    acc3: {
      titre: { fr: 'SUNNAHS DU PROPHÈTE ﷺ', en: 'PROPHET\'S ﷺ SUNNAH', es: 'SUNNAH DEL PROFETA ﷺ' },
      sunnah: true,
      ...
      sheet: { sub_fr: 'Les sunnahs dans les épreuves', sub_en: 'Sunnahs in hardship', sub_es: 'Sunnahs en las pruebas', sub_de: 'Sunnahs in Prüfungen', sub_it: 'Sunnah nelle prove', sub_nl: 'Soenna\'s in beproevingen', sub_pt: 'Sunnahs nas provações', sub_tr: 'Sıkıntı anındaki sünnetler' }
    }
  },
  ...
  enfants: {
    ...
    acc1: {
      ...
      audio: 'enfants1.mp3',
      sheet: { sub_fr: 'Protéger ses enfants', sub_en: 'Protecting your children', sub_es: 'Proteger a tus hijos', sub_de: 'Seine Kinder schützen', sub_it: 'Proteggere i propri figli', sub_nl: 'Je kinderen beschermen', sub_pt: 'Proteger os seus filhos', sub_tr: 'Çocukları korumak' }
    },
    acc2: {
      ...
      audio: 'enfants2.mp3',
      sheet: { sub_fr: 'Protéger son enfant', sub_en: 'Protecting your child', sub_es: 'Proteger a tu hijo', sub_de: 'Sein Kind schützen', sub_it: 'Proteggere il proprio figlio', sub_nl: 'Je kind beschermen', sub_pt: 'Proteger o seu filho', sub_tr: 'Çocuğu korumak' }
    },
    acc3: {
      ...
      sheet: { sub_fr: 'Les sunnahs de protection', sub_en: 'Sunnahs of protection', sub_es: 'Sunnahs de protección', sub_de: 'Sunnahs zum Schutz', sub_it: 'Sunnah di protezione', sub_nl: 'Beschermende soenna\'s', sub_pt: 'Sunnahs de proteção', sub_tr: 'Koruma sünnetleri' }
    }
  },
  ...
  transport: {
    ...
    acc1: {
      ...
      sheet: { sub_fr: 'Monter dans un véhicule', sub_en: 'Getting into a vehicle', sub_es: 'Subir a un vehículo', sub_de: 'In ein Fahrzeug einsteigen', sub_it: 'Salire su un veicolo', sub_nl: 'Instappen in een voertuig', sub_pt: 'Entrar num veículo', sub_tr: 'Araca binerken' }
    },
    acc2: {
      ...
      audio: null,
      sheet: { sub_fr: 'Départ en voyage', sub_en: 'Setting off on a journey', sub_es: 'Salida de viaje', sub_de: 'Reisebeginn', sub_it: 'Partenza per il viaggio', sub_nl: 'Vertrek op reis', sub_pt: 'Partida de viagem', sub_tr: 'Yolculuğa çıkarken' }
    },
    acc3: {
      ...
      sheet: { sub_fr: 'Voyage (version complète)', sub_en: 'Journey (full version)', sub_es: 'Viaje (versión completa)', sub_de: 'Reise (vollständige Version)', sub_it: 'Viaggio (versione completa)', sub_nl: 'Reis (volledige versie)', sub_pt: 'Viagem (versão completa)', sub_tr: 'Yolculuk (uzun versiyon)' }
    },
    acc4: {
      titre: { fr: 'SUNNAHS DU PROPHÈTE ﷺ', en: 'PROPHET\'S ﷺ SUNNAH', es: 'SUNNAH DEL PROFETA ﷺ' },
      sunnah: true,
      ...
      sheet: { sub_fr: 'Les sunnahs du voyage', sub_en: 'Sunnahs of travel', sub_es: 'Sunnahs del viaje', sub_de: 'Sunnahs der Reise', sub_it: 'Sunnah del viaggio', sub_nl: 'Soenna\'s van de reis', sub_pt: 'Sunnahs da viagem', sub_tr: 'Yolculuk sünnetleri' }
    }
  },
  ...
  mosquee: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'Entrer à la mosquée', sub_en: 'Entering the mosque', sub_es: 'Entrar a la mezquita', sub_de: 'Die Moschee betreten', sub_it: 'Entrare in moschea', sub_nl: 'De moskee binnengaan', sub_pt: 'Entrar na mesquita', sub_tr: 'Camiye girerken' }
    },
    acc2: {
      ...
      audio: null,
      sheet: { sub_fr: 'Sortir de la mosquée', sub_en: 'Leaving the mosque', sub_es: 'Salir de la mezquita', sub_de: 'Die Moschee verlassen', sub_it: 'Uscire dalla moschea', sub_nl: 'De moskee verlaten', sub_pt: 'Sair da mesquita', sub_tr: 'Camiden çıkarken' }
    }
  },
  ...
  maladie: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'Pour soi-même', sub_en: 'For yourself', sub_es: 'Para uno mismo', sub_de: 'Für sich selbst', sub_it: 'Per se stessi', sub_nl: 'Voor jezelf', sub_pt: 'Para si próprio', sub_tr: 'Kendisi için' }
    },
    acc2: {
      ...
      audio: null,
      sheet: { sub_fr: 'Visiter un malade', sub_en: 'Visiting a sick person', sub_es: 'Visitar a un enfermo', sub_de: 'Einen Kranken besuchen', sub_it: 'Visitare un malato', sub_nl: 'Een zieke bezoeken', sub_pt: 'Visitar um doente', sub_tr: 'Hasta ziyareti' }
    }
  },
  ...
  colere: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'En cas de colère', sub_en: 'In case of anger', sub_es: 'En caso de ira', sub_de: 'Bei Wut', sub_it: 'In caso di rabbia', sub_nl: 'Bij boosheid', sub_pt: 'Em caso de raiva', sub_tr: 'Öfkelenince' }
    }
  },
  ...
  rizq: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'Pour la subsistance', sub_en: 'For sustenance', sub_es: 'Por el sustento', sub_de: 'Für den Lebensunterhalt', sub_it: 'Per il sostentamento', sub_nl: 'Voor levensonderhoud', sub_pt: 'Pelo sustento', sub_tr: 'Rızık için' }
    }
  },
  ...
  ruqya: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'Protection contre le mauvais œil', sub_en: 'Protection from the evil eye', sub_es: 'Protección contra el mal de ojo', sub_de: 'Schutz vor dem bösen Blick', sub_it: 'Protezione dal malocchio', sub_nl: 'Bescherming tegen het boze oog', sub_pt: 'Proteção contra o mau-olhado', sub_tr: 'Nazardan korunma' }
    }
  },
  ...
  mariage: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'Félicitations aux époux', sub_en: 'Congratulating the newlyweds', sub_es: 'Felicitaciones a los esposos', sub_de: 'Glückwünsche an die Eheleute', sub_it: 'Congratulazioni agli sposi', sub_nl: 'Felicitaties aan het bruidspaar', sub_pt: 'Felicitações aos noivos', sub_tr: 'Yeni evlilere tebrik' }
    }
  },
  ...
  ramadan: {
    ...
    acc1: {
      ...
      audio: null,
      sheet: { sub_fr: 'Iftar', sub_en: 'Iftar', sub_es: 'Iftar', sub_de: 'Iftar', sub_it: 'Iftar', sub_nl: 'Iftar', sub_pt: 'Iftar', sub_tr: 'İftar' }
    },
    acc2: {
      ...
      audio: null,
      sheet: { sub_fr: 'Nuit du Destin (Laylat al-Qadr)', sub_en: 'Night of Decree (Laylat al-Qadr)', sub_es: 'Noche del Decreto (Laylat al-Qadr)', sub_de: 'Nacht der Bestimmung (Laylat al-Qadr)', sub_it: 'Notte del Decreto (Laylat al-Qadr)', sub_nl: 'Nacht van de Bestemming (Laylat al-Qadr)', sub_pt: 'Noite do Decreto (Laylat al-Qadr)', sub_tr: 'Kadir Gecesi (Laylat al-Qadr)' }
    }
  },
...
azan: {
  ...
  acc1: {
    ...
    audio: '',
    sheet: { sub_fr: 'En entendant l\'appel à la prière (Adhan)', sub_en: 'When hearing the call to prayer (Adhan)', sub_es: 'Al escuchar la llamada a la oración (Adhan)', sub_de: 'Beim Hören des Gebetsrufs (Adhan)', sub_it: 'All\'ascolto della chiamata alla preghiera (Adhan)', sub_nl: 'Bij het horen van de gebedsoproep (Adhan)', sub_pt: 'Ao ouvir o chamado à oração (Adhan)', sub_tr: 'Ezanı işitince' }
  },
  acc2: {
    ...
    audio: '',
    sheet: { sub_fr: 'Après l\'appel à la prière (Adhan)', sub_en: 'After the call to prayer (Adhan)', sub_es: 'Después de la llamada a la oración (Adhan)', sub_de: 'Nach dem Gebetsruf (Adhan)', sub_it: 'Dopo la chiamata alla preghiera (Adhan)', sub_nl: 'Na de gebedsoproep (Adhan)', sub_pt: 'Após o chamado à oração (Adhan)', sub_tr: 'Ezandan sonra' }
  }
},
...
salah: {
  ...
  acc1: {
    ...
    audio: '',
    sheet: { sub_fr: 'Invocation d\'ouverture', sub_en: 'Opening supplication', sub_es: 'Súplica de apertura', sub_de: 'Eröffnungsbittgebet', sub_it: 'Invocazione di apertura', sub_nl: 'Openingssmeekgebed', sub_pt: 'Súplica de abertura', sub_tr: 'Açılış duası' }
  },
  acc2: {
    ...
    audio: '',
    sheet: { sub_fr: 'En prosternation', sub_en: 'In prostration', sub_es: 'En la postración', sub_de: 'In der Niederwerfung', sub_it: 'Nella prosternazione', sub_nl: 'In de neerwerping', sub_pt: 'Na prostração', sub_tr: 'Secdede' }
  }
},
...
istikhara: {
  ...
  acc1: {
    ...
    audio: '',
    sheet: { sub_fr: 'Prière de consultation (Istikhara)', sub_en: 'Prayer of guidance (Istikhara)', sub_es: 'Oración de consulta (Istikhara)', sub_de: 'Konsultationsgebet (Istikhara)', sub_it: 'Preghiera di consultazione (Istikhara)', sub_nl: 'Consultatiegebed (Istikhara)', sub_pt: 'Oração de consulta (Istikhara)', sub_tr: 'İstihare namazı' }
  }
},
...
mort: {
  ...
  acc1: {
    ...
    audio: '',
    sheet: { sub_fr: 'À l\'annonce d\'un décès', sub_en: 'Upon hearing of a death', sub_es: 'Al conocer un fallecimiento', sub_de: 'Bei der Nachricht eines Todesfalls', sub_it: 'All\'annuncio di un decesso', sub_nl: 'Bij het horen van een overlijden', sub_pt: 'Ao saber de uma morte', sub_tr: 'Bir ölüm haberi alınca' }
  },
  acc2: {
    ...
    audio: '',
    sheet: { sub_fr: 'Pour le défunt', sub_en: 'For the deceased', sub_es: 'Por el difunto', sub_de: 'Für den Verstorbenen', sub_it: 'Per il defunto', sub_nl: 'Voor de overledene', sub_pt: 'Pelo falecido', sub_tr: 'Ölen için' }
  }
},
...
hajjumra: {
  ...
  acc1: {
    ...
    audio: '',
    sheet: { sub_fr: 'Formule du pèlerinage (Talbiyah)', sub_en: 'Pilgrimage formula (Talbiyah)', sub_es: 'Fórmula de la peregrinación (Talbiyah)', sub_de: 'Pilgerformel (Talbiyah)', sub_it: 'Formula del pellegrinaggio (Talbiyah)', sub_nl: 'Bedevaartformule (Talbiyah)', sub_pt: 'Fórmula da peregrinação (Talbiyah)', sub_tr: 'Hac telbiyesi' }
  },
  acc2: {
    ...
    audio: '',
    sheet: { sub_fr: 'Jour d\'Arafat', sub_en: 'Day of Arafat', sub_es: 'Día de Arafat', sub_de: 'Tag von Arafat', sub_it: 'Giorno di Arafat', sub_nl: 'Dag van Arafat', sub_pt: 'Dia de Arafat', sub_tr: 'Arefe Günü' }
  }
},
...
nouveaune: {
  ...
  acc1: {
    ...
    audio: '',
    sheet: { sub_fr: 'Protection du nouveau-né', sub_en: 'Protection of the newborn', sub_es: 'Protección del recién nacido', sub_de: 'Schutz des Neugeborenen', sub_it: 'Protezione del neonato', sub_nl: 'Bescherming van de pasgeborene', sub_pt: 'Proteção do recém-nascido', sub_tr: 'Yeni doğan koruması' }
  }
},
...
pluie: {
  ...
  acc1: {
    ...
    audio: '',
    sheet: { sub_fr: 'Quand il pleut', sub_en: 'When it rains', sub_es: 'Cuando llueve', sub_de: 'Wenn es regnet', sub_it: 'Quando piove', sub_nl: 'Als het regent', sub_pt: 'Quando chove', sub_tr: 'Yağmur yağınca' }
  },
  acc2: {
    ...
    audio: '',
    sheet: { sub_fr: 'Après la pluie', sub_en: 'After the rain', sub_es: 'Después de la lluvia', sub_de: 'Nach dem Regen', sub_it: 'Dopo la pioggia', sub_nl: 'Na de regen', sub_pt: 'Depois da chuva', sub_tr: 'Yağmurdan sonra' }
  }
}
}; // fin DUAS
