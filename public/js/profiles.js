...
(function () {
  ...
  var TRANSLATIONS = {
    fr: { memorized:'Mémorisé',      toMemorize:'Mémoriser', toMemorizeSurah:'Mémoriser la sourate', toMemorizeVerseTitle:'Mémoriser ce verset', profiles:'Profils',    addProfile:'Ajouter un profil', editProfile:'Modifier', deleteProfile:'Supprimer', chooseProfile:'Changer de profil', name:'Prénom', save:'Enregistrer', cancel:'Annuler', progress:'Progression', surasMemorized:'Sourates mémorisées', confirmDelete:'Supprimer ce profil ?', confirmDeleteText:'Toute la progression de {name} — sourates, versets, invocations — sera définitivement perdue.', detail:'Détail', close:'Fermer', activeSince:'Membre depuis', activeProfile:'Profil actif', juzCompleted:'Juz complétés', duasMemorized:'Invocations mémorisées', noDuaMemorized:'Aucune invocation mémorisée', me:'Moi', onboardTitle:'Créez votre profil', onboardText:'Démarrez votre progression personnelle : sourates, invocations, tout ce que vous apprenez sera suivi ici. Comment souhaitez-vous être appelé ?', onboardCta:'Commencer ✓' , thisWeek:'Cette semaine', activeDaysLabel:'jours actifs', itemsLearned:'appris', currentFocus:'En cours', continueLabel:'Continuer', recentActivity:'Activité récente', noRecentActivity:'Tes prochaines mémorisations apparaîtront ici', today:"Aujourd'hui", yesterday:'Hier', surahMemorizedEvent:'Sourate mémorisée', duaMemorizedEvent:'Invocation apprise', activeDayLabel:'jour actif', verseMemorizedEvent:'Verset mémorisé', nextVerse:'Prochain : v.', noSurahMemorized:'Aucune sourate mémorisée', profileSingular:'Profil', greetingCreateProfile:'Crée ton profil' },
    en: { memorized:'Memorized',     toMemorize:'Memorize', toMemorizeSurah:'Memorize surah', toMemorizeVerseTitle:'Memorize this verse', profiles:'Profiles',   addProfile:'Add profile',        editProfile:'Edit',     deleteProfile:'Delete',    chooseProfile:'Switch profile',     name:'Name',   save:'Save',        cancel:'Cancel',  progress:'Progress',     surasMemorized:'Memorized surahs',    confirmDelete:'Delete this profile?', confirmDeleteText:'All progress for {name} — surahs, verses, supplications — will be permanently lost.', detail:'Detail', close:'Close', activeSince:'Member since', activeProfile:'Active profile', juzCompleted:'Completed Juz', duasMemorized:'Memorized supplications', noDuaMemorized:'No supplication memorized yet', me:'Me', onboardTitle:'Create your profile', onboardText:'Start tracking your personal progress: surahs, supplications, and more. What would you like to be called?', onboardCta:'Get started ✓' , thisWeek:'This week', activeDaysLabel:'active days', itemsLearned:'learned', currentFocus:'In progress', continueLabel:'Continue', recentActivity:'Recent activity', noRecentActivity:'Your next milestones will appear here', today:'Today', yesterday:'Yesterday', surahMemorizedEvent:'Surah memorized', duaMemorizedEvent:'Supplication learned', activeDayLabel:'active day', verseMemorizedEvent:'Verse memorized', nextVerse:'Next: v.', noSurahMemorized:'No surah memorized yet', profileSingular:'Profile', greetingCreateProfile:'Create your profile' },
    es: { memorized:'Memorizado',    toMemorize:'Memorizar', toMemorizeSurah:'Memorizar la sura', toMemorizeVerseTitle:'Memorizar este versículo', profiles:'Perfiles',   addProfile:'Añadir perfil',      editProfile:'Editar',   deleteProfile:'Eliminar',  chooseProfile:'Cambiar de perfil',     name:'Nombre', save:'Guardar',     cancel:'Cancelar',progress:'Progreso',     surasMemorized:'Suras memorizadas',   confirmDelete:'¿Eliminar este perfil?', confirmDeleteText:'Todo el progreso de {name} — suras, versículos, súplicas — se perderá permanentemente.',detail:'Detalle',close:'Cerrar',activeSince:'Miembro desde',activeProfile:'Perfil activo',juzCompleted:'Juz completados', duasMemorized:'Invocaciones memorizadas', noDuaMemorized:'Ninguna invocación memorizada', me:'Yo', onboardTitle:'Cree su perfil', onboardText:'Este es su espacio para seguir su progreso personal: suras, súplicas, progreso... ¿Cómo desea que le llamemos?', onboardCta:'Empezar ✓' , thisWeek:'Esta semana', activeDaysLabel:'días activos', itemsLearned:'aprendido', currentFocus:'En curso', continueLabel:'Continuar', recentActivity:'Actividad reciente', noRecentActivity:'Tus próximos hitos aparecerán aquí', today:'Hoy', yesterday:'Ayer', surahMemorizedEvent:'Sura memorizada', duaMemorizedEvent:'Súplica aprendida', activeDayLabel:'día activo', verseMemorizedEvent:'Versículo memorizado', nextVerse:'Sig.: v.', noSurahMemorized:'Ninguna sura memorizada', profileSingular:'Perfil', greetingCreateProfile:'Crea tu perfil' },
    de: { memorized:'Auswendig',     toMemorize:'Auswendig lernen', toMemorizeSurah:'Sure auswendig lernen', toMemorizeVerseTitle:'Diesen Vers auswendig lernen', profiles:'Profile',    addProfile:'Profil hinzufügen',  editProfile:'Bearbeiten',deleteProfile:'Löschen',  chooseProfile:'Profil wechseln',      name:'Name',   save:'Speichern',   cancel:'Abbrechen',progress:'Fortschritt',  surasMemorized:'Gelernte Suren',      confirmDelete:'Profil löschen?', confirmDeleteText:'Der gesamte Fortschritt von {name} — Suren, Verse, Bittgebete — geht endgültig verloren.',       detail:'Detail', close:'Schließen',activeSince:'Mitglied seit',activeProfile:'Aktives Profil',juzCompleted:'Abgeschlossene Juz', duasMemorized:'Gelernte Bittgebete', noDuaMemorized:'Noch kein Bittgebet gelernt', me:'Ich', onboardTitle:'Erstellen Sie Ihr Profil', onboardText:'Dies ist Ihr Bereich, um Ihren persönlichen Fortschritt zu verfolgen: Suren, Bittgebete, Fortschritt... Wie möchten Sie genannt werden?', onboardCta:'Loslegen ✓' , thisWeek:'Diese Woche', activeDaysLabel:'aktive Tage', itemsLearned:'gelernt', currentFocus:'In Arbeit', continueLabel:'Weiter', recentActivity:'Letzte Aktivität', noRecentActivity:'Deine nächsten Meilensteine erscheinen hier', today:'Heute', yesterday:'Gestern', surahMemorizedEvent:'Sure gelernt', duaMemorizedEvent:'Bittgebet gelernt', activeDayLabel:'aktiver Tag', verseMemorizedEvent:'Vers gelernt', nextVerse:'Nächster: V.', noSurahMemorized:'Noch keine Sure gelernt', profileSingular:'Profil', greetingCreateProfile:'Erstelle dein Profil' },
    it: { memorized:'Memorizzato',   toMemorize:'Memorizzare', toMemorizeSurah:'Memorizzare la sura', toMemorizeVerseTitle:'Memorizza questo versetto', profiles:'Profili',    addProfile:'Aggiungi profilo',   editProfile:'Modifica', deleteProfile:'Elimina',   chooseProfile:'Cambia profilo',         name:'Nome',   save:'Salva',       cancel:'Annulla', progress:'Progressi',    surasMemorized:'Sure memorizzate',    confirmDelete:'Eliminare questo profilo?', confirmDeleteText:'Tutti i progressi di {name} — sure, versetti, invocazioni — andranno persi definitivamente.',detail:'Dettaglio',close:'Chiudi',activeSince:'Membro da',activeProfile:'Profilo attivo',juzCompleted:'Juz completati', duasMemorized:'Invocazioni memorizzate', noDuaMemorized:'Nessuna invocazione memorizzata', me:'Io', onboardTitle:'Crei il suo profilo', onboardText:'Questo è il suo spazio per seguire i suoi progressi personali: sure, invocazioni, progressi... Come desidera essere chiamato?', onboardCta:'Inizia ✓' , thisWeek:'Questa settimana', activeDaysLabel:'giorni attivi', itemsLearned:'imparato', currentFocus:'In corso', continueLabel:'Continua', recentActivity:'Attività recente', noRecentActivity:'I tuoi prossimi traguardi appariranno qui', today:'Oggi', yesterday:'Ieri', surahMemorizedEvent:'Sura memorizzata', duaMemorizedEvent:'Invocazione imparata', activeDayLabel:'giorno attivo', verseMemorizedEvent:'Versetto memorizzato', nextVerse:'Prossimo: v.', noSurahMemorized:'Nessuna sura memorizzata', profileSingular:'Profilo', greetingCreateProfile:'Crea il tuo profilo' },
    nl: { memorized:'Gememoriseerd', toMemorize:'Memoriseren', toMemorizeSurah:'Soera memoriseren', toMemorizeVerseTitle:'Dit vers memoriseren', profiles:'Profielen',  addProfile:'Profiel toevoegen',  editProfile:'Bewerken', deleteProfile:'Verwijderen',chooseProfile:'Profiel wisselen',    name:'Naam',   save:'Opslaan',     cancel:'Annuleren',progress:'Voortgang',    surasMemorized:"Gememoriseerde soera's",confirmDelete:'Dit profiel verwijderen?', confirmDeleteText:'Alle voortgang van {name} — soera\'s, verzen, smeekbeden — gaat definitief verloren.',detail:'Detail',close:'Sluiten',activeSince:'Lid sinds',activeProfile:'Actief profiel',juzCompleted:'Voltooide Juz', duasMemorized:'Gememoriseerde smeekgebeden', noDuaMemorized:'Nog geen smeekgebed gememoriseerd', me:'Ik', onboardTitle:'Maak uw profiel aan', onboardText:'Dit is uw plek om uw persoonlijke voortgang te volgen: soera\'s, smeekbeden, voortgang... Hoe wilt u genoemd worden?', onboardCta:'Beginnen ✓' , thisWeek:'Deze week', activeDaysLabel:'actieve dagen', itemsLearned:'geleerd', currentFocus:'Bezig', continueLabel:'Doorgaan', recentActivity:'Recente activiteit', noRecentActivity:'Je volgende mijlpalen verschijnen hier', today:'Vandaag', yesterday:'Gisteren', surahMemorizedEvent:'Soera gememoriseerd', duaMemorizedEvent:'Smeekgebed geleerd', activeDayLabel:'actieve dag', verseMemorizedEvent:'Vers gememoriseerd', nextVerse:'Volgende: v.', noSurahMemorized:'Nog geen soera gememoriseerd', profileSingular:'Profiel', greetingCreateProfile:'Maak je profiel aan' },
    pt: { memorized:'Memorizado',    toMemorize:'Memorizar', toMemorizeSurah:'Memorizar a sura', toMemorizeVerseTitle:'Memorizar este versículo', profiles:'Perfis',     addProfile:'Adicionar perfil',   editProfile:'Editar',   deleteProfile:'Eliminar',  chooseProfile:'Mudar de perfil',      name:'Nome',   save:'Guardar',     cancel:'Cancelar', progress:'Progresso',   surasMemorized:'Suras memorizadas',   confirmDelete:'Eliminar este perfil?', confirmDeleteText:'Todo o progresso de {name} — suras, versículos, súplicas — será perdido definitivamente.', detail:'Detalhe',close:'Fechar',activeSince:'Membro desde',activeProfile:'Perfil ativo',juzCompleted:'Juz concluídos', duasMemorized:'Invocações memorizadas', noDuaMemorized:'Nenhuma invocação memorizada', me:'Eu', onboardTitle:'Crie o seu perfil', onboardText:'Este é o seu espaço para acompanhar o seu progresso pessoal: suras, súplicas, progresso... Como deseja ser chamado?', onboardCta:'Começar ✓' , thisWeek:'Esta semana', activeDaysLabel:'dias ativos', itemsLearned:'aprendido', currentFocus:'Em curso', continueLabel:'Continuar', recentActivity:'Atividade recente', noRecentActivity:'As tuas próximas conquistas vão aparecer aqui', today:'Hoje', yesterday:'Ontem', surahMemorizedEvent:'Sura memorizada', duaMemorizedEvent:'Invocação aprendida', activeDayLabel:'dia ativo', verseMemorizedEvent:'Versículo memorizado', nextVerse:'Próximo: v.', noSurahMemorized:'Nenhuma sura memorizada', profileSingular:'Perfil', greetingCreateProfile:'Cria o teu perfil' },
    tr: { memorized:'Ezberlenmiş',   toMemorize:'Ezberle', toMemorizeSurah:'Sureyi ezberle', toMemorizeVerseTitle:'Bu ayeti ezberle', profiles:'Profiller',  addProfile:'Profil ekle',        editProfile:'Düzenle',  deleteProfile:'Sil',       chooseProfile:'Profili değiştir',      name:'İsim',   save:'Kaydet',      cancel:'İptal',    progress:'İlerleme',    surasMemorized:'Ezberlenmiş sureler', confirmDelete:'Bu profili sil?', confirmDeleteText:'{name} adlı profilin tüm ilerlemesi — sureler, ayetler, dualar — kalıcı olarak silinecek.',       detail:'Detay',  close:'Kapat',  activeSince:'Üye tarihi',  activeProfile:'Aktif profil',  juzCompleted:'Tamamlanan Cüzler', duasMemorized:'Ezberlenmiş dualar', noDuaMemorized:'Henüz ezberlenmiş dua yok', me:'Ben', onboardTitle:'Profilinizi oluşturun', onboardText:'Burası kişisel ilerlemenizi takip ettiğiniz alandır: sureler, dualar, ilerleme... Size nasıl hitap edelim?', onboardCta:'Başla ✓', thisWeek:'Bu hafta', activeDaysLabel:'aktif gün', itemsLearned:'öğrenildi', currentFocus:'Devam ediyor', continueLabel:'Devam et', recentActivity:'Son etkinlik', noRecentActivity:'Sonraki kilometre taşların burada görünecek', today:'Bugün', yesterday:'Dün', surahMemorizedEvent:'Sure ezberlendi', duaMemorizedEvent:'Dua ezberlendi', activeDayLabel:'aktif gün', verseMemorizedEvent:'Ayet ezberlendi', nextVerse:'Sonraki: a.', noSurahMemorized:'Henüz ezberlenmiş sure yok', profileSingular:'Profil', greetingCreateProfile:'Profilini oluştur' }
  };

  /* ── Helpers ── */
  function getLang() { return localStorage.getItem('deentag_lang') || 'fr'; }
  /* ── Échappe le HTML pour éviter toute injection via un nom de profil
       (ex: guillemets, balises) — appliqué partout où un nom est inséré
       dans du HTML construit par concaténation de chaîne. ── */
  ...
  window.DT_escapeHtml = escapeHtml;
  ...
  function getCurrentFocus(prog) {
    ...
    Object.keys(prog).forEach(function(k) {
      ...
      if (!sid) return;
      var vNum = parseInt(rest.slice(sep+1));
      var e = prog[k];
      if (!bySurah[sid]) bySurah[sid] = { verses:0, lastDate:null, memSet:{} };
      bySurah[sid].verses++;
      if (vNum) bySurah[sid].memSet[vNum] = true;
    ...
    var next  = null;
    for (var v = 1; v <= total; v++) { if (!bySurah[bestId].memSet[v]) { next = v; break; } }
    return { id: bestId, name: SURAH_NAMES[bestId] || ('Sourate '+bestId), done: done, total: total, pct: Math.round(done/total*100), next: next };
  }

  /* ── Activité récente : 5 derniers jalons (sourates + invocations + versets) ── */
  function getRecentActivity(prog) {
    ...
    Object.keys(prog).forEach(function(k) {
      ...
      } else if (k.indexOf('verse_') === 0) {
        var vRest = k.replace('verse_','');
        var vSep  = vRest.indexOf('_');
        var vSid  = parseInt(vRest.slice(0, vSep));
        var vNum  = vRest.slice(vSep+1);
        if (!vSid || prog['surah_'+vSid]) return; // déjà représenté par l'événement "sourate complète"
        events.push({ date: new Date(e.date), label: (SURAH_NAMES[vSid]||'Sourate '+vSid)+' · v.'+vNum, kind: 'verse' });
  ...
  function injectCSS() {
    ...
    style.textContent = `
      ...
      .dt-handle { width:36px;height:4px;background:rgba(var(--gold-rgb),0.3);border-radius:2px;margin:14px auto 0; }
      ...
      .dt-active-since { font-family:'Spectral',serif;font-style:italic;font-size:12px;color:rgba(var(--gold-rgb),0.9);margin-top:2px; }
      .dt-active-badge { display:inline-flex;align-items:center;gap:4px;padding:4px 12px;border-radius:20px;border:1px solid rgba(var(--gold-rgb),0.6);background:rgba(var(--gold-rgb),0.18);font-family:'Cinzel',serif;font-size:9px;letter-spacing:0.1em;color:var(--gold);margin-top:6px;font-weight:600; }
      .dt-active-badge::before { content:'';width:6px;height:6px;border-radius:50%;background:var(--gold);display:inline-block; }
      .dt-edit-btn { width:36px;height:36px;border-radius:50%;border:1.5px solid rgba(var(--gold-rgb),0.5);background:rgba(var(--gold-rgb),0.12);color:var(--gold);font-size:15px;display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0;margin-left:auto; }

      /* Ornement */
      .dt-ornament { display:flex;align-items:center;gap:10px;padding:12px 24px 0; }
      .dt-orn-line { flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(var(--gold-rgb),0.2),transparent); }
      .dt-orn-star { color:var(--gold);font-size:10px;opacity:0.6; }

      /* Stats */
      .dt-stats-section { padding:10px 24px 0; }
      .dt-section-title { font-family:'Cinzel',serif;font-size:9px;letter-spacing:0.2em;color:rgba(var(--gold-rgb),0.85);text-transform:uppercase;margin-bottom:16px; }
      .dt-stats-row { display:flex;gap:12px;justify-content:space-between; }
      .dt-stat-counter { flex:1;display:flex;flex-direction:column;align-items:center;gap:6px; }
      .dt-ring-wrap { position:relative;width:40px;height:40px;display:flex;align-items:center;justify-content:center; }
      ...
      .dt-ring-track { fill:none;stroke:rgba(var(--gold-rgb),0.18);stroke-width:5; }
      ...
      .dt-ring-pct { font-family:'Cinzel',serif;font-size:13px;font-weight:700;color:var(--text);line-height:1; }
      .dt-stat-label { font-family:'Cinzel',serif;font-size:8px;letter-spacing:0.12em;color:rgba(var(--gold-rgb),0.85);text-transform:uppercase;text-align:center; }
      .dt-stat-detail { font-family:'Spectral',serif;font-style:italic;font-size:12px;color:var(--text2);text-align:center; }

      /* Objectif en cours */
      .dt-focus-section { margin:16px 24px 0;padding:16px;border-radius:16px;border:1.5px solid rgba(var(--gold-rgb),0.4);background:linear-gradient(135deg,rgba(var(--gold-rgb),0.10),rgba(var(--gold-rgb),0.03));cursor:pointer;transition:border-color 0.2s; }
      .dt-focus-section:active { border-color:rgba(var(--gold-rgb),0.7); }
      ...
      .dt-focus-bar-track { width:100%;height:6px;border-radius:4px;background:rgba(var(--gold-rgb),0.12);overflow:hidden; }
      ...
      .dt-focus-sub { font-family:'Spectral',serif;font-style:italic;font-size:12px;color:rgba(var(--gold-rgb),0.85);margin-top:8px; }

      /* Activité récente */
      .dt-activity-section { padding:16px 24px 0; }
      .dt-activity-list { display:flex;flex-direction:column;gap:8px;margin-top:12px; }
      .dt-activity-item { display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:10px;border:1px solid rgba(var(--gold-rgb),0.15);background:rgba(var(--gold-rgb),0.02); }
      .dt-activity-icon { width:26px;height:26px;border-radius:50%;background:rgba(var(--gold-rgb),0.1);border:1px solid rgba(var(--gold-rgb),0.3);color:var(--gold);display:flex;align-items:center;justify-content:center;flex-shrink:0; }
      .dt-activity-label { font-family:'Cinzel',serif;font-size:12px;font-weight:600;color:var(--text); }
      .dt-activity-sub { font-family:'Spectral',serif;font-style:italic;font-size:11px;color:rgba(var(--gold-rgb),0.80);margin-top:1px; }
      .dt-activity-date { font-family:'Cinzel',serif;font-size:9px;letter-spacing:0.05em;color:rgba(var(--gold-rgb),0.75);flex-shrink:0;white-space:nowrap; }
      .dt-activity-empty { font-family:'Spectral',serif;font-style:italic;font-size:13px;color:rgba(var(--gold-rgb),0.65);text-align:center;padding:16px;margin-top:12px; }
      ...
      .dt-section-count { font-family:'Spectral',serif;font-style:italic;font-size:12px;color:var(--text2);flex-shrink:0; }
      ...
      .dt-juz-item { aspect-ratio:1;border-radius:8px;border:1px solid rgba(var(--gold-rgb),0.2);display:flex;align-items:center;justify-content:center;font-family:'Cinzel',serif;font-size:9px;color:rgba(var(--gold-rgb),0.5);position:relative;overflow:hidden; }
      .dt-juz-item.done { border-color:var(--gold);background:rgba(var(--gold-rgb),0.85);color:#1a2a1a;font-weight:700; }
      .dt-juz-item.done::after { content:'✓';position:absolute;top:1px;right:3px;font-size:8px;color:#fff;opacity:1;font-weight:700; }
      .dt-juz-item.partial { border-color:rgba(var(--gold-rgb),0.2);background:rgba(var(--gold-rgb),0.04);color:var(--text2); }

      /* Mémorisés */
      .dt-mem-section { padding:16px 24px 0; }
      .dt-mem-list { display:flex;flex-direction:column;gap:8px;margin-top:12px; }
      .dt-mem-item { display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:10px;border:1px solid rgba(var(--gold-rgb),0.2);background:rgba(var(--gold-rgb),0.03);animation:dtFadeIn 0.4s ease both; }
      @keyframes dtFadeIn { from{opacity:0;transform:translateY(6px)} to{opacity:1;transform:none} }
      .dt-mem-num { width:28px;height:28px;border-radius:50%;border:1px solid rgba(var(--gold-rgb),0.3);display:flex;align-items:center;justify-content:center;font-family:'Cinzel',serif;font-size:9px;color:var(--gold);flex-shrink:0; }
      .dt-mem-name { font-family:'Cinzel',serif;font-size:12px;font-weight:600;color:var(--text); }
      .dt-mem-sub  { font-family:'Spectral',serif;font-style:italic;font-size:11px;color:rgba(var(--gold-rgb),0.80);margin-top:1px; }
      .dt-mem-check { width:20px;height:20px;border-radius:50%;background:rgba(var(--gold-rgb),0.1);border:1px solid rgba(var(--gold-rgb),0.4);display:flex;align-items:center;justify-content:center;flex-shrink:0; }
      .dt-mem-check svg { stroke:var(--gold); }

      /* Profils liste */
      .dt-profiles-section { padding:16px 24px 0; }
      .dt-profile-row { display:flex;align-items:center;gap:12px;padding:12px 14px;border-radius:16px;border:1.5px solid rgba(var(--gold-rgb),0.2);background:transparent;margin-bottom:8px;cursor:pointer;transition:all 0.2s;position:relative;overflow:hidden; }
      ...
      .dt-profile-row.active-row { border-color:rgba(var(--gold-rgb),0.5);background:rgba(var(--gold-rgb),0.06); }
      ...
      .dt-p-stats { font-family:'Spectral',serif;font-style:italic;font-size:11px;color:rgba(var(--gold-rgb),0.80);margin-top:2px; }
      .dt-p-dot   { width:8px;height:8px;border-radius:50%;background:var(--gold);box-shadow:0 0 8px rgba(var(--gold-rgb),0.5); }
      .dt-p-edit  { background:rgba(var(--gold-rgb),0.1);border:1px solid rgba(var(--gold-rgb),0.3);border-radius:8px;color:var(--gold);cursor:pointer;padding:4px 8px;font-size:13px; }
      .dt-add-btn { width:100%;padding:14px;border-radius:16px;border:1.5px solid rgba(var(--gold-rgb),0.5);background:rgba(var(--gold-rgb),0.1);color:var(--gold);font-family:'Cinzel',serif;font-size:11px;letter-spacing:0.1em;cursor:pointer;transition:all 0.2s;font-weight:600; }

      /* Formulaire */
      .dt-form-input { width:100%;padding:12px 14px;border-radius:12px;border:1.5px solid rgba(var(--gold-rgb),0.2);background:rgba(var(--gold-rgb),0.04);color:var(--text);font-family:'Cinzel',serif;font-size:14px;box-sizing:border-box;margin-bottom:16px;outline:none; }
      .dt-form-input:focus { border-color:rgba(var(--gold-rgb),0.5); }
      ...
      .dt-cancel-btn { flex:1;padding:12px;border-radius:12px;border:1.5px solid rgba(var(--gold-rgb),0.2);background:transparent;color:rgba(var(--gold-rgb),0.75);font-family:'Cinzel',serif;font-size:13px;cursor:pointer; }
      ...
      /* ── Popup de confirmation custom (remplace confirm()) ── */
      .dt-confirm-overlay {
      ...
      .dt-confirm-box {
        ...
        transform:scale(0.92);opacity:0;transition:transform 0.25s cubic-bezier(0.25,0.46,0.45,0.94),opacity 0.2s ease;
      }
      .dt-confirm-overlay.open .dt-confirm-box { transform:scale(1);opacity:1; }
      .dt-confirm-title {
        font-family:'Cinzel',serif;font-size:15px;font-weight:600;color:var(--gold);
        letter-spacing:0.03em;margin-bottom:12px;
      }
      .dt-confirm-text {
        font-family:'Spectral',serif;font-size:15px;line-height:1.5;color:var(--text);
        margin-bottom:22px;
      }
      .dt-confirm-actions { display:flex;gap:10px; }
      .dt-confirm-cancel {
        flex:1;padding:12px;border-radius:12px;border:1.5px solid rgba(var(--gold-rgb),0.3);
        background:transparent;color:var(--text2);font-family:'Cinzel',serif;font-size:12px;
        letter-spacing:0.05em;cursor:pointer;
      }
      .dt-confirm-delete {
        flex:1;padding:12px;border-radius:12px;border:1.5px solid #E05555;
        background:rgba(224,85,85,0.12);color:#E05555;font-family:'Cinzel',serif;font-size:12px;
        letter-spacing:0.05em;cursor:pointer;font-weight:600;
      }
    `;
    document.head.appendChild(style);
  }

  /* ── Popup de confirmation custom, remplace window.confirm() ── */
  function showConfirmDialog(title, text, onConfirm) {
    injectCSS();
    var overlay = document.getElementById('dtConfirmOverlay');
    if (!overlay) {
      overlay = document.createElement('div');
      overlay.id = 'dtConfirmOverlay';
      overlay.className = 'dt-confirm-overlay';
      document.body.appendChild(overlay);
    }
    overlay.innerHTML =
      '<div class="dt-confirm-box" onclick="event.stopPropagation()">' +
        '<div class="dt-confirm-title">' + title + '</div>' +
        '<div class="dt-confirm-text">' + text + '</div>' +
        '<div class="dt-confirm-actions">' +
          '<button class="dt-confirm-cancel" id="dtConfirmCancel">' + t('cancel') + '</button>' +
          '<button class="dt-confirm-delete" id="dtConfirmOk">' + t('deleteProfile') + '</button>' +
        '</div>' +
      '</div>';
    overlay.classList.add('open');
    overlay.onclick = function () { overlay.classList.remove('open'); };
    document.getElementById('dtConfirmCancel').onclick = function () { overlay.classList.remove('open'); };
    document.getElementById('dtConfirmOk').onclick = function () {
  ...
  function buildModalHTML() {
    ...
    if (profile) {
      ...
      html += '<div class="dt-active-name">'+escapeHtml(profile.name)+'</div>';
      if (weekStats.activeDays > 0) {
        var dayLabel = weekStats.activeDays === 1 ? t('activeDayLabel') : t('activeDaysLabel');
        html += '<div class="dt-active-since">'+t('thisWeek')+' · '+weekStats.activeDays+' '+dayLabel+(weekStats.items > 0 ? ' · '+weekStats.items+' '+t('itemsLearned') : '')+'</div>';
      } else if (created) {
        html += '<div class="dt-active-since">'+t('activeSince')+' '+created+'</div>';
      }
      html += '</div>';
      if (profiles.length <= 1) {
        html += '<button class="dt-edit-btn" title="'+t('editProfile')+' — '+escapeHtml(profile.name)+'" aria-label="'+t('editProfile')+'" onclick="window.DT.editProfile(\''+profile.id+'\')">✎</button>';
      }
    }
    html += '</div>';

    // Switch profils : déplacé en bas de la modale (voir fin de fonction) —
    // c'est une action utilitaire ("changer de profil"), pas une étape du récit
    // de progression qui doit rester ininterrompu entre le header et l'activité.
    ...
    if (focus) {
      ...
      html += '<div class="dt-focus-sub">'+focus.done+' / '+focus.total+' · '+focus.pct+'%'+(focus.next ? ' · '+t('nextVerse')+' '+focus.next : '')+'</div>';
      html += '</div>';
    }
    ...
    if (memSurahs.length === 0) {
      html += '<div style="font-family:Spectral,serif;font-style:italic;font-size:13px;color:rgba(var(--gold-rgb),0.65);text-align:center;padding:16px;">'+t('noSurahMemorized')+'</div>';
    } else {
    ...
    if (memDuas.length === 0) {
      html += '<div style="font-family:Spectral,serif;font-style:italic;font-size:13px;color:rgba(var(--gold-rgb),0.65);text-align:center;padding:16px;">'+t('noDuaMemorized')+'</div>';
    } else {
    ...
    if (activity.length === 0) {
      ...
      activity.forEach(function(ev) {
        ...
        var evLabel = ev.kind === 'surah' ? t('surahMemorizedEvent') : ev.kind === 'verse' ? t('verseMemorizedEvent') : t('duaMemorizedEvent');
    ...
    // Ornement (sépare le récit de progression de la zone utilitaire ci-dessous)
    html += '<div class="dt-ornament"><div class="dt-orn-line"></div><span class="dt-orn-star">✦</span><div class="dt-orn-line"></div></div>';

    // Switch profils — en bas : action utilitaire ("changer de profil"), distincte
    // du récit de progression qui précède. Le titre n'est affiché que s'il y a
    // plusieurs profils ; avec un seul, seul le bouton "+ Ajouter" reste visible.
    html += '<div class="dt-profiles-section">';
    if (profiles.length > 1) {
      html += '<div class="dt-section-title">'+t('chooseProfile')+'</div>';
      profiles.forEach(function(p) {
        ...
        html += '<button class="dt-p-edit" title="'+t('editProfile')+' — '+escapeHtml(p.name)+'" aria-label="'+t('editProfile')+'" onclick="event.stopPropagation();window.DT.editProfile(\''+p.id+'\')">✎</button>';
        html += '</div>';
      });
    }
  ...
  function openProfileModal() {
    ...
    if (titleEl) titleEl.textContent = loadProfiles().length > 1 ? t('profiles') : t('profileSingular');
  ...
  window.DT.deleteProfile = function(id) {
    var target = loadProfiles().find(function(p){ return p.id === id; });
    var name   = target ? target.name : '';
    var msg    = t('confirmDeleteText').replace('{name}', '<strong>'+escapeHtml(name)+'</strong>');
  ...
  function openProfileForm(profile, isFirstRun) {
    ...
    html += '<input id="dt-name" class="dt-form-input" type="text" placeholder="'+t('name')+'" maxlength="20" value="'+(isEdit?escapeHtml(profile.name):'')+'">';
